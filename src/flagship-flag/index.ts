...
// https://registry.terraform.io/providers/cloudflare/cloudflare/5.23.0/docs/resources/flagship_flag
...
export interface FlagshipFlagConfig extends cdktn.TerraformMetaArguments {
  /**
  ...
  */
  ...
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.23.0/docs/resources/flagship_flag#description FlagshipFlag#description}
  */
...
export interface FlagshipFlagRulesConditionsClauses {
  ...
  */
  ...
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.23.0/docs/resources/flagship_flag#clauses FlagshipFlag#clauses}
  */
...
export function flagshipFlagRulesConditionsClausesToTerraform(struct?: FlagshipFlagRulesConditionsClauses | cdktn.IResolvable): any {
  ...
  return {
    ...
    clauses: cdktn.listMapper(flagshipFlagRulesConditionsClausesToTerraform, false)(struct!.clauses),
...
export function flagshipFlagRulesConditionsClausesToHclTerraform(struct?: FlagshipFlagRulesConditionsClauses | cdktn.IResolvable): any {
  if (!cdktn.canInspect(struct) || cdktn.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktn.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdktn.io/docs/concepts/resources#references");
  }
  const attrs = {
    ...
    clauses: {
      value: cdktn.listMapperHcl(flagshipFlagRulesConditionsClausesToHclTerraform, false)(struct!.clauses),
      isBlock: true,
      type: "list",
...
export class FlagshipFlagRulesConditionsClausesOutputReference extends cdktn.ComplexObject {
  ...
  */
  ...
  public get internalValue(): FlagshipFlagRulesConditionsClauses | cdktn.IResolvable | undefined {
  ...
  public set internalValue(value: FlagshipFlagRulesConditionsClauses | cdktn.IResolvable | undefined) {
    if (value === undefined) {
  ...
  public putClauses(value: FlagshipFlagRulesConditionsClauses[] | cdktn.IResolvable) {
...
export class FlagshipFlagRulesConditionsClausesList extends cdktn.ComplexList {
  public internalValue? : FlagshipFlagRulesConditionsClauses[] | cdktn.IResolvable
...
export function flagshipFlagRulesConditionsToTerraform(struct?: FlagshipFlagRulesConditions | cdktn.IResolvable): any {
  if (!cdktn.canInspect(struct) || cdktn.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktn.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdktn.io/docs/concepts/resources#references");
  }
...
export function flagshipFlagRulesConditionsToHclTerraform(struct?: FlagshipFlagRulesConditions | cdktn.IResolvable): any {
  if (!cdktn.canInspect(struct) || cdktn.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktn.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdktn.io/docs/concepts/resources#references");
  }
...
export class FlagshipFlagRulesConditionsOutputReference extends cdktn.ComplexObject {
  private isEmptyObject = false;
  private resolvableValue?: cdktn.IResolvable;
  ...
  */
  ...
  public get internalValue(): FlagshipFlagRulesConditions | cdktn.IResolvable | undefined {
    if (this.resolvableValue) {
      return this.resolvableValue;
    }
    let hasAnyValues = this.isEmptyObject;
  ...
  public set internalValue(value: FlagshipFlagRulesConditions | cdktn.IResolvable | undefined) {
    if (value === undefined) {
      this.isEmptyObject = false;
      this.resolvableValue = undefined;
      this._attribute = undefined;
...
export class FlagshipFlagRulesConditionsList extends cdktn.ComplexList {
  public internalValue? : FlagshipFlagRulesConditions[] | cdktn.IResolvable
...
export function flagshipFlagRulesRolloutToTerraform(struct?: FlagshipFlagRulesRollout | cdktn.IResolvable): any {
  if (!cdktn.canInspect(struct) || cdktn.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktn.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdktn.io/docs/concepts/resources#references");
  }
...
export function flagshipFlagRulesRolloutToHclTerraform(struct?: FlagshipFlagRulesRollout | cdktn.IResolvable): any {
  if (!cdktn.canInspect(struct) || cdktn.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktn.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdktn.io/docs/concepts/resources#references");
  }
...
export class FlagshipFlagRulesRolloutOutputReference extends cdktn.ComplexObject {
  private isEmptyObject = false;
  private resolvableValue?: cdktn.IResolvable;
  ...
  */
  ...
  public get internalValue(): FlagshipFlagRulesRollout | cdktn.IResolvable | undefined {
    if (this.resolvableValue) {
      return this.resolvableValue;
    }
    let hasAnyValues = this.isEmptyObject;
  ...
  public set internalValue(value: FlagshipFlagRulesRollout | cdktn.IResolvable | undefined) {
    if (value === undefined) {
      this.isEmptyObject = false;
      this.resolvableValue = undefined;
      this._attribute = undefined;
...
export interface FlagshipFlagRules {
  ...
  */
  ...
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.23.0/docs/resources/flagship_flag#rollout FlagshipFlag#rollout}
  */
...
export function flagshipFlagRulesToTerraform(struct?: FlagshipFlagRules | cdktn.IResolvable): any {
  if (!cdktn.canInspect(struct) || cdktn.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktn.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdktn.io/docs/concepts/resources#references");
  }
  return {
    conditions: cdktn.listMapper(flagshipFlagRulesConditionsToTerraform, false)(struct!.conditions),
    priority: cdktn.numberToTerraform(struct!.priority),
    rollout: flagshipFlagRulesRolloutToTerraform(struct!.rollout),
    serve_variation: cdktn.stringToTerraform(struct!.serveVariation),
  }
}


export function flagshipFlagRulesToHclTerraform(struct?: FlagshipFlagRules | cdktn.IResolvable): any {
  if (!cdktn.canInspect(struct) || cdktn.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktn.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdktn.io/docs/concepts/resources#references");
  }
  const attrs = {
    conditions: {
      value: cdktn.listMapperHcl(flagshipFlagRulesConditionsToHclTerraform, false)(struct!.conditions),
      isBlock: true,
      type: "list",
    ...
    serve_variation: {
      value: cdktn.stringToHclTerraform(struct!.serveVariation),
      isBlock: false,
      type: "simple",
      storageClassType: "string",
    },
...
export class FlagshipFlagRulesOutputReference extends cdktn.ComplexObject {
  private isEmptyObject = false;
  private resolvableValue?: cdktn.IResolvable;
  ...
  */
  ...
  public get internalValue(): FlagshipFlagRules | cdktn.IResolvable | undefined {
    if (this.resolvableValue) {
      return this.resolvableValue;
    }
    let hasAnyValues = this.isEmptyObject;
  ...
  public set internalValue(value: FlagshipFlagRules | cdktn.IResolvable | undefined) {
    if (value === undefined) {
      this.isEmptyObject = false;
      this.resolvableValue = undefined;
  ...
  public putConditions(value: FlagshipFlagRulesConditions[] | cdktn.IResolvable) {
...
export class FlagshipFlagRulesList extends cdktn.ComplexList {
  public internalValue? : FlagshipFlagRules[] | cdktn.IResolvable
...
/**
* Represents a {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.23.0/docs/resources/flagship_flag cloudflare_flagship_flag}
*/
export class FlagshipFlag extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing FlagshipFlag that should be imported. Refer to the {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.23.0/docs/resources/flagship_flag#import import section} in the documentation of this resource for the id to use
  * @param provider? Optional instance of the provider where the FlagshipFlag to import is found
  */
  public static generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: cdktn.TerraformProvider) {
        return new cdktn.ImportableResource(scope, importToId, { terraformResourceType: "cloudflare_flagship_flag", importId: importFromId, provider });
      }
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.23.0/docs/resources/flagship_flag cloudflare_flagship_flag} Resource
  *
  * @param scope The scope in which to define this construct
  ...
  */
  ...
  public putRules(value: FlagshipFlagRules[] | cdktn.IResolvable) {
  ...
  protected synthesizeAttributes(): { [name: string]: any } {
    return {
      ...
      variations: cdktn.hashMapper(cdktn.stringToTerraform)(this._variations),
    };
  }
  ...
  protected synthesizeHclAttributes(): { [name: string]: any } {
    const attrs = {
      ...
      rules: {
        value: cdktn.listMapperHcl(flagshipFlagRulesToHclTerraform, false)(this._rules.internalValue),
        isBlock: true,
        type: "list",
      ...
      variations: {
        value: cdktn.hashMapperHcl(cdktn.stringToHclTerraform)(this._variations),
        isBlock: false,
        type: "map",

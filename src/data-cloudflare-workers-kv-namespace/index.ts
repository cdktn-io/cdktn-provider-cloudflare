...
// https://registry.terraform.io/providers/cloudflare/cloudflare/5.17.0/docs/data-sources/workers_kv_namespace
...
export interface DataCloudflareWorkersKvNamespaceConfig extends cdktn.TerraformMetaArguments {
  /**
  * Identifier.
  *
...
export function dataCloudflareWorkersKvNamespaceFilterToTerraform(struct?: DataCloudflareWorkersKvNamespaceFilter | cdktn.IResolvable): any {
...
export function dataCloudflareWorkersKvNamespaceFilterToHclTerraform(struct?: DataCloudflareWorkersKvNamespaceFilter | cdktn.IResolvable): any {
  if (!cdktn.canInspect(struct) || cdktn.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktn.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
...
export class DataCloudflareWorkersKvNamespaceFilterOutputReference extends cdktn.ComplexObject {
  ...
  */
  ...
  public get internalValue(): DataCloudflareWorkersKvNamespaceFilter | cdktn.IResolvable | undefined {
  ...
  public set internalValue(value: DataCloudflareWorkersKvNamespaceFilter | cdktn.IResolvable | undefined) {
    if (value === undefined) {
...
*/
export class DataCloudflareWorkersKvNamespace extends cdktn.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataCloudflareWorkersKvNamespace that should be imported. Refer to the {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.17.0/docs/data-sources/workers_kv_namespace#import import section} in the documentation of this resource for the id to use

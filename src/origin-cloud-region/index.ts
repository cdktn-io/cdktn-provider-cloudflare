...
// https://registry.terraform.io/providers/cloudflare/cloudflare/5.20.0/docs/resources/origin_cloud_region
...
export class OriginCloudRegion extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing OriginCloudRegion that should be imported. Refer to the {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.20.0/docs/resources/origin_cloud_region#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.20.0/docs/resources/origin_cloud_region cloudflare_origin_cloud_region} Resource
  *
  * @param scope The scope in which to define this construct

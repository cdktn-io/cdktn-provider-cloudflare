...
// https://registry.terraform.io/providers/cloudflare/cloudflare/5.18.0/docs/data-sources/schema_validation_operation_settings
...
export interface DataCloudflareSchemaValidationOperationSettingsConfig extends cdktn.TerraformMetaArguments {
  /**
  * UUID.
  *
...
*/
export class DataCloudflareSchemaValidationOperationSettings extends cdktn.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataCloudflareSchemaValidationOperationSettings that should be imported. Refer to the {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.18.0/docs/data-sources/schema_validation_operation_settings#import import section} in the documentation of this resource for the id to use

...
// https://registry.terraform.io/providers/cloudflare/cloudflare/5.18.0/docs/resources/zero_trust_tunnel_cloudflared
...
export interface ZeroTrustTunnelCloudflaredConfig extends cdktn.TerraformMetaArguments {
  /**
...
export class ZeroTrustTunnelCloudflaredConnectionsOutputReference extends cdktn.ComplexObject {
...
export class ZeroTrustTunnelCloudflaredConnectionsList extends cdktn.ComplexList {
...
*/
export class ZeroTrustTunnelCloudflared extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing ZeroTrustTunnelCloudflared that should be imported. Refer to the {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.18.0/docs/resources/zero_trust_tunnel_cloudflared#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.18.0/docs/resources/zero_trust_tunnel_cloudflared cloudflare_zero_trust_tunnel_cloudflared} Resource
  *
  * @param scope The scope in which to define this construct
  ...
  */
  ...
  protected synthesizeAttributes(): { [name: string]: any } {
    return {
      ...
      config_src: cdktn.stringToTerraform(this._configSrc),
      name: cdktn.stringToTerraform(this._name),
      tunnel_secret: cdktn.stringToTerraform(this._tunnelSecret),
    };
  }
  ...
  protected synthesizeHclAttributes(): { [name: string]: any } {
    const attrs = {
      ...
      config_src: {
        value: cdktn.stringToHclTerraform(this._configSrc),
        isBlock: false,
        type: "simple",
        storageClassType: "string",
      },
      ...
      tunnel_secret: {
        value: cdktn.stringToHclTerraform(this._tunnelSecret),
        isBlock: false,
        type: "simple",
        storageClassType: "string",
      },

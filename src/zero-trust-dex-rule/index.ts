...
// https://registry.terraform.io/providers/cloudflare/cloudflare/5.18.0/docs/resources/zero_trust_dex_rule
...
export interface ZeroTrustDexRuleConfig extends cdktn.TerraformMetaArguments {
  /**
...
export class ZeroTrustDexRuleTargetedTestsDataOutputReference extends cdktn.ComplexObject {
...
export class ZeroTrustDexRuleTargetedTestsOutputReference extends cdktn.ComplexObject {
  private isEmptyObject = false;
...
export class ZeroTrustDexRuleTargetedTestsList extends cdktn.ComplexList {
...
*/
export class ZeroTrustDexRule extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing ZeroTrustDexRule that should be imported. Refer to the {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.18.0/docs/resources/zero_trust_dex_rule#import import section} in the documentation of this resource for the id to use

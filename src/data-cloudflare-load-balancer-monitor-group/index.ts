...
// https://registry.terraform.io/providers/cloudflare/cloudflare/5.20.0/docs/data-sources/load_balancer_monitor_group
...
export class DataCloudflareLoadBalancerMonitorGroupMembersOutputReference extends cdktn.ComplexObject {
...
export class DataCloudflareLoadBalancerMonitorGroupMembersList extends cdktn.ComplexList {
  ...
  */
  ...
  protected synthesizeAttributes(): { [name: string]: any } {
    return {
      ...
      monitor_group_id: cdktn.stringToTerraform(this._monitorGroupId),
    };
  }
  ...
  protected synthesizeHclAttributes(): { [name: string]: any } {
    const attrs = {
      ...
      monitor_group_id: {
        value: cdktn.stringToHclTerraform(this._monitorGroupId),
        isBlock: false,
        type: "simple",
        storageClassType: "string",
      },

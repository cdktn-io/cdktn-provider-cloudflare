...
// https://registry.terraform.io/providers/cloudflare/cloudflare/5.25.0/docs/data-sources/oauth_clients
...
export interface DataCloudflareOauthClientsConfig extends cdktn.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.25.0/docs/data-sources/oauth_clients#account_id DataCloudflareOauthClients#account_id}
  */
  readonly accountId: string;
  /**
  * Max items to fetch, default: 1000
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.25.0/docs/data-sources/oauth_clients#max_items DataCloudflareOauthClients#max_items}
  */
...
export class DataCloudflareOauthClientsResultClientUriVerificationOutputReference extends cdktn.ComplexObject {
...
export class DataCloudflareOauthClientsResultOutputReference extends cdktn.ComplexObject {
  private isEmptyObject = false;
  ...
  */
  ...
  // optional_scopes - computed: true, optional: false, required: false
...
export class DataCloudflareOauthClientsResultList extends cdktn.ComplexList {
...
/**
* Represents a {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.25.0/docs/data-sources/oauth_clients cloudflare_oauth_clients}
*/
export class DataCloudflareOauthClients extends cdktn.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataCloudflareOauthClients that should be imported. Refer to the {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.25.0/docs/data-sources/oauth_clients#import import section} in the documentation of this resource for the id to use
  ...
  */
  public static generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: cdktn.TerraformProvider) {
        return new cdktn.ImportableResource(scope, importToId, { terraformResourceType: "cloudflare_oauth_clients", importId: importFromId, provider });
      }
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.25.0/docs/data-sources/oauth_clients cloudflare_oauth_clients} Data Source
  *
  * @param scope The scope in which to define this construct

...
export class DataCloudflareMoqRelaysResultOutputReference extends cdktn.ComplexObject {
...
export class DataCloudflareMoqRelaysResultList extends cdktn.ComplexList {
...
export class DataCloudflareMoqRelays extends cdktn.TerraformDataSource {
  ...
  */
  public static generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: cdktn.TerraformProvider) {
        return new cdktn.ImportableResource(scope, importToId, { terraformResourceType: "cloudflare_moq_relays", importId: importFromId, provider });
      }

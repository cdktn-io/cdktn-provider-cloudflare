...
// https://registry.terraform.io/providers/cloudflare/cloudflare/5.19.1/docs/data-sources/magic_network_monitoring_configuration
...
export interface DataCloudflareMagicNetworkMonitoringConfigurationConfig extends cdktn.TerraformMetaArguments {
  /**
...
export class DataCloudflareMagicNetworkMonitoringConfigurationWarpDevicesOutputReference extends cdktn.ComplexObject {
...
export class DataCloudflareMagicNetworkMonitoringConfigurationWarpDevicesList extends cdktn.ComplexList {
...
*/
export class DataCloudflareMagicNetworkMonitoringConfiguration extends cdktn.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataCloudflareMagicNetworkMonitoringConfiguration that should be imported. Refer to the {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.19.1/docs/data-sources/magic_network_monitoring_configuration#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.19.1/docs/data-sources/magic_network_monitoring_configuration cloudflare_magic_network_monitoring_configuration} Data Source
  *
  * @param scope The scope in which to define this construct

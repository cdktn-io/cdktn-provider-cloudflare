...
// https://registry.terraform.io/providers/cloudflare/cloudflare/5.20.0/docs/resources/custom_ssl
...
export class CustomSsl extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing CustomSsl that should be imported. Refer to the {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.20.0/docs/resources/custom_ssl#import import section} in the documentation of this resource for the id to use

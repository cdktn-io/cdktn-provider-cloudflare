...
// https://registry.terraform.io/providers/cloudflare/cloudflare/5.18.0/docs/data-sources/origin_ca_certificates
...
export interface DataCloudflareOriginCaCertificatesConfig extends cdktn.TerraformMetaArguments {
  /**
...
export class DataCloudflareOriginCaCertificatesResultOutputReference extends cdktn.ComplexObject {
...
export class DataCloudflareOriginCaCertificatesResultList extends cdktn.ComplexList {
...
*/
export class DataCloudflareOriginCaCertificates extends cdktn.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataCloudflareOriginCaCertificates that should be imported. Refer to the {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.18.0/docs/data-sources/origin_ca_certificates#import import section} in the documentation of this resource for the id to use
  ...
  */
  public static generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: cdktn.TerraformProvider) {
        return new cdktn.ImportableResource(scope, importToId, { terraformResourceType: "cloudflare_origin_ca_certificates", importId: importFromId, provider });
      }
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.18.0/docs/data-sources/origin_ca_certificates cloudflare_origin_ca_certificates} Data Source
  *
  * @param scope The scope in which to define this construct

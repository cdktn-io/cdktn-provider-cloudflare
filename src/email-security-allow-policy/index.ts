...
export interface EmailSecurityAllowPolicyConfig extends cdktn.TerraformMetaArguments {
  /**
  * Identifier.
  *
...
export class EmailSecurityAllowPolicy extends cdktn.TerraformResource {
  ...
  */
  ...
  private _isRecipient?: boolean | cdktn.IResolvable; 
  public get isRecipient() {
    return this.getBooleanAttribute('is_recipient');
  }
  public set isRecipient(value: boolean | cdktn.IResolvable) {
  ...
  private _isSender?: boolean | cdktn.IResolvable; 
  public get isSender() {
    return this.getBooleanAttribute('is_sender');
  }
  public set isSender(value: boolean | cdktn.IResolvable) {
  ...
  private _isSpoof?: boolean | cdktn.IResolvable; 
  public get isSpoof() {
    return this.getBooleanAttribute('is_spoof');
  }
  public set isSpoof(value: boolean | cdktn.IResolvable) {
    this._isSpoof = value;
  }
  public resetIsSpoof() {
  ...
  protected synthesizeAttributes(): { [name: string]: any } {
    return {
      ...
      is_acceptable_sender: cdktn.booleanToTerraform(this._isAcceptableSender),
      is_exempt_recipient: cdktn.booleanToTerraform(this._isExemptRecipient),
      is_recipient: cdktn.booleanToTerraform(this._isRecipient),
      is_regex: cdktn.booleanToTerraform(this._isRegex),
      is_sender: cdktn.booleanToTerraform(this._isSender),
      is_spoof: cdktn.booleanToTerraform(this._isSpoof),
      is_trusted_sender: cdktn.booleanToTerraform(this._isTrustedSender),
      pattern: cdktn.stringToTerraform(this._pattern),
      pattern_type: cdktn.stringToTerraform(this._patternType),
      verify_sender: cdktn.booleanToTerraform(this._verifySender),
    };
  }
  ...
  protected synthesizeHclAttributes(): { [name: string]: any } {
    const attrs = {
      ...
      is_acceptable_sender: {
        value: cdktn.booleanToHclTerraform(this._isAcceptableSender),
        isBlock: false,
        type: "simple",
        storageClassType: "boolean",
      },
      is_exempt_recipient: {
        value: cdktn.booleanToHclTerraform(this._isExemptRecipient),
        isBlock: false,
        type: "simple",
        storageClassType: "boolean",
      },
      is_recipient: {
        value: cdktn.booleanToHclTerraform(this._isRecipient),
        isBlock: false,
        type: "simple",
        storageClassType: "boolean",
      },
      ...
      is_sender: {
        value: cdktn.booleanToHclTerraform(this._isSender),
        isBlock: false,
        type: "simple",
        storageClassType: "boolean",
      },
      is_spoof: {
        value: cdktn.booleanToHclTerraform(this._isSpoof),
        isBlock: false,
        type: "simple",
        storageClassType: "boolean",
      },
      is_trusted_sender: {
        value: cdktn.booleanToHclTerraform(this._isTrustedSender),
        isBlock: false,
        type: "simple",
        storageClassType: "boolean",
      },
      ...
      verify_sender: {
        value: cdktn.booleanToHclTerraform(this._verifySender),
        isBlock: false,
        type: "simple",
        storageClassType: "boolean",
      },

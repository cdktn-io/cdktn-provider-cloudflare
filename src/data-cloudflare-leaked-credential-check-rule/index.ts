...
// https://registry.terraform.io/providers/cloudflare/cloudflare/5.19.1/docs/data-sources/leaked_credential_check_rule
...
export interface DataCloudflareLeakedCredentialCheckRuleConfig extends cdktn.TerraformMetaArguments {
  /**
...
*/
export class DataCloudflareLeakedCredentialCheckRule extends cdktn.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataCloudflareLeakedCredentialCheckRule that should be imported. Refer to the {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.19.1/docs/data-sources/leaked_credential_check_rule#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.19.1/docs/data-sources/leaked_credential_check_rule cloudflare_leaked_credential_check_rule} Data Source
  *
  * @param scope The scope in which to define this construct
  ...
  */
  ...
  protected synthesizeAttributes(): { [name: string]: any } {
    return {
      detection_id: cdktn.stringToTerraform(this._detectionId),
  ...
  protected synthesizeHclAttributes(): { [name: string]: any } {
    const attrs = {
      detection_id: {
        value: cdktn.stringToHclTerraform(this._detectionId),
        isBlock: false,
        type: "simple",

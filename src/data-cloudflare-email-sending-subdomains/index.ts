...
export interface DataCloudflareEmailSendingSubdomainsConfig extends cdktn.TerraformMetaArguments {
  /**
...
export class DataCloudflareEmailSendingSubdomainsResultOutputReference extends cdktn.ComplexObject {
...
export class DataCloudflareEmailSendingSubdomainsResultList extends cdktn.ComplexList {
...
*/
export class DataCloudflareEmailSendingSubdomains extends cdktn.TerraformDataSource {
  ...
  */
  public static generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: cdktn.TerraformProvider) {
        return new cdktn.ImportableResource(scope, importToId, { terraformResourceType: "cloudflare_email_sending_subdomains", importId: importFromId, provider });
      }

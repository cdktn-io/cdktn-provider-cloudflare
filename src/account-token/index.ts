...
// https://registry.terraform.io/providers/cloudflare/cloudflare/5.21.0/docs/resources/account_token
...
export class AccountToken extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing AccountToken that should be imported. Refer to the {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.21.0/docs/resources/account_token#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.21.0/docs/resources/account_token cloudflare_account_token} Resource
  *
  * @param scope The scope in which to define this construct
  ...
  */
  ...
  private _policies = new AccountTokenPoliciesList(this, "policies", false);
  public get policies() {

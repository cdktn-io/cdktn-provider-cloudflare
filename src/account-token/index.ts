...
// https://registry.terraform.io/providers/cloudflare/cloudflare/5.18.0/docs/resources/account_token
...
export class AccountTokenPoliciesOutputReference extends cdktn.ComplexObject {
  ...
  */
  ...
  private _permissionGroups = new AccountTokenPoliciesPermissionGroupsList(this, "permission_groups", true);
...
export class AccountToken extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing AccountToken that should be imported. Refer to the {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.18.0/docs/resources/account_token#import import section} in the documentation of this resource for the id to use

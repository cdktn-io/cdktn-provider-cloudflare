...
// https://registry.terraform.io/providers/cloudflare/cloudflare/5.17.0/docs/data-sources/zero_trust_device_custom_profile_local_domain_fallback
...
export interface DataCloudflareZeroTrustDeviceCustomProfileLocalDomainFallbackConfig extends cdktn.TerraformMetaArguments {
  /**
...
*/
export class DataCloudflareZeroTrustDeviceCustomProfileLocalDomainFallback extends cdktn.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataCloudflareZeroTrustDeviceCustomProfileLocalDomainFallback that should be imported. Refer to the {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.17.0/docs/data-sources/zero_trust_device_custom_profile_local_domain_fallback#import import section} in the documentation of this resource for the id to use

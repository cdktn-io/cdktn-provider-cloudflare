  ...
  */
  ...
  protected synthesizeAttributes(): { [name: string]: any } {
    return {
      ...
      optional_scopes: cdktn.listMapper(cdktn.stringToTerraform, false)(this._optionalScopes),
  ...
  protected synthesizeHclAttributes(): { [name: string]: any } {
    const attrs = {
      ...
      optional_scopes: {
        value: cdktn.listMapperHcl(cdktn.stringToHclTerraform, false)(this._optionalScopes),
        isBlock: false,
        type: "list",
        storageClassType: "stringList",
      },

...
// https://registry.terraform.io/providers/cloudflare/cloudflare/5.22.0/docs/resources/oauth_client
...
export interface OauthClientConfig extends cdktn.TerraformMetaArguments {
  /**
  * Account identifier tag.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.22.0/docs/resources/oauth_client#account_id OauthClient#account_id}
  */
  readonly accountId: string;
  /**
  * Array of allowed CORS origins.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.22.0/docs/resources/oauth_client#allowed_cors_origins OauthClient#allowed_cors_origins}
  */
  readonly allowedCorsOrigins?: string[];
  /**
  * Human-readable name of the OAuth client.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.22.0/docs/resources/oauth_client#client_name OauthClient#client_name}
  */
  readonly clientName: string;
  /**
  * URL of the home page of the client.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.22.0/docs/resources/oauth_client#client_uri OauthClient#client_uri}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.22.0/docs/resources/oauth_client#grant_types OauthClient#grant_types}
  */
  readonly grantTypes: string[];
  /**
  * URL of the client's logo.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.22.0/docs/resources/oauth_client#logo_uri OauthClient#logo_uri}
  */
  readonly logoUri?: string;
  /**
  * The unique identifier for an OAuth client.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.22.0/docs/resources/oauth_client#oauth_client_id OauthClient#oauth_client_id}
  */
  readonly oauthClientId?: string;
  /**
  * URL that points to a privacy policy document.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.22.0/docs/resources/oauth_client#policy_uri OauthClient#policy_uri}
  */
  readonly policyUri?: string;
  /**
  * Array of allowed post-logout redirect URIs.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.22.0/docs/resources/oauth_client#post_logout_redirect_uris OauthClient#post_logout_redirect_uris}
  */
  readonly postLogoutRedirectUris?: string[];
  /**
  * Array of allowed redirect URIs for the client.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.22.0/docs/resources/oauth_client#redirect_uris OauthClient#redirect_uris}
  */
  readonly redirectUris: string[];
  /**
  * Array of OAuth response types the client is allowed to use.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.22.0/docs/resources/oauth_client#response_types OauthClient#response_types}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.22.0/docs/resources/oauth_client#scopes OauthClient#scopes}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.22.0/docs/resources/oauth_client#token_endpoint_auth_method OauthClient#token_endpoint_auth_method}
  */
  readonly tokenEndpointAuthMethod: string;
  /**
  * URL that points to a terms of service document.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.22.0/docs/resources/oauth_client#tos_uri OauthClient#tos_uri}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.22.0/docs/resources/oauth_client#visibility OauthClient#visibility}
  */
...
export class OauthClientClientUriVerificationOutputReference extends cdktn.ComplexObject {
...
/**
* Represents a {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.22.0/docs/resources/oauth_client cloudflare_oauth_client}
*/
export class OauthClient extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing OauthClient that should be imported. Refer to the {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.22.0/docs/resources/oauth_client#import import section} in the documentation of this resource for the id to use
  * @param provider? Optional instance of the provider where the OauthClient to import is found
  */
  public static generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: cdktn.TerraformProvider) {
        return new cdktn.ImportableResource(scope, importToId, { terraformResourceType: "cloudflare_oauth_client", importId: importFromId, provider });
      }
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.22.0/docs/resources/oauth_client cloudflare_oauth_client} Resource
  *
  * @param scope The scope in which to define this construct
  ...
  */
  ...
  protected synthesizeAttributes(): { [name: string]: any } {
    return {
      ...
      allowed_cors_origins: cdktn.listMapper(cdktn.stringToTerraform, false)(this._allowedCorsOrigins),
      client_name: cdktn.stringToTerraform(this._clientName),
      client_uri: cdktn.stringToTerraform(this._clientUri),
      grant_types: cdktn.listMapper(cdktn.stringToTerraform, false)(this._grantTypes),
      logo_uri: cdktn.stringToTerraform(this._logoUri),
      oauth_client_id: cdktn.stringToTerraform(this._oauthClientId),
      policy_uri: cdktn.stringToTerraform(this._policyUri),
      post_logout_redirect_uris: cdktn.listMapper(cdktn.stringToTerraform, false)(this._postLogoutRedirectUris),
      redirect_uris: cdktn.listMapper(cdktn.stringToTerraform, false)(this._redirectUris),
      response_types: cdktn.listMapper(cdktn.stringToTerraform, false)(this._responseTypes),
      scopes: cdktn.listMapper(cdktn.stringToTerraform, false)(this._scopes),
      token_endpoint_auth_method: cdktn.stringToTerraform(this._tokenEndpointAuthMethod),
      tos_uri: cdktn.stringToTerraform(this._tosUri),
  ...
  protected synthesizeHclAttributes(): { [name: string]: any } {
    const attrs = {
      ...
      allowed_cors_origins: {
        value: cdktn.listMapperHcl(cdktn.stringToHclTerraform, false)(this._allowedCorsOrigins),
        isBlock: false,
        type: "list",
      ...
      client_uri: {
        value: cdktn.stringToHclTerraform(this._clientUri),
        isBlock: false,
        type: "simple",
        storageClassType: "string",
      },
      ...
      logo_uri: {
        value: cdktn.stringToHclTerraform(this._logoUri),
        isBlock: false,
        type: "simple",
        storageClassType: "string",
      },
      ...
      policy_uri: {
        value: cdktn.stringToHclTerraform(this._policyUri),
        isBlock: false,
        type: "simple",
        storageClassType: "string",
      },
      post_logout_redirect_uris: {
        value: cdktn.listMapperHcl(cdktn.stringToHclTerraform, false)(this._postLogoutRedirectUris),
        isBlock: false,
        type: "list",
        storageClassType: "stringList",
      },
      ...
      response_types: {
        value: cdktn.listMapperHcl(cdktn.stringToHclTerraform, false)(this._responseTypes),
        isBlock: false,
        type: "list",
        storageClassType: "stringList",
      },
      ...
      token_endpoint_auth_method: {
        value: cdktn.stringToHclTerraform(this._tokenEndpointAuthMethod),
        isBlock: false,
        type: "simple",
        storageClassType: "string",
      },
      tos_uri: {
        value: cdktn.stringToHclTerraform(this._tosUri),
        isBlock: false,
        type: "simple",
        storageClassType: "string",
      },

...
// https://registry.terraform.io/providers/cloudflare/cloudflare/5.20.0/docs/resources/oauth_client
...
export class OauthClient extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing OauthClient that should be imported. Refer to the {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.20.0/docs/resources/oauth_client#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.20.0/docs/resources/oauth_client cloudflare_oauth_client} Resource
  *
  * @param scope The scope in which to define this construct

...
export interface DataCloudflareEmailSecurityDomainConfig extends cdktn.TerraformMetaArguments {
  /**
  * Identifier.
  *
...
export class DataCloudflareEmailSecurityDomainAuthorizationOutputReference extends cdktn.ComplexObject {
...
export class DataCloudflareEmailSecurityDomainEmailsProcessedOutputReference extends cdktn.ComplexObject {
  private isEmptyObject = false;
...
export function dataCloudflareEmailSecurityDomainFilterToTerraform(struct?: DataCloudflareEmailSecurityDomainFilter | cdktn.IResolvable): any {
  if (!cdktn.canInspect(struct) || cdktn.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktn.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdktn.io/docs/concepts/resources#references");
  }
  return {
    active_delivery_mode: cdktn.stringToTerraform(struct!.activeDeliveryMode),
    allowed_delivery_mode: cdktn.stringToTerraform(struct!.allowedDeliveryMode),
    direction: cdktn.stringToTerraform(struct!.direction),
    domain: cdktn.listMapper(cdktn.stringToTerraform, false)(struct!.domain),
    integration_id: cdktn.stringToTerraform(struct!.integrationId),
...
export function dataCloudflareEmailSecurityDomainFilterToHclTerraform(struct?: DataCloudflareEmailSecurityDomainFilter | cdktn.IResolvable): any {
  if (!cdktn.canInspect(struct) || cdktn.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktn.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdktn.io/docs/concepts/resources#references");
  }
  const attrs = {
    active_delivery_mode: {
      value: cdktn.stringToHclTerraform(struct!.activeDeliveryMode),
      isBlock: false,
      type: "simple",
      storageClassType: "string",
    },
    allowed_delivery_mode: {
      value: cdktn.stringToHclTerraform(struct!.allowedDeliveryMode),
      isBlock: false,
      type: "simple",
      storageClassType: "string",
    },
    ...
    domain: {
      value: cdktn.listMapperHcl(cdktn.stringToHclTerraform, false)(struct!.domain),
      isBlock: false,
      type: "list",
      storageClassType: "stringList",
    },
    integration_id: {
      value: cdktn.stringToHclTerraform(struct!.integrationId),
      isBlock: false,
      type: "simple",
      storageClassType: "string",
    },
...
export class DataCloudflareEmailSecurityDomainFilterOutputReference extends cdktn.ComplexObject {
  private isEmptyObject = false;
  ...
  */
  ...
  public get internalValue(): DataCloudflareEmailSecurityDomainFilter | cdktn.IResolvable | undefined {
  ...
  public set internalValue(value: DataCloudflareEmailSecurityDomainFilter | cdktn.IResolvable | undefined) {
    if (value === undefined) {
      this.isEmptyObject = false;
...
*/
export class DataCloudflareEmailSecurityDomain extends cdktn.TerraformDataSource {
  ...
  */
  public static generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: cdktn.TerraformProvider) {
        return new cdktn.ImportableResource(scope, importToId, { terraformResourceType: "cloudflare_email_security_domain", importId: importFromId, provider });
      }
  ...
  */
  ...
  public get allowedDeliveryModes() {
    return cdktn.Fn.tolist(this.getListAttribute('allowed_delivery_modes'));
  }
  ...
  public get dropDispositions() {
    return cdktn.Fn.tolist(this.getListAttribute('drop_dispositions'));
  }
  ...
  public get ipRestrictions() {
    return cdktn.Fn.tolist(this.getListAttribute('ip_restrictions'));
  }

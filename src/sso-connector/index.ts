...
// https://registry.terraform.io/providers/cloudflare/cloudflare/5.20.0/docs/resources/sso_connector
...
export class SsoConnector extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing SsoConnector that should be imported. Refer to the {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.20.0/docs/resources/sso_connector#import import section} in the documentation of this resource for the id to use

...
// https://registry.terraform.io/providers/cloudflare/cloudflare/5.19.1/docs/data-sources/stream_audio_track
...
export interface DataCloudflareStreamAudioTrackConfig extends cdktn.TerraformMetaArguments {
  /**
...
export class DataCloudflareStreamAudioTrackAudioOutputReference extends cdktn.ComplexObject {
...
export class DataCloudflareStreamAudioTrackAudioList extends cdktn.ComplexList {
...
*/
export class DataCloudflareStreamAudioTrack extends cdktn.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataCloudflareStreamAudioTrack that should be imported. Refer to the {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.19.1/docs/data-sources/stream_audio_track#import import section} in the documentation of this resource for the id to use

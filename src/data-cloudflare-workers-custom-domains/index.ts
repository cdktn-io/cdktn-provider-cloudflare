...
// https://registry.terraform.io/providers/cloudflare/cloudflare/5.17.0/docs/data-sources/workers_custom_domains
...
export interface DataCloudflareWorkersCustomDomainsConfig extends cdktn.TerraformMetaArguments {
  /**
...
export class DataCloudflareWorkersCustomDomainsResultOutputReference extends cdktn.ComplexObject {
...
export class DataCloudflareWorkersCustomDomainsResultList extends cdktn.ComplexList {
...
*/
export class DataCloudflareWorkersCustomDomains extends cdktn.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataCloudflareWorkersCustomDomains that should be imported. Refer to the {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.17.0/docs/data-sources/workers_custom_domains#import import section} in the documentation of this resource for the id to use
  ...
  */
  public static generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: cdktn.TerraformProvider) {
        return new cdktn.ImportableResource(scope, importToId, { terraformResourceType: "cloudflare_workers_custom_domains", importId: importFromId, provider });
      }

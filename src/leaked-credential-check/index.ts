...
// https://registry.terraform.io/providers/cloudflare/cloudflare/5.17.0/docs/resources/leaked_credential_check
...
export interface LeakedCredentialCheckConfig extends cdktn.TerraformMetaArguments {
  /**
...
export class LeakedCredentialCheck extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing LeakedCredentialCheck that should be imported. Refer to the {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.17.0/docs/resources/leaked_credential_check#import import section} in the documentation of this resource for the id to use

...
// https://registry.terraform.io/providers/cloudflare/cloudflare/5.18.0/docs/data-sources/byo_ip_prefixes
...
export function dataCloudflareByoIpPrefixesResultToTerraform(struct?: DataCloudflareByoIpPrefixesResult): any {
...
export function dataCloudflareByoIpPrefixesResultToHclTerraform(struct?: DataCloudflareByoIpPrefixesResult): any {
  if (!cdktn.canInspect(struct) || cdktn.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktn.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
...
export class DataCloudflareByoIpPrefixesResultOutputReference extends cdktn.ComplexObject {
  ...
  */
  ...
  public get internalValue(): DataCloudflareByoIpPrefixesResult | undefined {
    let hasAnyValues = this.isEmptyObject;
    const internalValueResult: any = {};
    return hasAnyValues ? internalValueResult : undefined;
  }

  public set internalValue(value: DataCloudflareByoIpPrefixesResult | undefined) {
    if (value === undefined) {
...
export class DataCloudflareByoIpPrefixesResultList extends cdktn.ComplexList {
...
*/
export class DataCloudflareByoIpPrefixes extends cdktn.TerraformDataSource {

  // =================
  // STATIC PROPERTIES
  // =================
  public static readonly tfResourceType = "cloudflare_byo_ip_prefixes";
  ...
  * @param importFromId The id of the existing DataCloudflareByoIpPrefixes that should be imported. Refer to the {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.18.0/docs/data-sources/byo_ip_prefixes#import import section} in the documentation of this resource for the id to use
  ...
  */
  public static generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: cdktn.TerraformProvider) {
        return new cdktn.ImportableResource(scope, importToId, { terraformResourceType: "cloudflare_byo_ip_prefixes", importId: importFromId, provider });
      }
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.18.0/docs/data-sources/byo_ip_prefixes cloudflare_byo_ip_prefixes} Data Source
  *
  * @param scope The scope in which to define this construct
  * @param id The scoped construct ID. Must be unique amongst siblings in the same scope
  * @param options DataCloudflareByoIpPrefixesConfig
  */
  public constructor(scope: Construct, id: string, config: DataCloudflareByoIpPrefixesConfig) {
    super(scope, id, {
  ...
  private _result = new DataCloudflareByoIpPrefixesResultList(this, "result", false);
  public get result() {
    return this._result;
  }

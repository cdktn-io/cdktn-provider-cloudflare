...
// https://registry.terraform.io/providers/cloudflare/cloudflare/5.20.0/docs/resources/google_tag_gateway
...
export interface GoogleTagGatewayConfig extends cdktn.TerraformMetaArguments {
  /**
  ...
  */
  readonly hideOriginalIp: boolean | cdktn.IResolvable;
  /**
  ...
  */
  readonly setUpTag?: boolean | cdktn.IResolvable;
  /**
  * Identifier.
  *
...
*/
export class GoogleTagGateway extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing GoogleTagGateway that should be imported. Refer to the {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.20.0/docs/resources/google_tag_gateway#import import section} in the documentation of this resource for the id to use
  * @param provider? Optional instance of the provider where the GoogleTagGateway to import is found
  */
  public static generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: cdktn.TerraformProvider) {
        return new cdktn.ImportableResource(scope, importToId, { terraformResourceType: "cloudflare_google_tag_gateway", importId: importFromId, provider });
      }
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.20.0/docs/resources/google_tag_gateway cloudflare_google_tag_gateway} Resource
  *
  * @param scope The scope in which to define this construct
  ...
  */
  ...
  private _hideOriginalIp?: boolean | cdktn.IResolvable; 
  public get hideOriginalIp() {
    return this.getBooleanAttribute('hide_original_ip');
  }
  public set hideOriginalIp(value: boolean | cdktn.IResolvable) {
  ...
  private _setUpTag?: boolean | cdktn.IResolvable; 
  public get setUpTag() {
    return this.getBooleanAttribute('set_up_tag');
  }
  public set setUpTag(value: boolean | cdktn.IResolvable) {
  ...
  protected synthesizeAttributes(): { [name: string]: any } {
    return {
      ...
      hide_original_ip: cdktn.booleanToTerraform(this._hideOriginalIp),
      measurement_id: cdktn.stringToTerraform(this._measurementId),
      set_up_tag: cdktn.booleanToTerraform(this._setUpTag),
  ...
  protected synthesizeHclAttributes(): { [name: string]: any } {
    const attrs = {
      ...
      hide_original_ip: {
        value: cdktn.booleanToHclTerraform(this._hideOriginalIp),
        isBlock: false,
        type: "simple",
        storageClassType: "boolean",
      },
      measurement_id: {
        value: cdktn.stringToHclTerraform(this._measurementId),
        isBlock: false,
        type: "simple",
        storageClassType: "string",
      },
      set_up_tag: {
        value: cdktn.booleanToHclTerraform(this._setUpTag),
        isBlock: false,
        type: "simple",
        storageClassType: "boolean",
      },

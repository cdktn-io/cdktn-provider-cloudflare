...
// https://registry.terraform.io/providers/cloudflare/cloudflare/5.20.0/docs/resources/zero_trust_dlp_data_tag
...
export interface ZeroTrustDlpDataTagConfig extends cdktn.TerraformMetaArguments {
  /**
...
*/
export class ZeroTrustDlpDataTag extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing ZeroTrustDlpDataTag that should be imported. Refer to the {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.20.0/docs/resources/zero_trust_dlp_data_tag#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.20.0/docs/resources/zero_trust_dlp_data_tag cloudflare_zero_trust_dlp_data_tag} Resource
  *
  * @param scope The scope in which to define this construct

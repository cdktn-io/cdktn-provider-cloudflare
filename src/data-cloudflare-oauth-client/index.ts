...
// https://registry.terraform.io/providers/cloudflare/cloudflare/5.20.0/docs/data-sources/oauth_client
...
export class DataCloudflareOauthClientClientUriVerificationOutputReference extends cdktn.ComplexObject {
...
*/
export class DataCloudflareOauthClient extends cdktn.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataCloudflareOauthClient that should be imported. Refer to the {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.20.0/docs/data-sources/oauth_client#import import section} in the documentation of this resource for the id to use

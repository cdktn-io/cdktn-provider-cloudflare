...
// https://registry.terraform.io/providers/cloudflare/cloudflare/5.20.0/docs/resources/logpull_retention
...
export class LogpullRetention extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing LogpullRetention that should be imported. Refer to the {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.20.0/docs/resources/logpull_retention#import import section} in the documentation of this resource for the id to use

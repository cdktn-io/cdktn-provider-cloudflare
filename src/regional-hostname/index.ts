...
// https://registry.terraform.io/providers/cloudflare/cloudflare/5.20.0/docs/resources/regional_hostname
...
export class RegionalHostname extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing RegionalHostname that should be imported. Refer to the {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.20.0/docs/resources/regional_hostname#import import section} in the documentation of this resource for the id to use

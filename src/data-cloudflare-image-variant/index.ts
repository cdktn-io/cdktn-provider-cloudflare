...
// https://registry.terraform.io/providers/cloudflare/cloudflare/5.18.0/docs/data-sources/image_variant
...
export interface DataCloudflareImageVariantConfig extends cdktn.TerraformMetaArguments {
  /**
...
export class DataCloudflareImageVariantVariantOptionsOutputReference extends cdktn.ComplexObject {
...
export class DataCloudflareImageVariantVariantOutputReference extends cdktn.ComplexObject {
  private isEmptyObject = false;
...
export class DataCloudflareImageVariant extends cdktn.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataCloudflareImageVariant that should be imported. Refer to the {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.18.0/docs/data-sources/image_variant#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  protected synthesizeAttributes(): { [name: string]: any } {
    return {
      ...
      variant_id: cdktn.stringToTerraform(this._variantId),
    };
  }
  ...
  protected synthesizeHclAttributes(): { [name: string]: any } {
    const attrs = {
      ...
      variant_id: {
        value: cdktn.stringToHclTerraform(this._variantId),
        isBlock: false,
        type: "simple",
        storageClassType: "string",
      },

...
// https://registry.terraform.io/providers/cloudflare/cloudflare/5.17.0/docs/data-sources/magic_transit_site_wans
...
export interface DataCloudflareMagicTransitSiteWansConfig extends cdktn.TerraformMetaArguments {
  /**
  * Identifier
  *
...
export class DataCloudflareMagicTransitSiteWansResultStaticAddressingOutputReference extends cdktn.ComplexObject {
...
export class DataCloudflareMagicTransitSiteWansResultOutputReference extends cdktn.ComplexObject {
  private isEmptyObject = false;
...
export class DataCloudflareMagicTransitSiteWansResultList extends cdktn.ComplexList {
...
export class DataCloudflareMagicTransitSiteWans extends cdktn.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataCloudflareMagicTransitSiteWans that should be imported. Refer to the {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.17.0/docs/data-sources/magic_transit_site_wans#import import section} in the documentation of this resource for the id to use
  ...
  */
  public static generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: cdktn.TerraformProvider) {
        return new cdktn.ImportableResource(scope, importToId, { terraformResourceType: "cloudflare_magic_transit_site_wans", importId: importFromId, provider });
      }

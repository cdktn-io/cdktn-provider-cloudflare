...
export interface NelSettingConfig extends cdktn.TerraformMetaArguments {
  /**
...
export function nelSettingValueToTerraform(struct?: NelSettingValue | cdktn.IResolvable): any {
...
export function nelSettingValueToHclTerraform(struct?: NelSettingValue | cdktn.IResolvable): any {
  if (!cdktn.canInspect(struct) || cdktn.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktn.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdktn.io/docs/concepts/resources#references");
  }
...
export class NelSettingValueOutputReference extends cdktn.ComplexObject {
  ...
  */
  ...
  public get internalValue(): NelSettingValue | cdktn.IResolvable | undefined {
  ...
  public set internalValue(value: NelSettingValue | cdktn.IResolvable | undefined) {
    if (value === undefined) {

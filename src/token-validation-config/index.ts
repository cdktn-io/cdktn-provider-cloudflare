...
// https://registry.terraform.io/providers/cloudflare/cloudflare/5.25.0/docs/resources/token_validation_config
...
export function tokenValidationConfigCredentialsKeysToTerraform(struct?: TokenValidationConfigCredentialsKeys | cdktn.IResolvable): any {
  ...
  return {
    ...
    k: cdktn.stringToTerraform(struct!.k),
...
export function tokenValidationConfigCredentialsKeysToHclTerraform(struct?: TokenValidationConfigCredentialsKeys | cdktn.IResolvable): any {
  ...
  const attrs = {
    ...
    k: {
      value: cdktn.stringToHclTerraform(struct!.k),
      isBlock: false,
      type: "simple",
      storageClassType: "string",
    },
...
export class TokenValidationConfig extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing TokenValidationConfig that should be imported. Refer to the {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.25.0/docs/resources/token_validation_config#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.25.0/docs/resources/token_validation_config cloudflare_token_validation_config} Resource
  *
  * @param scope The scope in which to define this construct

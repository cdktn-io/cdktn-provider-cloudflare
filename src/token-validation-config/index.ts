...
// https://registry.terraform.io/providers/cloudflare/cloudflare/5.20.0/docs/resources/token_validation_config
...
export class TokenValidationConfig extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing TokenValidationConfig that should be imported. Refer to the {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.20.0/docs/resources/token_validation_config#import import section} in the documentation of this resource for the id to use

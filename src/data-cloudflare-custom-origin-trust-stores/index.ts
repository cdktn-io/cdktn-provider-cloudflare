...
// https://registry.terraform.io/providers/cloudflare/cloudflare/5.18.0/docs/data-sources/custom_origin_trust_stores
...
export interface DataCloudflareCustomOriginTrustStoresConfig extends cdktn.TerraformMetaArguments {
  /**
...
export class DataCloudflareCustomOriginTrustStoresResultOutputReference extends cdktn.ComplexObject {
...
export class DataCloudflareCustomOriginTrustStoresResultList extends cdktn.ComplexList {
...
*/
export class DataCloudflareCustomOriginTrustStores extends cdktn.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataCloudflareCustomOriginTrustStores that should be imported. Refer to the {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.18.0/docs/data-sources/custom_origin_trust_stores#import import section} in the documentation of this resource for the id to use
  ...
  */
  public static generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: cdktn.TerraformProvider) {
        return new cdktn.ImportableResource(scope, importToId, { terraformResourceType: "cloudflare_custom_origin_trust_stores", importId: importFromId, provider });
      }

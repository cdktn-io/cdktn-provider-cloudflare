...
export interface DataCloudflareHostnameTlsSettingsConfig extends cdktn.TerraformMetaArguments {
  /**
...
export class DataCloudflareHostnameTlsSettingsResultOutputReference extends cdktn.ComplexObject {
...
export class DataCloudflareHostnameTlsSettingsResultList extends cdktn.ComplexList {
...
*/
export class DataCloudflareHostnameTlsSettings extends cdktn.TerraformDataSource {
  ...
  */
  public static generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: cdktn.TerraformProvider) {
        return new cdktn.ImportableResource(scope, importToId, { terraformResourceType: "cloudflare_hostname_tls_settings", importId: importFromId, provider });
      }

...
// https://registry.terraform.io/providers/cloudflare/cloudflare/5.21.1/docs/data-sources/workflows
...
export function dataCloudflareWorkflowsResultInstancesToTerraform(struct?: DataCloudflareWorkflowsResultInstances): any {
...
export function dataCloudflareWorkflowsResultInstancesToHclTerraform(struct?: DataCloudflareWorkflowsResultInstances): any {
  if (!cdktn.canInspect(struct) || cdktn.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktn.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdktn.io/docs/concepts/resources#references");
  }
...
export class DataCloudflareWorkflowsResultInstancesOutputReference extends cdktn.ComplexObject {
  ...
  */
  ...
  public get internalValue(): DataCloudflareWorkflowsResultInstances | undefined {
    let hasAnyValues = this.isEmptyObject;
    const internalValueResult: any = {};
    return hasAnyValues ? internalValueResult : undefined;
  }

  public set internalValue(value: DataCloudflareWorkflowsResultInstances | undefined) {
    if (value === undefined) {
...
export class DataCloudflareWorkflowsResultSchedulesOutputReference extends cdktn.ComplexObject {
  private isEmptyObject = false;
...
export class DataCloudflareWorkflowsResultSchedulesList extends cdktn.ComplexList {
...
export function dataCloudflareWorkflowsResultToTerraform(struct?: DataCloudflareWorkflowsResult): any {
  if (!cdktn.canInspect(struct) || cdktn.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktn.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdktn.io/docs/concepts/resources#references");
  }
...
export function dataCloudflareWorkflowsResultToHclTerraform(struct?: DataCloudflareWorkflowsResult): any {
  if (!cdktn.canInspect(struct) || cdktn.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktn.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdktn.io/docs/concepts/resources#references");
  }
...
export class DataCloudflareWorkflowsResultOutputReference extends cdktn.ComplexObject {
  private isEmptyObject = false;
  ...
  */
  ...
  public get internalValue(): DataCloudflareWorkflowsResult | undefined {
    let hasAnyValues = this.isEmptyObject;
    const internalValueResult: any = {};
    return hasAnyValues ? internalValueResult : undefined;
  }

  public set internalValue(value: DataCloudflareWorkflowsResult | undefined) {
    if (value === undefined) {
      this.isEmptyObject = false;
    }
    else {
  ...
  private _instances = new DataCloudflareWorkflowsResultInstancesOutputReference(this, "instances");
...
export class DataCloudflareWorkflowsResultList extends cdktn.ComplexList {
...
*/
export class DataCloudflareWorkflows extends cdktn.TerraformDataSource {

  // =================
  // STATIC PROPERTIES
  // =================
  public static readonly tfResourceType = "cloudflare_workflows";
  ...
  * @param importFromId The id of the existing DataCloudflareWorkflows that should be imported. Refer to the {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.21.1/docs/data-sources/workflows#import import section} in the documentation of this resource for the id to use
  ...
  */
  public static generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: cdktn.TerraformProvider) {
        return new cdktn.ImportableResource(scope, importToId, { terraformResourceType: "cloudflare_workflows", importId: importFromId, provider });
      }
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.21.1/docs/data-sources/workflows cloudflare_workflows} Data Source
  *
  * @param scope The scope in which to define this construct
  * @param id The scoped construct ID. Must be unique amongst siblings in the same scope
  * @param options DataCloudflareWorkflowsConfig = {}
  */
  public constructor(scope: Construct, id: string, config: DataCloudflareWorkflowsConfig = {}) {
    super(scope, id, {
  ...
  private _result = new DataCloudflareWorkflowsResultList(this, "result", false);
  public get result() {
    return this._result;
  }

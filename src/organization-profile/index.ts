...
// https://registry.terraform.io/providers/cloudflare/cloudflare/5.20.0/docs/resources/organization_profile
...
export class OrganizationProfileA extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing OrganizationProfileA that should be imported. Refer to the {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.20.0/docs/resources/organization_profile#import import section} in the documentation of this resource for the id to use

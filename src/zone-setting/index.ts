...
// https://registry.terraform.io/providers/cloudflare/cloudflare/5.18.0/docs/resources/zone_setting
...
export interface ZoneSettingConfig extends cdktn.TerraformMetaArguments {
  /**
...
*/
export class ZoneSetting extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing ZoneSetting that should be imported. Refer to the {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.18.0/docs/resources/zone_setting#import import section} in the documentation of this resource for the id to use

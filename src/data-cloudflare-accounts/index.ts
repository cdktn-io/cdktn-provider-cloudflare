...
// https://registry.terraform.io/providers/cloudflare/cloudflare/5.18.0/docs/data-sources/accounts
...
export class DataCloudflareAccountsResultManagedByOutputReference extends cdktn.ComplexObject {
  ...
  */
  ...
  public get internalValue(): DataCloudflareAccountsResultManagedBy | undefined {
    let hasAnyValues = this.isEmptyObject;
    const internalValueResult: any = {};
    return hasAnyValues ? internalValueResult : undefined;
  }

  public set internalValue(value: DataCloudflareAccountsResultManagedBy | undefined) {
    if (value === undefined) {
...
export class DataCloudflareAccountsResultOutputReference extends cdktn.ComplexObject {
  ...
  */
  ...
  private _managedBy = new DataCloudflareAccountsResultManagedByOutputReference(this, "managed_by");
...
export class DataCloudflareAccounts extends cdktn.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataCloudflareAccounts that should be imported. Refer to the {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.18.0/docs/data-sources/accounts#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.18.0/docs/data-sources/accounts cloudflare_accounts} Data Source
  *
  * @param scope The scope in which to define this construct

...
// https://registry.terraform.io/providers/cloudflare/cloudflare/5.18.0/docs/data-sources/magic_transit_site_wan
...
export interface DataCloudflareMagicTransitSiteWanConfig extends cdktn.TerraformMetaArguments {
  /**
  * Identifier
  *
...
export class DataCloudflareMagicTransitSiteWanStaticAddressingOutputReference extends cdktn.ComplexObject {
...
*/
export class DataCloudflareMagicTransitSiteWan extends cdktn.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataCloudflareMagicTransitSiteWan that should be imported. Refer to the {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.18.0/docs/data-sources/magic_transit_site_wan#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.18.0/docs/data-sources/magic_transit_site_wan cloudflare_magic_transit_site_wan} Data Source
  *
  * @param scope The scope in which to define this construct
  ...
  */
  ...
  protected synthesizeAttributes(): { [name: string]: any } {
    return {
      ...
      wan_id: cdktn.stringToTerraform(this._wanId),
    };
  }
  ...
  protected synthesizeHclAttributes(): { [name: string]: any } {
    const attrs = {
      ...
      wan_id: {
        value: cdktn.stringToHclTerraform(this._wanId),
        isBlock: false,
        type: "simple",
        storageClassType: "string",
      },

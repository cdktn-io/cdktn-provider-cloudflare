...
// https://registry.terraform.io/providers/cloudflare/cloudflare/5.20.0/docs/resources/zero_trust_dlp_data_class
...
export interface ZeroTrustDlpDataClassConfig extends cdktn.TerraformMetaArguments {
  /**
  ...
  */
  readonly sensitivityLevels: ZeroTrustDlpDataClassSensitivityLevels[] | cdktn.IResolvable;
}
...
export function zeroTrustDlpDataClassSensitivityLevelsToTerraform(struct?: ZeroTrustDlpDataClassSensitivityLevels | cdktn.IResolvable): any {
...
export function zeroTrustDlpDataClassSensitivityLevelsToHclTerraform(struct?: ZeroTrustDlpDataClassSensitivityLevels | cdktn.IResolvable): any {
  if (!cdktn.canInspect(struct) || cdktn.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktn.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdktn.io/docs/concepts/resources#references");
  }
...
export class ZeroTrustDlpDataClassSensitivityLevelsOutputReference extends cdktn.ComplexObject {
  ...
  */
  ...
  public get internalValue(): ZeroTrustDlpDataClassSensitivityLevels | cdktn.IResolvable | undefined {
  ...
  public set internalValue(value: ZeroTrustDlpDataClassSensitivityLevels | cdktn.IResolvable | undefined) {
    if (value === undefined) {
...
export class ZeroTrustDlpDataClassSensitivityLevelsList extends cdktn.ComplexList {
  public internalValue? : ZeroTrustDlpDataClassSensitivityLevels[] | cdktn.IResolvable
...
*/
export class ZeroTrustDlpDataClass extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing ZeroTrustDlpDataClass that should be imported. Refer to the {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.20.0/docs/resources/zero_trust_dlp_data_class#import import section} in the documentation of this resource for the id to use
  ...
  */
  public static generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: cdktn.TerraformProvider) {
        return new cdktn.ImportableResource(scope, importToId, { terraformResourceType: "cloudflare_zero_trust_dlp_data_class", importId: importFromId, provider });
      }
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.20.0/docs/resources/zero_trust_dlp_data_class cloudflare_zero_trust_dlp_data_class} Resource
  *
  * @param scope The scope in which to define this construct
  ...
  */
  ...
  public putSensitivityLevels(value: ZeroTrustDlpDataClassSensitivityLevels[] | cdktn.IResolvable) {
  ...
  protected synthesizeAttributes(): { [name: string]: any } {
    return {
      ...
      sensitivity_levels: cdktn.listMapper(zeroTrustDlpDataClassSensitivityLevelsToTerraform, false)(this._sensitivityLevels.internalValue),
    };
  }
  ...
  protected synthesizeHclAttributes(): { [name: string]: any } {
    const attrs = {
      ...
      sensitivity_levels: {
        value: cdktn.listMapperHcl(zeroTrustDlpDataClassSensitivityLevelsToHclTerraform, false)(this._sensitivityLevels.internalValue),
        isBlock: true,
        type: "list",

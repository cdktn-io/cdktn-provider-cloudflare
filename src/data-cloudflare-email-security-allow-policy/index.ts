...
export interface DataCloudflareEmailSecurityAllowPolicyConfig extends cdktn.TerraformMetaArguments {
  /**
  * Identifier.
  *
...
export function dataCloudflareEmailSecurityAllowPolicyFilterToTerraform(struct?: DataCloudflareEmailSecurityAllowPolicyFilter | cdktn.IResolvable): any {
  ...
  return {
    ...
    is_acceptable_sender: cdktn.booleanToTerraform(struct!.isAcceptableSender),
    is_exempt_recipient: cdktn.booleanToTerraform(struct!.isExemptRecipient),
    is_trusted_sender: cdktn.booleanToTerraform(struct!.isTrustedSender),
    ...
    verify_sender: cdktn.booleanToTerraform(struct!.verifySender),
  }
}


export function dataCloudflareEmailSecurityAllowPolicyFilterToHclTerraform(struct?: DataCloudflareEmailSecurityAllowPolicyFilter | cdktn.IResolvable): any {
  if (!cdktn.canInspect(struct) || cdktn.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktn.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdktn.io/docs/concepts/resources#references");
  }
  const attrs = {
    ...
    is_acceptable_sender: {
      value: cdktn.booleanToHclTerraform(struct!.isAcceptableSender),
      isBlock: false,
      type: "simple",
      storageClassType: "boolean",
    },
    is_exempt_recipient: {
      value: cdktn.booleanToHclTerraform(struct!.isExemptRecipient),
      isBlock: false,
      type: "simple",
      storageClassType: "boolean",
    },
    is_trusted_sender: {
      value: cdktn.booleanToHclTerraform(struct!.isTrustedSender),
      isBlock: false,
      type: "simple",
      storageClassType: "boolean",
    },
    ...
    verify_sender: {
      value: cdktn.booleanToHclTerraform(struct!.verifySender),
      isBlock: false,
      type: "simple",
      storageClassType: "boolean",
    },
...
export class DataCloudflareEmailSecurityAllowPolicyFilterOutputReference extends cdktn.ComplexObject {
  ...
  */
  ...
  public get internalValue(): DataCloudflareEmailSecurityAllowPolicyFilter | cdktn.IResolvable | undefined {
  ...
  public set internalValue(value: DataCloudflareEmailSecurityAllowPolicyFilter | cdktn.IResolvable | undefined) {
    if (value === undefined) {
  ...
  private _isAcceptableSender?: boolean | cdktn.IResolvable; 
  public get isAcceptableSender() {
    return this.getBooleanAttribute('is_acceptable_sender');
  }
  public set isAcceptableSender(value: boolean | cdktn.IResolvable) {
  ...
  private _isExemptRecipient?: boolean | cdktn.IResolvable; 
  public get isExemptRecipient() {
    return this.getBooleanAttribute('is_exempt_recipient');
  }
  public set isExemptRecipient(value: boolean | cdktn.IResolvable) {
  ...
  private _isTrustedSender?: boolean | cdktn.IResolvable; 
  public get isTrustedSender() {
    return this.getBooleanAttribute('is_trusted_sender');
  }
  public set isTrustedSender(value: boolean | cdktn.IResolvable) {
  ...
  private _verifySender?: boolean | cdktn.IResolvable; 
  public get verifySender() {
    return this.getBooleanAttribute('verify_sender');
  }
  public set verifySender(value: boolean | cdktn.IResolvable) {
...
export class DataCloudflareEmailSecurityAllowPolicy extends cdktn.TerraformDataSource {
  ...
  */
  public static generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: cdktn.TerraformProvider) {
        return new cdktn.ImportableResource(scope, importToId, { terraformResourceType: "cloudflare_email_security_allow_policy", importId: importFromId, provider });
      }

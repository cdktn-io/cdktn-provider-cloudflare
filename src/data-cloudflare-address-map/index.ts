...
// https://registry.terraform.io/providers/cloudflare/cloudflare/5.20.0/docs/data-sources/address_map
...
export interface DataCloudflareAddressMapConfig extends cdktn.TerraformMetaArguments {
  /**
...
export class DataCloudflareAddressMapIpsOutputReference extends cdktn.ComplexObject {
...
export class DataCloudflareAddressMapIpsList extends cdktn.ComplexList {
...
export class DataCloudflareAddressMapMembershipsOutputReference extends cdktn.ComplexObject {
  private isEmptyObject = false;
...
export class DataCloudflareAddressMapMembershipsList extends cdktn.ComplexList {
...
*/
export class DataCloudflareAddressMap extends cdktn.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataCloudflareAddressMap that should be imported. Refer to the {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.20.0/docs/data-sources/address_map#import import section} in the documentation of this resource for the id to use
  ...
  */
  public static generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: cdktn.TerraformProvider) {
        return new cdktn.ImportableResource(scope, importToId, { terraformResourceType: "cloudflare_address_map", importId: importFromId, provider });
      }
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.20.0/docs/data-sources/address_map cloudflare_address_map} Data Source
  *
  * @param scope The scope in which to define this construct
  ...
  */
  ...
  protected synthesizeAttributes(): { [name: string]: any } {
    return {
      ...
      address_map_id: cdktn.stringToTerraform(this._addressMapId),
    };
  }
  ...
  protected synthesizeHclAttributes(): { [name: string]: any } {
    const attrs = {
      ...
      address_map_id: {
        value: cdktn.stringToHclTerraform(this._addressMapId),
        isBlock: false,
        type: "simple",
        storageClassType: "string",
      },

...
// https://registry.terraform.io/providers/cloudflare/cloudflare/5.24.0/docs/data-sources/api_shield_operation
...
export interface DataCloudflareApiShieldOperationConfig extends cdktn.TerraformMetaArguments {
  /**
  ...
  */
  ...
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.24.0/docs/data-sources/api_shield_operation#filter DataCloudflareApiShieldOperation#filter}
  */
  readonly filter?: DataCloudflareApiShieldOperationFilter;
  /**
  * UUID.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.24.0/docs/data-sources/api_shield_operation#operation_id DataCloudflareApiShieldOperation#operation_id}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.24.0/docs/data-sources/api_shield_operation#with_schemas DataCloudflareApiShieldOperation#with_schemas}
  */
  readonly withSchemas?: boolean | cdktn.IResolvable;
  /**
  * Identifier.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.24.0/docs/data-sources/api_shield_operation#zone_id DataCloudflareApiShieldOperation#zone_id}
  */
...
export class DataCloudflareApiShieldOperationFeaturesApiRoutingOutputReference extends cdktn.ComplexObject {
...
export class DataCloudflareApiShieldOperationFeaturesConfidenceIntervalsSuggestedThresholdConfidenceIntervalsP90OutputReference extends cdktn.ComplexObject {
  private isEmptyObject = false;
...
export class DataCloudflareApiShieldOperationFeaturesConfidenceIntervalsSuggestedThresholdConfidenceIntervalsP95OutputReference extends cdktn.ComplexObject {
  private isEmptyObject = false;
...
export class DataCloudflareApiShieldOperationFeaturesConfidenceIntervalsSuggestedThresholdConfidenceIntervalsP99OutputReference extends cdktn.ComplexObject {
  private isEmptyObject = false;
...
export class DataCloudflareApiShieldOperationFeaturesConfidenceIntervalsSuggestedThresholdConfidenceIntervalsOutputReference extends cdktn.ComplexObject {
  private isEmptyObject = false;
...
export class DataCloudflareApiShieldOperationFeaturesConfidenceIntervalsSuggestedThresholdOutputReference extends cdktn.ComplexObject {
  private isEmptyObject = false;
...
export class DataCloudflareApiShieldOperationFeaturesConfidenceIntervalsOutputReference extends cdktn.ComplexObject {
  private isEmptyObject = false;
...
export class DataCloudflareApiShieldOperationFeaturesParameterSchemasParameterSchemasOutputReference extends cdktn.ComplexObject {
  private isEmptyObject = false;
...
export class DataCloudflareApiShieldOperationFeaturesParameterSchemasOutputReference extends cdktn.ComplexObject {
  private isEmptyObject = false;
...
export class DataCloudflareApiShieldOperationFeaturesSchemaInfoActiveSchemaOutputReference extends cdktn.ComplexObject {
  private isEmptyObject = false;
...
export class DataCloudflareApiShieldOperationFeaturesSchemaInfoOutputReference extends cdktn.ComplexObject {
  private isEmptyObject = false;
...
export class DataCloudflareApiShieldOperationFeaturesThresholdsOutputReference extends cdktn.ComplexObject {
  private isEmptyObject = false;
...
export class DataCloudflareApiShieldOperationFeaturesOutputReference extends cdktn.ComplexObject {
  private isEmptyObject = false;
...
export function dataCloudflareApiShieldOperationFilterToTerraform(struct?: DataCloudflareApiShieldOperationFilter | cdktn.IResolvable): any {
  if (!cdktn.canInspect(struct) || cdktn.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktn.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdktn.io/docs/concepts/resources#references");
  }
  return {
    ...
    feature: cdktn.listMapper(cdktn.stringToTerraform, false)(struct!.feature),
    host: cdktn.listMapper(cdktn.stringToTerraform, false)(struct!.host),
...
export function dataCloudflareApiShieldOperationFilterToHclTerraform(struct?: DataCloudflareApiShieldOperationFilter | cdktn.IResolvable): any {
  if (!cdktn.canInspect(struct) || cdktn.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktn.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdktn.io/docs/concepts/resources#references");
  }
  const attrs = {
    ...
    feature: {
      value: cdktn.listMapperHcl(cdktn.stringToHclTerraform, false)(struct!.feature),
      isBlock: false,
      type: "list",
      storageClassType: "stringList",
    },
    host: {
      value: cdktn.listMapperHcl(cdktn.stringToHclTerraform, false)(struct!.host),
      isBlock: false,
      type: "list",
      storageClassType: "stringList",
    },
...
export class DataCloudflareApiShieldOperationFilterOutputReference extends cdktn.ComplexObject {
  private isEmptyObject = false;
  ...
  */
  ...
  public get internalValue(): DataCloudflareApiShieldOperationFilter | cdktn.IResolvable | undefined {
  ...
  public set internalValue(value: DataCloudflareApiShieldOperationFilter | cdktn.IResolvable | undefined) {
    if (value === undefined) {
      this.isEmptyObject = false;
...
export interface DataCloudflareApiShieldOperationSchemasLearned {
}

export function dataCloudflareApiShieldOperationSchemasLearnedToTerraform(struct?: DataCloudflareApiShieldOperationSchemasLearned): any {
  if (!cdktn.canInspect(struct) || cdktn.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktn.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdktn.io/docs/concepts/resources#references");
  }
...
export function dataCloudflareApiShieldOperationSchemasLearnedToHclTerraform(struct?: DataCloudflareApiShieldOperationSchemasLearned): any {
  if (!cdktn.canInspect(struct) || cdktn.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktn.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdktn.io/docs/concepts/resources#references");
  }
...
export class DataCloudflareApiShieldOperationSchemasLearnedOutputReference extends cdktn.ComplexObject {
  private isEmptyObject = false;
  ...
  */
  ...
  public get internalValue(): DataCloudflareApiShieldOperationSchemasLearned | undefined {
    let hasAnyValues = this.isEmptyObject;
    const internalValueResult: any = {};
    return hasAnyValues ? internalValueResult : undefined;
  }

  public set internalValue(value: DataCloudflareApiShieldOperationSchemasLearned | undefined) {
    if (value === undefined) {
      this.isEmptyObject = false;
    }
    else {
...
export interface DataCloudflareApiShieldOperationSchemasUploaded {
}

export function dataCloudflareApiShieldOperationSchemasUploadedToTerraform(struct?: DataCloudflareApiShieldOperationSchemasUploaded): any {
  if (!cdktn.canInspect(struct) || cdktn.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktn.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdktn.io/docs/concepts/resources#references");
  }
...
export function dataCloudflareApiShieldOperationSchemasUploadedToHclTerraform(struct?: DataCloudflareApiShieldOperationSchemasUploaded): any {
  if (!cdktn.canInspect(struct) || cdktn.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktn.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdktn.io/docs/concepts/resources#references");
  }
...
export class DataCloudflareApiShieldOperationSchemasUploadedOutputReference extends cdktn.ComplexObject {
  private isEmptyObject = false;
  ...
  */
  ...
  public get internalValue(): DataCloudflareApiShieldOperationSchemasUploaded | undefined {
    let hasAnyValues = this.isEmptyObject;
    const internalValueResult: any = {};
    return hasAnyValues ? internalValueResult : undefined;
  }

  public set internalValue(value: DataCloudflareApiShieldOperationSchemasUploaded | undefined) {
    if (value === undefined) {
      this.isEmptyObject = false;
    }
    else {
...
export interface DataCloudflareApiShieldOperationSchemas {
}

export function dataCloudflareApiShieldOperationSchemasToTerraform(struct?: DataCloudflareApiShieldOperationSchemas): any {
  if (!cdktn.canInspect(struct) || cdktn.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktn.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdktn.io/docs/concepts/resources#references");
  }
...
export function dataCloudflareApiShieldOperationSchemasToHclTerraform(struct?: DataCloudflareApiShieldOperationSchemas): any {
  if (!cdktn.canInspect(struct) || cdktn.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktn.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdktn.io/docs/concepts/resources#references");
  }
...
export class DataCloudflareApiShieldOperationSchemasOutputReference extends cdktn.ComplexObject {
  private isEmptyObject = false;
  ...
  */
  ...
  public get internalValue(): DataCloudflareApiShieldOperationSchemas | undefined {
    let hasAnyValues = this.isEmptyObject;
    const internalValueResult: any = {};
    return hasAnyValues ? internalValueResult : undefined;
  }

  public set internalValue(value: DataCloudflareApiShieldOperationSchemas | undefined) {
    if (value === undefined) {
      this.isEmptyObject = false;
    }
    else {
  ...
  private _learned = new DataCloudflareApiShieldOperationSchemasLearnedOutputReference(this, "learned");
  public get learned() {
    return this._learned;
  }

  // uploaded - computed: true, optional: false, required: false
  private _uploaded = new DataCloudflareApiShieldOperationSchemasUploadedOutputReference(this, "uploaded");
  public get uploaded() {
...
/**
* Represents a {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.24.0/docs/data-sources/api_shield_operation cloudflare_api_shield_operation}
*/
export class DataCloudflareApiShieldOperation extends cdktn.TerraformDataSource {
  ...
  // ==============
  /**
  * Generates CDKTN code for importing a DataCloudflareApiShieldOperation resource upon running "cdktn plan <stack-name>"
  ...
  * @param importFromId The id of the existing DataCloudflareApiShieldOperation that should be imported. Refer to the {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.24.0/docs/data-sources/api_shield_operation#import import section} in the documentation of this resource for the id to use
  ...
  */
  public static generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: cdktn.TerraformProvider) {
        return new cdktn.ImportableResource(scope, importToId, { terraformResourceType: "cloudflare_api_shield_operation", importId: importFromId, provider });
      }
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.24.0/docs/data-sources/api_shield_operation cloudflare_api_shield_operation} Data Source
  *
  * @param scope The scope in which to define this construct
  ...
  */
  ...
  private _schemas = new DataCloudflareApiShieldOperationSchemasOutputReference(this, "schemas");
  public get schemas() {

...
// https://registry.terraform.io/providers/cloudflare/cloudflare/5.20.0/docs/data-sources/pipeline_stream
...
export interface DataCloudflarePipelineStreamConfig extends cdktn.TerraformMetaArguments {
  /**
...
export function dataCloudflarePipelineStreamFilterToTerraform(struct?: DataCloudflarePipelineStreamFilter | cdktn.IResolvable): any {
...
export function dataCloudflarePipelineStreamFilterToHclTerraform(struct?: DataCloudflarePipelineStreamFilter | cdktn.IResolvable): any {
  if (!cdktn.canInspect(struct) || cdktn.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktn.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdktn.io/docs/concepts/resources#references");
  }
...
export class DataCloudflarePipelineStreamFilterOutputReference extends cdktn.ComplexObject {
  ...
  */
  ...
  public get internalValue(): DataCloudflarePipelineStreamFilter | cdktn.IResolvable | undefined {
  ...
  public set internalValue(value: DataCloudflarePipelineStreamFilter | cdktn.IResolvable | undefined) {
    if (value === undefined) {
...
export class DataCloudflarePipelineStreamFormatOutputReference extends cdktn.ComplexObject {
  private isEmptyObject = false;
...
export class DataCloudflarePipelineStreamHttpCorsOutputReference extends cdktn.ComplexObject {
  private isEmptyObject = false;
...
export class DataCloudflarePipelineStreamHttpOutputReference extends cdktn.ComplexObject {
  private isEmptyObject = false;
...
export class DataCloudflarePipelineStreamSchemaFieldsOutputReference extends cdktn.ComplexObject {
  private isEmptyObject = false;
...
export class DataCloudflarePipelineStreamSchemaFieldsList extends cdktn.ComplexList {
...
export class DataCloudflarePipelineStreamSchemaFormatOutputReference extends cdktn.ComplexObject {
  private isEmptyObject = false;
...
export class DataCloudflarePipelineStreamSchemaOutputReference extends cdktn.ComplexObject {
  private isEmptyObject = false;
...
export class DataCloudflarePipelineStreamWorkerBindingOutputReference extends cdktn.ComplexObject {
  private isEmptyObject = false;
...
*/
export class DataCloudflarePipelineStream extends cdktn.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataCloudflarePipelineStream that should be imported. Refer to the {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.20.0/docs/data-sources/pipeline_stream#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.20.0/docs/data-sources/pipeline_stream cloudflare_pipeline_stream} Data Source
  *
  * @param scope The scope in which to define this construct

...
// https://registry.terraform.io/providers/cloudflare/cloudflare/5.20.0/docs/data-sources/zero_trust_dlp_data_class
...
export class DataCloudflareZeroTrustDlpDataClassSensitivityLevelsOutputReference extends cdktn.ComplexObject {
...
export class DataCloudflareZeroTrustDlpDataClassSensitivityLevelsList extends cdktn.ComplexList {
...
*/
export class DataCloudflareZeroTrustDlpDataClass extends cdktn.TerraformDataSource {
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.20.0/docs/data-sources/zero_trust_dlp_data_class cloudflare_zero_trust_dlp_data_class} Data Source
  *
  * @param scope The scope in which to define this construct
  ...
  */
  ...
  protected synthesizeAttributes(): { [name: string]: any } {
    return {
      ...
      data_class_id: cdktn.stringToTerraform(this._dataClassId),
    };
  }
  ...
  protected synthesizeHclAttributes(): { [name: string]: any } {
    const attrs = {
      ...
      data_class_id: {
        value: cdktn.stringToHclTerraform(this._dataClassId),
        isBlock: false,
        type: "simple",
        storageClassType: "string",
      },

...
// https://registry.terraform.io/providers/cloudflare/cloudflare/5.20.0/docs/data-sources/share_resource
...
export function dataCloudflareShareResourceFilterToTerraform(struct?: DataCloudflareShareResourceFilter | cdktn.IResolvable): any {
...
export function dataCloudflareShareResourceFilterToHclTerraform(struct?: DataCloudflareShareResourceFilter | cdktn.IResolvable): any {
  if (!cdktn.canInspect(struct) || cdktn.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktn.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdktn.io/docs/concepts/resources#references");
  }
...
export class DataCloudflareShareResourceFilterOutputReference extends cdktn.ComplexObject {
  ...
  */
  ...
  public get internalValue(): DataCloudflareShareResourceFilter | cdktn.IResolvable | undefined {
  ...
  public set internalValue(value: DataCloudflareShareResourceFilter | cdktn.IResolvable | undefined) {
    if (value === undefined) {
...
*/
export class DataCloudflareShareResource extends cdktn.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataCloudflareShareResource that should be imported. Refer to the {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.20.0/docs/data-sources/share_resource#import import section} in the documentation of this resource for the id to use
  ...
  */
  public static generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: cdktn.TerraformProvider) {
        return new cdktn.ImportableResource(scope, importToId, { terraformResourceType: "cloudflare_share_resource", importId: importFromId, provider });
      }
  ...
  */
  ...
  protected synthesizeAttributes(): { [name: string]: any } {
    return {
      ...
      share_resource_id: cdktn.stringToTerraform(this._shareResourceId),
    };
  }
  ...
  protected synthesizeHclAttributes(): { [name: string]: any } {
    const attrs = {
      ...
      share_resource_id: {
        value: cdktn.stringToHclTerraform(this._shareResourceId),
        isBlock: false,
        type: "simple",
        storageClassType: "string",
      },

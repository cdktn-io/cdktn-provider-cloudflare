...
// https://registry.terraform.io/providers/cloudflare/cloudflare/5.21.1/docs/data-sources/magic_transit_site_lan
...
export interface DataCloudflareMagicTransitSiteLanConfig extends cdktn.TerraformMetaArguments {
  /**
  * Identifier
  *
...
export class DataCloudflareMagicTransitSiteLanNatOutputReference extends cdktn.ComplexObject {
...
export class DataCloudflareMagicTransitSiteLanRoutedSubnetsNatOutputReference extends cdktn.ComplexObject {
  private isEmptyObject = false;
...
export class DataCloudflareMagicTransitSiteLanRoutedSubnetsOutputReference extends cdktn.ComplexObject {
  private isEmptyObject = false;
...
export class DataCloudflareMagicTransitSiteLanRoutedSubnetsList extends cdktn.ComplexList {
...
export class DataCloudflareMagicTransitSiteLanStaticAddressingDhcpRelayOutputReference extends cdktn.ComplexObject {
  private isEmptyObject = false;
...
export interface DataCloudflareMagicTransitSiteLanStaticAddressingDhcpServerDhcpOptions {
}

export function dataCloudflareMagicTransitSiteLanStaticAddressingDhcpServerDhcpOptionsToTerraform(struct?: DataCloudflareMagicTransitSiteLanStaticAddressingDhcpServerDhcpOptions): any {
  if (!cdktn.canInspect(struct) || cdktn.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktn.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdktn.io/docs/concepts/resources#references");
  }
...
export function dataCloudflareMagicTransitSiteLanStaticAddressingDhcpServerDhcpOptionsToHclTerraform(struct?: DataCloudflareMagicTransitSiteLanStaticAddressingDhcpServerDhcpOptions): any {
  if (!cdktn.canInspect(struct) || cdktn.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktn.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdktn.io/docs/concepts/resources#references");
  }
...
export class DataCloudflareMagicTransitSiteLanStaticAddressingDhcpServerDhcpOptionsOutputReference extends cdktn.ComplexObject {
  private isEmptyObject = false;
  ...
  */
  ...
  public get internalValue(): DataCloudflareMagicTransitSiteLanStaticAddressingDhcpServerDhcpOptions | undefined {
    let hasAnyValues = this.isEmptyObject;
    const internalValueResult: any = {};
    return hasAnyValues ? internalValueResult : undefined;
  }

  public set internalValue(value: DataCloudflareMagicTransitSiteLanStaticAddressingDhcpServerDhcpOptions | undefined) {
    if (value === undefined) {
      this.isEmptyObject = false;
    }
    else {
...
export class DataCloudflareMagicTransitSiteLanStaticAddressingDhcpServerDhcpOptionsList extends cdktn.ComplexList {
  ...
  * @param index the index of the item to return
  */
  public get(index: number): DataCloudflareMagicTransitSiteLanStaticAddressingDhcpServerDhcpOptionsOutputReference {
    return new DataCloudflareMagicTransitSiteLanStaticAddressingDhcpServerDhcpOptionsOutputReference(this.terraformResource, this.terraformAttribute, index, this.wrapsSet);
  }
}
...
export class DataCloudflareMagicTransitSiteLanStaticAddressingDhcpServerOutputReference extends cdktn.ComplexObject {
  private isEmptyObject = false;
  ...
  */
  ...
  private _dhcpOptions = new DataCloudflareMagicTransitSiteLanStaticAddressingDhcpServerDhcpOptionsList(this, "dhcp_options", false);
  ...
  private _reservations = new cdktn.StringMap(this, "reservations");
...
export class DataCloudflareMagicTransitSiteLanStaticAddressingOutputReference extends cdktn.ComplexObject {
  private isEmptyObject = false;
...
*/
export class DataCloudflareMagicTransitSiteLan extends cdktn.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataCloudflareMagicTransitSiteLan that should be imported. Refer to the {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.21.1/docs/data-sources/magic_transit_site_lan#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.21.1/docs/data-sources/magic_transit_site_lan cloudflare_magic_transit_site_lan} Data Source
  *
  * @param scope The scope in which to define this construct
  ...
  */
  ...
  protected synthesizeAttributes(): { [name: string]: any } {
    return {
      ...
      lan_id: cdktn.stringToTerraform(this._lanId),
  ...
  protected synthesizeHclAttributes(): { [name: string]: any } {
    const attrs = {
      ...
      lan_id: {
        value: cdktn.stringToHclTerraform(this._lanId),
        isBlock: false,
        type: "simple",
        storageClassType: "string",
      },

...
// https://registry.terraform.io/providers/cloudflare/cloudflare/5.18.0/docs/data-sources/zone_dns_settings
...
export class DataCloudflareZoneDnsSettingsInternalDnsOutputReference extends cdktn.ComplexObject {
...
export class DataCloudflareZoneDnsSettingsNameserversOutputReference extends cdktn.ComplexObject {
  private isEmptyObject = false;
...
export class DataCloudflareZoneDnsSettingsSoaOutputReference extends cdktn.ComplexObject {
  private isEmptyObject = false;
...
export class DataCloudflareZoneDnsSettings extends cdktn.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataCloudflareZoneDnsSettings that should be imported. Refer to the {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.18.0/docs/data-sources/zone_dns_settings#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.18.0/docs/data-sources/zone_dns_settings cloudflare_zone_dns_settings} Data Source
  *
  * @param scope The scope in which to define this construct

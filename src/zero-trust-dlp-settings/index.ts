...
// https://registry.terraform.io/providers/cloudflare/cloudflare/5.24.0/docs/resources/zero_trust_dlp_settings
...
export interface ZeroTrustDlpSettingsConfig extends cdktn.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.24.0/docs/resources/zero_trust_dlp_settings#account_id ZeroTrustDlpSettings#account_id}
  */
  readonly accountId: string;
  /**
  * Whether AI context analysis is enabled at the account level.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.24.0/docs/resources/zero_trust_dlp_settings#ai_context_analysis ZeroTrustDlpSettings#ai_context_analysis}
  */
  readonly aiContextAnalysis?: boolean | cdktn.IResolvable;
  /**
  * Whether OCR is enabled at the account level.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.24.0/docs/resources/zero_trust_dlp_settings#ocr ZeroTrustDlpSettings#ocr}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.24.0/docs/resources/zero_trust_dlp_settings#payload_logging ZeroTrustDlpSettings#payload_logging}
  */
...
export function zeroTrustDlpSettingsPayloadLoggingToHclTerraform(struct?: ZeroTrustDlpSettingsPayloadLogging | cdktn.IResolvable): any {
  ...
  const attrs = {
    masking_level: {
      value: cdktn.stringToHclTerraform(struct!.maskingLevel),
      isBlock: false,
      type: "simple",
...
export class ZeroTrustDlpSettingsPayloadLoggingOutputReference extends cdktn.ComplexObject {
  ...
  */
  ...
  public get internalValue(): ZeroTrustDlpSettingsPayloadLogging | cdktn.IResolvable | undefined {
  ...
  public set internalValue(value: ZeroTrustDlpSettingsPayloadLogging | cdktn.IResolvable | undefined) {
    if (value === undefined) {
...
/**
* Represents a {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.24.0/docs/resources/zero_trust_dlp_settings cloudflare_zero_trust_dlp_settings}
*/
export class ZeroTrustDlpSettings extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing ZeroTrustDlpSettings that should be imported. Refer to the {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.24.0/docs/resources/zero_trust_dlp_settings#import import section} in the documentation of this resource for the id to use
  ...
  */
  public static generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: cdktn.TerraformProvider) {
        return new cdktn.ImportableResource(scope, importToId, { terraformResourceType: "cloudflare_zero_trust_dlp_settings", importId: importFromId, provider });
      }
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.24.0/docs/resources/zero_trust_dlp_settings cloudflare_zero_trust_dlp_settings} Resource
  *
  * @param scope The scope in which to define this construct
  ...
  */
  ...
  private _aiContextAnalysis?: boolean | cdktn.IResolvable; 
  public get aiContextAnalysis() {
    return this.getBooleanAttribute('ai_context_analysis');
  }
  public set aiContextAnalysis(value: boolean | cdktn.IResolvable) {
  ...
  private _ocr?: boolean | cdktn.IResolvable; 
  public get ocr() {
    return this.getBooleanAttribute('ocr');
  }
  public set ocr(value: boolean | cdktn.IResolvable) {
    this._ocr = value;
  }
  public resetOcr() {
    this._ocr = undefined;
  ...
  protected synthesizeAttributes(): { [name: string]: any } {
    return {
      ...
      ai_context_analysis: cdktn.booleanToTerraform(this._aiContextAnalysis),
      ocr: cdktn.booleanToTerraform(this._ocr),
  ...
  protected synthesizeHclAttributes(): { [name: string]: any } {
    const attrs = {
      ...
      ai_context_analysis: {
        value: cdktn.booleanToHclTerraform(this._aiContextAnalysis),
        isBlock: false,
        type: "simple",
        storageClassType: "boolean",
      },
      ocr: {
        value: cdktn.booleanToHclTerraform(this._ocr),
        isBlock: false,
        type: "simple",
        storageClassType: "boolean",
      },

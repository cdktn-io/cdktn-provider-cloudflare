...
// https://registry.terraform.io/providers/cloudflare/cloudflare/5.20.0/docs/data-sources/flagship_flag
...
export class DataCloudflareFlagshipFlagRulesConditionsClausesOutputReference extends cdktn.ComplexObject {
...
export class DataCloudflareFlagshipFlagRulesConditionsClausesList extends cdktn.ComplexList {
...
export class DataCloudflareFlagshipFlagRulesConditionsOutputReference extends cdktn.ComplexObject {
  private isEmptyObject = false;
...
export class DataCloudflareFlagshipFlagRulesConditionsList extends cdktn.ComplexList {
...
export class DataCloudflareFlagshipFlagRulesRolloutOutputReference extends cdktn.ComplexObject {
  private isEmptyObject = false;
...
export class DataCloudflareFlagshipFlagRulesOutputReference extends cdktn.ComplexObject {
  private isEmptyObject = false;
...
export class DataCloudflareFlagshipFlagRulesList extends cdktn.ComplexList {
...
export class DataCloudflareFlagshipFlag extends cdktn.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataCloudflareFlagshipFlag that should be imported. Refer to the {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.20.0/docs/data-sources/flagship_flag#import import section} in the documentation of this resource for the id to use

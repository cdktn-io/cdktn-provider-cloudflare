...
export interface DataCloudflareSpectrumProtocolsConfig extends cdktn.TerraformMetaArguments {
  /**
...
export class DataCloudflareSpectrumProtocolsResultOutputReference extends cdktn.ComplexObject {
...
export class DataCloudflareSpectrumProtocolsResultList extends cdktn.ComplexList {
...
export class DataCloudflareSpectrumProtocols extends cdktn.TerraformDataSource {
  ...
  */
  public static generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: cdktn.TerraformProvider) {
        return new cdktn.ImportableResource(scope, importToId, { terraformResourceType: "cloudflare_spectrum_protocols", importId: importFromId, provider });
      }

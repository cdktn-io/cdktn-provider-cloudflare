...
// https://registry.terraform.io/providers/cloudflare/cloudflare/5.20.0/docs/resources/custom_page_asset
...
export interface CustomPageAssetConfig extends cdktn.TerraformMetaArguments {
  /**
...
*/
export class CustomPageAsset extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing CustomPageAsset that should be imported. Refer to the {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.20.0/docs/resources/custom_page_asset#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.20.0/docs/resources/custom_page_asset cloudflare_custom_page_asset} Resource
  *
  * @param scope The scope in which to define this construct

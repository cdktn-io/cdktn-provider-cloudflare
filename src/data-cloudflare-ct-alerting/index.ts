...
export interface DataCloudflareCtAlertingConfig extends cdktn.TerraformMetaArguments {
  /**
  * Identifier.
  *
...
*/
export class DataCloudflareCtAlerting extends cdktn.TerraformDataSource {

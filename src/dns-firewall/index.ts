...
// https://registry.terraform.io/providers/cloudflare/cloudflare/5.20.0/docs/resources/dns_firewall
...
export class DnsFirewall extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing DnsFirewall that should be imported. Refer to the {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.20.0/docs/resources/dns_firewall#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  protected synthesizeAttributes(): { [name: string]: any } {
    return {
      ...
      dns_firewall_ip_count: cdktn.numberToTerraform(this._dnsFirewallIpCount),
  ...
  protected synthesizeHclAttributes(): { [name: string]: any } {
    const attrs = {
      ...
      dns_firewall_ip_count: {
        value: cdktn.numberToHclTerraform(this._dnsFirewallIpCount),
        isBlock: false,
        type: "simple",

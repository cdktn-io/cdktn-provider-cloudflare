...
// https://registry.terraform.io/providers/cloudflare/cloudflare/5.18.0/docs/resources/zone_lockdown
...
export interface ZoneLockdownConfig extends cdktn.TerraformMetaArguments {
  /**
  ...
  */
  readonly configurations: ZoneLockdownConfigurations[] | cdktn.IResolvable;
  /**
...
export function zoneLockdownConfigurationsToTerraform(struct?: ZoneLockdownConfigurations | cdktn.IResolvable): any {
...
export function zoneLockdownConfigurationsToHclTerraform(struct?: ZoneLockdownConfigurations | cdktn.IResolvable): any {
  if (!cdktn.canInspect(struct) || cdktn.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktn.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
...
export class ZoneLockdownConfigurationsOutputReference extends cdktn.ComplexObject {
  ...
  */
  ...
  public get internalValue(): ZoneLockdownConfigurations | cdktn.IResolvable | undefined {
  ...
  public set internalValue(value: ZoneLockdownConfigurations | cdktn.IResolvable | undefined) {
    if (value === undefined) {
...
export class ZoneLockdownConfigurationsList extends cdktn.ComplexList {
  public internalValue? : ZoneLockdownConfigurations[] | cdktn.IResolvable
...
*/
export class ZoneLockdown extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing ZoneLockdown that should be imported. Refer to the {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.18.0/docs/resources/zone_lockdown#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.18.0/docs/resources/zone_lockdown cloudflare_zone_lockdown} Resource
  *
  * @param scope The scope in which to define this construct
  ...
  */
  ...
  public putConfigurations(value: ZoneLockdownConfigurations[] | cdktn.IResolvable) {
  ...
  protected synthesizeAttributes(): { [name: string]: any } {
    return {
      configurations: cdktn.listMapper(zoneLockdownConfigurationsToTerraform, false)(this._configurations.internalValue),
      description: cdktn.stringToTerraform(this._description),
      paused: cdktn.booleanToTerraform(this._paused),
      priority: cdktn.numberToTerraform(this._priority),
      urls: cdktn.listMapper(cdktn.stringToTerraform, false)(this._urls),
  ...
  protected synthesizeHclAttributes(): { [name: string]: any } {
    const attrs = {
      configurations: {
        value: cdktn.listMapperHcl(zoneLockdownConfigurationsToHclTerraform, false)(this._configurations.internalValue),
        isBlock: true,
        type: "list",
      ...
      urls: {
        value: cdktn.listMapperHcl(cdktn.stringToHclTerraform, false)(this._urls),
        isBlock: false,
        type: "list",

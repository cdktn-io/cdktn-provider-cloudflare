...
// https://registry.terraform.io/providers/cloudflare/cloudflare/5.18.0/docs/resources/dns_zone_transfers_peer
...
export interface DnsZoneTransfersPeerConfig extends cdktn.TerraformMetaArguments {
  /**
  ...
  */
  readonly ixfrEnable?: boolean | cdktn.IResolvable;
  /**
...
*/
export class DnsZoneTransfersPeer extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing DnsZoneTransfersPeer that should be imported. Refer to the {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.18.0/docs/resources/dns_zone_transfers_peer#import import section} in the documentation of this resource for the id to use
  ...
  */
  public static generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: cdktn.TerraformProvider) {
        return new cdktn.ImportableResource(scope, importToId, { terraformResourceType: "cloudflare_dns_zone_transfers_peer", importId: importFromId, provider });
      }
  ...
  */
  ...
  private _ixfrEnable?: boolean | cdktn.IResolvable; 
  public get ixfrEnable() {
    return this.getBooleanAttribute('ixfr_enable');
  }
  public set ixfrEnable(value: boolean | cdktn.IResolvable) {
  ...
  protected synthesizeAttributes(): { [name: string]: any } {
    return {
      ...
      ixfr_enable: cdktn.booleanToTerraform(this._ixfrEnable),
  ...
  protected synthesizeHclAttributes(): { [name: string]: any } {
    const attrs = {
      ...
      ixfr_enable: {
        value: cdktn.booleanToHclTerraform(this._ixfrEnable),
        isBlock: false,
        type: "simple",

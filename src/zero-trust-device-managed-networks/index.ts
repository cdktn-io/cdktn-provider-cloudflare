...
// https://registry.terraform.io/providers/cloudflare/cloudflare/5.18.0/docs/resources/zero_trust_device_managed_networks
...
export interface ZeroTrustDeviceManagedNetworksConfig extends cdktn.TerraformMetaArguments {
  /**
...
export function zeroTrustDeviceManagedNetworksConfigAToTerraform(struct?: ZeroTrustDeviceManagedNetworksConfigA | cdktn.IResolvable): any {
  ...
  return {
    ...
    tls_sockaddr: cdktn.stringToTerraform(struct!.tlsSockaddr),
  }
}


export function zeroTrustDeviceManagedNetworksConfigAToHclTerraform(struct?: ZeroTrustDeviceManagedNetworksConfigA | cdktn.IResolvable): any {
  if (!cdktn.canInspect(struct) || cdktn.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktn.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
  const attrs = {
    ...
    tls_sockaddr: {
      value: cdktn.stringToHclTerraform(struct!.tlsSockaddr),
      isBlock: false,
      type: "simple",
      storageClassType: "string",
    },
...
export class ZeroTrustDeviceManagedNetworksConfigAOutputReference extends cdktn.ComplexObject {
  ...
  */
  ...
  public get internalValue(): ZeroTrustDeviceManagedNetworksConfigA | cdktn.IResolvable | undefined {
  ...
  public set internalValue(value: ZeroTrustDeviceManagedNetworksConfigA | cdktn.IResolvable | undefined) {
    if (value === undefined) {
...
*/
export class ZeroTrustDeviceManagedNetworks extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing ZeroTrustDeviceManagedNetworks that should be imported. Refer to the {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.18.0/docs/resources/zero_trust_device_managed_networks#import import section} in the documentation of this resource for the id to use
  ...
  */
  public static generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: cdktn.TerraformProvider) {
        return new cdktn.ImportableResource(scope, importToId, { terraformResourceType: "cloudflare_zero_trust_device_managed_networks", importId: importFromId, provider });
      }
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.18.0/docs/resources/zero_trust_device_managed_networks cloudflare_zero_trust_device_managed_networks} Resource
  *
  * @param scope The scope in which to define this construct

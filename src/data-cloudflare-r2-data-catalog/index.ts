...
export interface DataCloudflareR2DataCatalogConfig extends cdktn.TerraformMetaArguments {
  /**
...
export class DataCloudflareR2DataCatalogMaintenanceConfigCompactionOutputReference extends cdktn.ComplexObject {
...
export class DataCloudflareR2DataCatalogMaintenanceConfigSnapshotExpirationOutputReference extends cdktn.ComplexObject {
  private isEmptyObject = false;
...
export class DataCloudflareR2DataCatalogMaintenanceConfigOutputReference extends cdktn.ComplexObject {
  private isEmptyObject = false;

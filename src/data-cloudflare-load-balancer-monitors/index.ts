...
// https://registry.terraform.io/providers/cloudflare/cloudflare/5.17.0/docs/data-sources/load_balancer_monitors
...
export class DataCloudflareLoadBalancerMonitorsResultOutputReference extends cdktn.ComplexObject {
...
export class DataCloudflareLoadBalancerMonitorsResultList extends cdktn.ComplexList {
...
*/
export class DataCloudflareLoadBalancerMonitors extends cdktn.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataCloudflareLoadBalancerMonitors that should be imported. Refer to the {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.17.0/docs/data-sources/load_balancer_monitors#import import section} in the documentation of this resource for the id to use
  ...
  */
  public static generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: cdktn.TerraformProvider) {
        return new cdktn.ImportableResource(scope, importToId, { terraformResourceType: "cloudflare_load_balancer_monitors", importId: importFromId, provider });
      }

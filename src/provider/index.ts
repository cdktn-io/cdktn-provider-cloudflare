...
// https://registry.terraform.io/providers/cloudflare/cloudflare/5.18.0/docs
...
*/
export class CloudflareProvider extends cdktn.TerraformProvider {
  ...
  * @param importFromId The id of the existing CloudflareProvider that should be imported. Refer to the {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.18.0/docs#import import section} in the documentation of this resource for the id to use
  * @param provider? Optional instance of the provider where the CloudflareProvider to import is found
  */
  public static generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: cdktn.TerraformProvider) {
        return new cdktn.ImportableResource(scope, importToId, { terraformResourceType: "cloudflare", importId: importFromId, provider });
      }
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.18.0/docs cloudflare} Resource
  *
  * @param scope The scope in which to define this construct
  ...
  */
  ...
  protected synthesizeAttributes(): { [name: string]: any } {
    return {
      ...
      api_user_service_key: cdktn.stringToTerraform(this._apiUserServiceKey),
      base_url: cdktn.stringToTerraform(this._baseUrl),
      email: cdktn.stringToTerraform(this._email),
      user_agent_operator_suffix: cdktn.stringToTerraform(this._userAgentOperatorSuffix),
  ...
  protected synthesizeHclAttributes(): { [name: string]: any } {
    const attrs = {
      ...
      api_user_service_key: {
        value: cdktn.stringToHclTerraform(this._apiUserServiceKey),
        isBlock: false,
        type: "simple",
        storageClassType: "string",
      },
      ...
      user_agent_operator_suffix: {
        value: cdktn.stringToHclTerraform(this._userAgentOperatorSuffix),
        isBlock: false,
        type: "simple",
        storageClassType: "string",
      },

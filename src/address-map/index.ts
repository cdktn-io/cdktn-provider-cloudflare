...
// https://registry.terraform.io/providers/cloudflare/cloudflare/5.18.0/docs/resources/address_map
...
export interface AddressMapConfig extends cdktn.TerraformMetaArguments {
  /**
  ...
  */
  readonly memberships?: AddressMapMemberships[] | cdktn.IResolvable;
}
...
export function addressMapMembershipsToTerraform(struct?: AddressMapMemberships | cdktn.IResolvable): any {
...
export function addressMapMembershipsToHclTerraform(struct?: AddressMapMemberships | cdktn.IResolvable): any {
  if (!cdktn.canInspect(struct) || cdktn.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktn.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
...
export class AddressMapMembershipsOutputReference extends cdktn.ComplexObject {
  ...
  */
  ...
  public get internalValue(): AddressMapMemberships | cdktn.IResolvable | undefined {
  ...
  public set internalValue(value: AddressMapMemberships | cdktn.IResolvable | undefined) {
    if (value === undefined) {
...
export class AddressMapMembershipsList extends cdktn.ComplexList {
  public internalValue? : AddressMapMemberships[] | cdktn.IResolvable
...
*/
export class AddressMap extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing AddressMap that should be imported. Refer to the {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.18.0/docs/resources/address_map#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  public putMemberships(value: AddressMapMemberships[] | cdktn.IResolvable) {
  ...
  protected synthesizeAttributes(): { [name: string]: any } {
    return {
      ...
      default_sni: cdktn.stringToTerraform(this._defaultSni),
      description: cdktn.stringToTerraform(this._description),
      enabled: cdktn.booleanToTerraform(this._enabled),
      ips: cdktn.listMapper(cdktn.stringToTerraform, false)(this._ips),
      memberships: cdktn.listMapper(addressMapMembershipsToTerraform, false)(this._memberships.internalValue),
    };
  }
  ...
  protected synthesizeHclAttributes(): { [name: string]: any } {
    const attrs = {
      ...
      default_sni: {
        value: cdktn.stringToHclTerraform(this._defaultSni),
        isBlock: false,
        type: "simple",
        storageClassType: "string",
      },
      ...
      memberships: {
        value: cdktn.listMapperHcl(addressMapMembershipsToHclTerraform, false)(this._memberships.internalValue),
        isBlock: true,
        type: "list",

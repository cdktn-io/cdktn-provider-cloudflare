...
// https://registry.terraform.io/providers/cloudflare/cloudflare/5.20.0/docs/resources/address_map
...
export class AddressMap extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing AddressMap that should be imported. Refer to the {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.20.0/docs/resources/address_map#import import section} in the documentation of this resource for the id to use

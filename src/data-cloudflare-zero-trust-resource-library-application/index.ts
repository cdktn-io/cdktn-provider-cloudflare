...
export interface DataCloudflareZeroTrustResourceLibraryApplicationConfig extends cdktn.TerraformMetaArguments {
  /**
...
export function dataCloudflareZeroTrustResourceLibraryApplicationFilterToTerraform(struct?: DataCloudflareZeroTrustResourceLibraryApplicationFilter | cdktn.IResolvable): any {
...
export function dataCloudflareZeroTrustResourceLibraryApplicationFilterToHclTerraform(struct?: DataCloudflareZeroTrustResourceLibraryApplicationFilter | cdktn.IResolvable): any {
  if (!cdktn.canInspect(struct) || cdktn.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktn.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdktn.io/docs/concepts/resources#references");
  }
...
export class DataCloudflareZeroTrustResourceLibraryApplicationFilterOutputReference extends cdktn.ComplexObject {
  ...
  */
  ...
  public get internalValue(): DataCloudflareZeroTrustResourceLibraryApplicationFilter | cdktn.IResolvable | undefined {
  ...
  public set internalValue(value: DataCloudflareZeroTrustResourceLibraryApplicationFilter | cdktn.IResolvable | undefined) {
    if (value === undefined) {
...
*/
export class DataCloudflareZeroTrustResourceLibraryApplication extends cdktn.TerraformDataSource {
  ...
  */
  public static generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: cdktn.TerraformProvider) {
        return new cdktn.ImportableResource(scope, importToId, { terraformResourceType: "cloudflare_zero_trust_resource_library_application", importId: importFromId, provider });
      }
  ...
  */
  ...
  public get hostnames() {
    return cdktn.Fn.tolist(this.getListAttribute('hostnames'));
  }
  ...
  public get ipSubnets() {
    return cdktn.Fn.tolist(this.getListAttribute('ip_subnets'));
  }
  ...
  public get portProtocols() {
    return cdktn.Fn.tolist(this.getListAttribute('port_protocols'));
  }

  // support_domains - computed: true, optional: false, required: false
  public get supportDomains() {
    return cdktn.Fn.tolist(this.getListAttribute('support_domains'));
  }

  // supported - computed: true, optional: false, required: false
  public get supported() {
    return cdktn.Fn.tolist(this.getListAttribute('supported'));
  }

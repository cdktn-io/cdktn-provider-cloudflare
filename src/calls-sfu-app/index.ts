...
// https://registry.terraform.io/providers/cloudflare/cloudflare/5.25.0/docs/resources/calls_sfu_app
...
export class CallsSfuApp extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing CallsSfuApp that should be imported. Refer to the {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.25.0/docs/resources/calls_sfu_app#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.25.0/docs/resources/calls_sfu_app cloudflare_calls_sfu_app} Resource
  *
  * @param scope The scope in which to define this construct

...
// https://registry.terraform.io/providers/cloudflare/cloudflare/5.19.1/docs/resources/content_scanning
...
export class ContentScanning extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing ContentScanning that should be imported. Refer to the {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.19.1/docs/resources/content_scanning#import import section} in the documentation of this resource for the id to use

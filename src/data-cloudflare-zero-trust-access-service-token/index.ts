...
// https://registry.terraform.io/providers/cloudflare/cloudflare/5.18.0/docs/data-sources/zero_trust_access_service_token
...
export interface DataCloudflareZeroTrustAccessServiceTokenConfig extends cdktn.TerraformMetaArguments {
  /**
...
export function dataCloudflareZeroTrustAccessServiceTokenFilterToTerraform(struct?: DataCloudflareZeroTrustAccessServiceTokenFilter | cdktn.IResolvable): any {
...
export function dataCloudflareZeroTrustAccessServiceTokenFilterToHclTerraform(struct?: DataCloudflareZeroTrustAccessServiceTokenFilter | cdktn.IResolvable): any {
  if (!cdktn.canInspect(struct) || cdktn.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktn.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
...
export class DataCloudflareZeroTrustAccessServiceTokenFilterOutputReference extends cdktn.ComplexObject {
  ...
  */
  ...
  public get internalValue(): DataCloudflareZeroTrustAccessServiceTokenFilter | cdktn.IResolvable | undefined {
  ...
  public set internalValue(value: DataCloudflareZeroTrustAccessServiceTokenFilter | cdktn.IResolvable | undefined) {
    if (value === undefined) {
...
*/
export class DataCloudflareZeroTrustAccessServiceToken extends cdktn.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataCloudflareZeroTrustAccessServiceToken that should be imported. Refer to the {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.18.0/docs/data-sources/zero_trust_access_service_token#import import section} in the documentation of this resource for the id to use
  ...
  */
  public static generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: cdktn.TerraformProvider) {
        return new cdktn.ImportableResource(scope, importToId, { terraformResourceType: "cloudflare_zero_trust_access_service_token", importId: importFromId, provider });
      }
  ...
  */
  ...
  protected synthesizeAttributes(): { [name: string]: any } {
    return {
      ...
      service_token_id: cdktn.stringToTerraform(this._serviceTokenId),
  ...
  protected synthesizeHclAttributes(): { [name: string]: any } {
    const attrs = {
      ...
      service_token_id: {
        value: cdktn.stringToHclTerraform(this._serviceTokenId),
        isBlock: false,
        type: "simple",
        storageClassType: "string",
      },

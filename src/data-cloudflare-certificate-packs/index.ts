...
// https://registry.terraform.io/providers/cloudflare/cloudflare/5.18.0/docs/data-sources/certificate_packs
...
export class DataCloudflareCertificatePacksResultCertificatesGeoRestrictionsOutputReference extends cdktn.ComplexObject {
...
export class DataCloudflareCertificatePacksResultCertificatesOutputReference extends cdktn.ComplexObject {
  private isEmptyObject = false;
...
export class DataCloudflareCertificatePacksResultCertificatesList extends cdktn.ComplexList {
...
export class DataCloudflareCertificatePacksResultDcvDelegationRecordsOutputReference extends cdktn.ComplexObject {
  private isEmptyObject = false;
...
export class DataCloudflareCertificatePacksResultDcvDelegationRecordsList extends cdktn.ComplexList {
...
export class DataCloudflareCertificatePacksResultValidationErrorsOutputReference extends cdktn.ComplexObject {
  private isEmptyObject = false;
...
export class DataCloudflareCertificatePacksResultValidationErrorsList extends cdktn.ComplexList {
...
export class DataCloudflareCertificatePacksResultValidationRecordsOutputReference extends cdktn.ComplexObject {
  private isEmptyObject = false;
...
export class DataCloudflareCertificatePacksResultValidationRecordsList extends cdktn.ComplexList {
...
export class DataCloudflareCertificatePacksResultOutputReference extends cdktn.ComplexObject {
  private isEmptyObject = false;
...
export class DataCloudflareCertificatePacksResultList extends cdktn.ComplexList {
...
export class DataCloudflareCertificatePacks extends cdktn.TerraformDataSource {
  ...
  */
  public static generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: cdktn.TerraformProvider) {
        return new cdktn.ImportableResource(scope, importToId, { terraformResourceType: "cloudflare_certificate_packs", importId: importFromId, provider });
      }
  ...
  */
  ...
  protected synthesizeAttributes(): { [name: string]: any } {
    return {
      deploy: cdktn.stringToTerraform(this._deploy),
  ...
  protected synthesizeHclAttributes(): { [name: string]: any } {
    const attrs = {
      deploy: {
        value: cdktn.stringToHclTerraform(this._deploy),
        isBlock: false,
        type: "simple",

...
// https://registry.terraform.io/providers/cloudflare/cloudflare/5.25.0/docs/data-sources/ai_gateway_dynamic_routing
...
export interface DataCloudflareAiGatewayDynamicRoutingConfig extends cdktn.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.25.0/docs/data-sources/ai_gateway_dynamic_routing#account_id DataCloudflareAiGatewayDynamicRouting#account_id}
  */
  readonly accountId?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.25.0/docs/data-sources/ai_gateway_dynamic_routing#gateway_id DataCloudflareAiGatewayDynamicRouting#gateway_id}
  */
  readonly gatewayId: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.25.0/docs/data-sources/ai_gateway_dynamic_routing#id DataCloudflareAiGatewayDynamicRouting#id}
  *
...
export class DataCloudflareAiGatewayDynamicRoutingDeploymentOutputReference extends cdktn.ComplexObject {
...
export class DataCloudflareAiGatewayDynamicRoutingElementsOutputsFallbackOutputReference extends cdktn.ComplexObject {
  private isEmptyObject = false;
...
export class DataCloudflareAiGatewayDynamicRoutingElementsOutputsFalseOutputReference extends cdktn.ComplexObject {
  private isEmptyObject = false;
...
export class DataCloudflareAiGatewayDynamicRoutingElementsOutputsNextOutputReference extends cdktn.ComplexObject {
  private isEmptyObject = false;
...
export class DataCloudflareAiGatewayDynamicRoutingElementsOutputsSuccessOutputReference extends cdktn.ComplexObject {
  private isEmptyObject = false;
...
export class DataCloudflareAiGatewayDynamicRoutingElementsOutputsTrueOutputReference extends cdktn.ComplexObject {
  private isEmptyObject = false;
...
export class DataCloudflareAiGatewayDynamicRoutingElementsOutputsOutputReference extends cdktn.ComplexObject {
  private isEmptyObject = false;
...
export class DataCloudflareAiGatewayDynamicRoutingElementsPropertiesOutputReference extends cdktn.ComplexObject {
  private isEmptyObject = false;
...
export class DataCloudflareAiGatewayDynamicRoutingElementsOutputReference extends cdktn.ComplexObject {
  private isEmptyObject = false;
...
export class DataCloudflareAiGatewayDynamicRoutingElementsList extends cdktn.ComplexList {
...
export class DataCloudflareAiGatewayDynamicRoutingVersionOutputReference extends cdktn.ComplexObject {
  private isEmptyObject = false;
...
/**
* Represents a {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.25.0/docs/data-sources/ai_gateway_dynamic_routing cloudflare_ai_gateway_dynamic_routing}
*/
export class DataCloudflareAiGatewayDynamicRouting extends cdktn.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataCloudflareAiGatewayDynamicRouting that should be imported. Refer to the {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.25.0/docs/data-sources/ai_gateway_dynamic_routing#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.25.0/docs/data-sources/ai_gateway_dynamic_routing cloudflare_ai_gateway_dynamic_routing} Data Source
  *
  * @param scope The scope in which to define this construct

...
// https://registry.terraform.io/providers/cloudflare/cloudflare/5.20.0/docs/resources/page_rule
...
export class PageRule extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing PageRule that should be imported. Refer to the {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.20.0/docs/resources/page_rule#import import section} in the documentation of this resource for the id to use

...
// https://registry.terraform.io/providers/cloudflare/cloudflare/5.25.0/docs/data-sources/moq_relay
...
export interface DataCloudflareMoqRelayConfig extends cdktn.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.25.0/docs/data-sources/moq_relay#account_id DataCloudflareMoqRelay#account_id}
  */
  readonly accountId: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.25.0/docs/data-sources/moq_relay#filter DataCloudflareMoqRelay#filter}
  */
  readonly filter?: DataCloudflareMoqRelayFilter;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.25.0/docs/data-sources/moq_relay#relay_id DataCloudflareMoqRelay#relay_id}
  */
...
export class DataCloudflareMoqRelayConfigLingeringSubscribeOutputReference extends cdktn.ComplexObject {
...
export class DataCloudflareMoqRelayConfigUpstreamsUpstreamsOutputReference extends cdktn.ComplexObject {
  private isEmptyObject = false;
...
export class DataCloudflareMoqRelayConfigUpstreamsUpstreamsList extends cdktn.ComplexList {
...
export class DataCloudflareMoqRelayConfigUpstreamsOutputReference extends cdktn.ComplexObject {
  private isEmptyObject = false;
...
export class DataCloudflareMoqRelayConfigAOutputReference extends cdktn.ComplexObject {
  private isEmptyObject = false;
...
export interface DataCloudflareMoqRelayFilter {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.25.0/docs/data-sources/moq_relay#asc DataCloudflareMoqRelay#asc}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.25.0/docs/data-sources/moq_relay#created_after DataCloudflareMoqRelay#created_after}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.25.0/docs/data-sources/moq_relay#created_before DataCloudflareMoqRelay#created_before}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.25.0/docs/data-sources/moq_relay#per_page DataCloudflareMoqRelay#per_page}
  */
  readonly perPage?: number;
}

export function dataCloudflareMoqRelayFilterToTerraform(struct?: DataCloudflareMoqRelayFilter | cdktn.IResolvable): any {
  if (!cdktn.canInspect(struct) || cdktn.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktn.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdktn.io/docs/concepts/resources#references");
  }
  return {
    asc: cdktn.booleanToTerraform(struct!.asc),
...
export function dataCloudflareMoqRelayFilterToHclTerraform(struct?: DataCloudflareMoqRelayFilter | cdktn.IResolvable): any {
  if (!cdktn.canInspect(struct) || cdktn.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktn.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdktn.io/docs/concepts/resources#references");
  }
  const attrs = {
    asc: {
      value: cdktn.booleanToHclTerraform(struct!.asc),
      isBlock: false,
      type: "simple",
...
export class DataCloudflareMoqRelayFilterOutputReference extends cdktn.ComplexObject {
  private isEmptyObject = false;
  ...
  */
  ...
  public get internalValue(): DataCloudflareMoqRelayFilter | cdktn.IResolvable | undefined {
  ...
  public set internalValue(value: DataCloudflareMoqRelayFilter | cdktn.IResolvable | undefined) {
    if (value === undefined) {
      this.isEmptyObject = false;
  ...
  private _asc?: boolean | cdktn.IResolvable; 
  public get asc() {
    return this.getBooleanAttribute('asc');
  }
  public set asc(value: boolean | cdktn.IResolvable) {
    this._asc = value;
  }
  public resetAsc() {
    this._asc = undefined;
...
/**
* Represents a {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.25.0/docs/data-sources/moq_relay cloudflare_moq_relay}
*/
export class DataCloudflareMoqRelay extends cdktn.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataCloudflareMoqRelay that should be imported. Refer to the {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.25.0/docs/data-sources/moq_relay#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.25.0/docs/data-sources/moq_relay cloudflare_moq_relay} Data Source
  *
  * @param scope The scope in which to define this construct

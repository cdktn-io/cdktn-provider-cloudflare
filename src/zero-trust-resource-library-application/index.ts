  ...
  */
  ...
  protected synthesizeAttributes(): { [name: string]: any } {
    return {
      ...
      category_id: cdktn.numberToTerraform(this._categoryId),
      hostnames: cdktn.listMapper(cdktn.stringToTerraform, false)(this._hostnames),
      human_id: cdktn.stringToTerraform(this._humanId),
      ip_subnets: cdktn.listMapper(cdktn.stringToTerraform, false)(this._ipSubnets),
      name: cdktn.stringToTerraform(this._name),
      port_protocols: cdktn.listMapper(cdktn.stringToTerraform, false)(this._portProtocols),
      support_domains: cdktn.listMapper(cdktn.stringToTerraform, false)(this._supportDomains),
    };
  }
  ...
  protected synthesizeHclAttributes(): { [name: string]: any } {
    const attrs = {
      ...
      category_id: {
        value: cdktn.numberToHclTerraform(this._categoryId),
        isBlock: false,
        type: "simple",
      ...
      human_id: {
        value: cdktn.stringToHclTerraform(this._humanId),
        isBlock: false,
        type: "simple",
        storageClassType: "string",
      },
      ip_subnets: {
        value: cdktn.listMapperHcl(cdktn.stringToHclTerraform, false)(this._ipSubnets),
        isBlock: false,
        type: "set",
        storageClassType: "stringList",
      },
      ...
      port_protocols: {
        value: cdktn.listMapperHcl(cdktn.stringToHclTerraform, false)(this._portProtocols),
        isBlock: false,
        type: "set",
        storageClassType: "stringList",
      },
      support_domains: {
        value: cdktn.listMapperHcl(cdktn.stringToHclTerraform, false)(this._supportDomains),
        isBlock: false,
        type: "set",
        storageClassType: "stringList",
      },

...
// https://registry.terraform.io/providers/cloudflare/cloudflare/5.21.0/docs/data-sources/zero_trust_dlp_entries
...
export class DataCloudflareZeroTrustDlpEntriesResultConfidenceOutputReference extends cdktn.ComplexObject {
  ...
  */
  ...
  public get internalValue(): DataCloudflareZeroTrustDlpEntriesResultConfidence | undefined {
    let hasAnyValues = this.isEmptyObject;
    const internalValueResult: any = {};
    return hasAnyValues ? internalValueResult : undefined;
  }

  public set internalValue(value: DataCloudflareZeroTrustDlpEntriesResultConfidence | undefined) {
    if (value === undefined) {
...
export class DataCloudflareZeroTrustDlpEntriesResultPatternOutputReference extends cdktn.ComplexObject {
  private isEmptyObject = false;
  ...
  */
  ...
  public get internalValue(): DataCloudflareZeroTrustDlpEntriesResultPattern | undefined {
    let hasAnyValues = this.isEmptyObject;
    const internalValueResult: any = {};
    return hasAnyValues ? internalValueResult : undefined;
  }

  public set internalValue(value: DataCloudflareZeroTrustDlpEntriesResultPattern | undefined) {
    if (value === undefined) {
      this.isEmptyObject = false;
    }
    else {
...
export class DataCloudflareZeroTrustDlpEntriesResultVariantOutputReference extends cdktn.ComplexObject {
  private isEmptyObject = false;
...
export class DataCloudflareZeroTrustDlpEntriesResultOutputReference extends cdktn.ComplexObject {
  private isEmptyObject = false;
  ...
  */
  ...
  public get internalValue(): DataCloudflareZeroTrustDlpEntriesResult | undefined {
    let hasAnyValues = this.isEmptyObject;
    const internalValueResult: any = {};
    return hasAnyValues ? internalValueResult : undefined;
  }

  public set internalValue(value: DataCloudflareZeroTrustDlpEntriesResult | undefined) {
    if (value === undefined) {
      this.isEmptyObject = false;
    }
    else {
  ...
  private _confidence = new DataCloudflareZeroTrustDlpEntriesResultConfidenceOutputReference(this, "confidence");
  ...
  private _pattern = new DataCloudflareZeroTrustDlpEntriesResultPatternOutputReference(this, "pattern");
  public get pattern() {
...
export class DataCloudflareZeroTrustDlpEntriesResultList extends cdktn.ComplexList {
  ...
  */
  public get(index: number): DataCloudflareZeroTrustDlpEntriesResultOutputReference {
    return new DataCloudflareZeroTrustDlpEntriesResultOutputReference(this.terraformResource, this.terraformAttribute, index, this.wrapsSet);
  }
}
...
export class DataCloudflareZeroTrustDlpEntries extends cdktn.TerraformDataSource {
  ...
  // STATIC PROPERTIES
  // =================
  public static readonly tfResourceType = "cloudflare_zero_trust_dlp_entries";
  ...
  * @param importFromId The id of the existing DataCloudflareZeroTrustDlpEntries that should be imported. Refer to the {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.21.0/docs/data-sources/zero_trust_dlp_entries#import import section} in the documentation of this resource for the id to use
  ...
  */
  public static generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: cdktn.TerraformProvider) {
        return new cdktn.ImportableResource(scope, importToId, { terraformResourceType: "cloudflare_zero_trust_dlp_entries", importId: importFromId, provider });
      }
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.21.0/docs/data-sources/zero_trust_dlp_entries cloudflare_zero_trust_dlp_entries} Data Source
  *
  * @param scope The scope in which to define this construct
  * @param id The scoped construct ID. Must be unique amongst siblings in the same scope
  * @param options DataCloudflareZeroTrustDlpEntriesConfig = {}
  */
  public constructor(scope: Construct, id: string, config: DataCloudflareZeroTrustDlpEntriesConfig = {}) {
    super(scope, id, {
  ...
  private _result = new DataCloudflareZeroTrustDlpEntriesResultList(this, "result", false);
  public get result() {
    return this._result;
  }

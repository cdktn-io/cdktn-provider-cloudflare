...
// https://registry.terraform.io/providers/cloudflare/cloudflare/5.23.0/docs/data-sources/connectivity_directory_service
...
export interface DataCloudflareConnectivityDirectoryServiceConfig extends cdktn.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.23.0/docs/data-sources/connectivity_directory_service#account_id DataCloudflareConnectivityDirectoryService#account_id}
  */
  readonly accountId?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.23.0/docs/data-sources/connectivity_directory_service#filter DataCloudflareConnectivityDirectoryService#filter}
  */
  readonly filter?: DataCloudflareConnectivityDirectoryServiceFilter;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.23.0/docs/data-sources/connectivity_directory_service#service_id DataCloudflareConnectivityDirectoryService#service_id}
  */
...
export interface DataCloudflareConnectivityDirectoryServiceFilter {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.23.0/docs/data-sources/connectivity_directory_service#type DataCloudflareConnectivityDirectoryService#type}
  */
  readonly type?: string;
}

export function dataCloudflareConnectivityDirectoryServiceFilterToTerraform(struct?: DataCloudflareConnectivityDirectoryServiceFilter | cdktn.IResolvable): any {
...
export function dataCloudflareConnectivityDirectoryServiceFilterToHclTerraform(struct?: DataCloudflareConnectivityDirectoryServiceFilter | cdktn.IResolvable): any {
  if (!cdktn.canInspect(struct) || cdktn.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktn.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdktn.io/docs/concepts/resources#references");
  }
...
export class DataCloudflareConnectivityDirectoryServiceFilterOutputReference extends cdktn.ComplexObject {
  ...
  */
  ...
  public get internalValue(): DataCloudflareConnectivityDirectoryServiceFilter | cdktn.IResolvable | undefined {
  ...
  public set internalValue(value: DataCloudflareConnectivityDirectoryServiceFilter | cdktn.IResolvable | undefined) {
    if (value === undefined) {
...
export class DataCloudflareConnectivityDirectoryServiceHostNetworkOutputReference extends cdktn.ComplexObject {
  private isEmptyObject = false;
...
export class DataCloudflareConnectivityDirectoryServiceHostResolverNetworkOutputReference extends cdktn.ComplexObject {
  private isEmptyObject = false;
...
export class DataCloudflareConnectivityDirectoryServiceHostOutputReference extends cdktn.ComplexObject {
  private isEmptyObject = false;
...
export function dataCloudflareConnectivityDirectoryServiceTlsSettingsToTerraform(struct?: DataCloudflareConnectivityDirectoryServiceTlsSettings): any {
  if (!cdktn.canInspect(struct) || cdktn.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktn.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdktn.io/docs/concepts/resources#references");
  }
...
export function dataCloudflareConnectivityDirectoryServiceTlsSettingsToHclTerraform(struct?: DataCloudflareConnectivityDirectoryServiceTlsSettings): any {
  if (!cdktn.canInspect(struct) || cdktn.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktn.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdktn.io/docs/concepts/resources#references");
  }
...
export class DataCloudflareConnectivityDirectoryServiceTlsSettingsOutputReference extends cdktn.ComplexObject {
  private isEmptyObject = false;
  ...
  */
  ...
  public get internalValue(): DataCloudflareConnectivityDirectoryServiceTlsSettings | undefined {
    let hasAnyValues = this.isEmptyObject;
    const internalValueResult: any = {};
    return hasAnyValues ? internalValueResult : undefined;
  }

  public set internalValue(value: DataCloudflareConnectivityDirectoryServiceTlsSettings | undefined) {
    if (value === undefined) {
      this.isEmptyObject = false;
    }
    else {
...
/**
* Represents a {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.23.0/docs/data-sources/connectivity_directory_service cloudflare_connectivity_directory_service}
*/
export class DataCloudflareConnectivityDirectoryService extends cdktn.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataCloudflareConnectivityDirectoryService that should be imported. Refer to the {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.23.0/docs/data-sources/connectivity_directory_service#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.23.0/docs/data-sources/connectivity_directory_service cloudflare_connectivity_directory_service} Data Source
  *
  * @param scope The scope in which to define this construct
  ...
  */
  ...
  private _tlsSettings = new DataCloudflareConnectivityDirectoryServiceTlsSettingsOutputReference(this, "tls_settings");

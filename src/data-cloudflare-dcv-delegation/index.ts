...
// https://registry.terraform.io/providers/cloudflare/cloudflare/5.24.0/docs/data-sources/dcv_delegation
...
export interface DataCloudflareDcvDelegationConfig extends cdktn.TerraformMetaArguments {
  ...
  * Identifier.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.24.0/docs/data-sources/dcv_delegation#zone_id DataCloudflareDcvDelegation#zone_id}
  */
...
export class DataCloudflareDcvDelegation extends cdktn.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataCloudflareDcvDelegation that should be imported. Refer to the {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.24.0/docs/data-sources/dcv_delegation#import import section} in the documentation of this resource for the id to use

...
// https://registry.terraform.io/providers/cloudflare/cloudflare/5.20.0/docs/resources/load_balancer_monitor_group
...
export class LoadBalancerMonitorGroup extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing LoadBalancerMonitorGroup that should be imported. Refer to the {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.20.0/docs/resources/load_balancer_monitor_group#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.20.0/docs/resources/load_balancer_monitor_group cloudflare_load_balancer_monitor_group} Resource
  *
  * @param scope The scope in which to define this construct

...
// https://registry.terraform.io/providers/cloudflare/cloudflare/5.20.0/docs/resources/waiting_room_rules
...
export class WaitingRoomRules extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing WaitingRoomRules that should be imported. Refer to the {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.20.0/docs/resources/waiting_room_rules#import import section} in the documentation of this resource for the id to use

...
// https://registry.terraform.io/providers/cloudflare/cloudflare/5.18.0/docs/data-sources/web_analytics_sites
...
export class DataCloudflareWebAnalyticsSitesResultRulesOutputReference extends cdktn.ComplexObject {
...
export class DataCloudflareWebAnalyticsSitesResultRulesList extends cdktn.ComplexList {
...
export class DataCloudflareWebAnalyticsSitesResultRulesetOutputReference extends cdktn.ComplexObject {
  private isEmptyObject = false;
...
export class DataCloudflareWebAnalyticsSitesResultOutputReference extends cdktn.ComplexObject {
  private isEmptyObject = false;
...
export class DataCloudflareWebAnalyticsSitesResultList extends cdktn.ComplexList {
...
*/
export class DataCloudflareWebAnalyticsSites extends cdktn.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataCloudflareWebAnalyticsSites that should be imported. Refer to the {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.18.0/docs/data-sources/web_analytics_sites#import import section} in the documentation of this resource for the id to use
  ...
  */
  public static generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: cdktn.TerraformProvider) {
        return new cdktn.ImportableResource(scope, importToId, { terraformResourceType: "cloudflare_web_analytics_sites", importId: importFromId, provider });
      }
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.18.0/docs/data-sources/web_analytics_sites cloudflare_web_analytics_sites} Data Source
  *
  * @param scope The scope in which to define this construct

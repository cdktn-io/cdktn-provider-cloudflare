...
export class DataCloudflareMagicTransitCf1SiteLocationOutputReference extends cdktn.ComplexObject {
...
*/
export class DataCloudflareMagicTransitCf1Site extends cdktn.TerraformDataSource {
  ...
  */
  ...
  protected synthesizeAttributes(): { [name: string]: any } {
    return {
      ...
      cf1_site_id: cdktn.stringToTerraform(this._cf1SiteId),
    };
  }
  ...
  protected synthesizeHclAttributes(): { [name: string]: any } {
    const attrs = {
      ...
      cf1_site_id: {
        value: cdktn.stringToHclTerraform(this._cf1SiteId),
        isBlock: false,
        type: "simple",
        storageClassType: "string",
      },

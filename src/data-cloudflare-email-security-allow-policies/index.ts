...
export interface DataCloudflareEmailSecurityAllowPoliciesConfig extends cdktn.TerraformMetaArguments {
  /**
  * Identifier.
  *
...
export class DataCloudflareEmailSecurityAllowPoliciesResultOutputReference extends cdktn.ComplexObject {
...
export class DataCloudflareEmailSecurityAllowPoliciesResultList extends cdktn.ComplexList {
...
export class DataCloudflareEmailSecurityAllowPolicies extends cdktn.TerraformDataSource {
  ...
  */
  public static generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: cdktn.TerraformProvider) {
        return new cdktn.ImportableResource(scope, importToId, { terraformResourceType: "cloudflare_email_security_allow_policies", importId: importFromId, provider });
      }

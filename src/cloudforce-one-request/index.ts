...
// https://registry.terraform.io/providers/cloudflare/cloudflare/5.18.0/docs/resources/cloudforce_one_request
...
export interface CloudforceOneRequestConfig extends cdktn.TerraformMetaArguments {
  /**
  * Identifier.
  *
...
*/
export class CloudforceOneRequest extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing CloudforceOneRequest that should be imported. Refer to the {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.18.0/docs/resources/cloudforce_one_request#import import section} in the documentation of this resource for the id to use

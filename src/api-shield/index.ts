...
// https://registry.terraform.io/providers/cloudflare/cloudflare/5.20.0/docs/resources/api_shield
...
export class ApiShield extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing ApiShield that should be imported. Refer to the {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.20.0/docs/resources/api_shield#import import section} in the documentation of this resource for the id to use

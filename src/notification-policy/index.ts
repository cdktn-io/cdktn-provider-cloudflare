...
// https://registry.terraform.io/providers/cloudflare/cloudflare/5.21.1/docs/resources/notification_policy
...
export class NotificationPolicyMechanismsOutputReference extends cdktn.ComplexObject {
  ...
  */
  ...
  private _email = new NotificationPolicyMechanismsEmailList(this, "email", true);
  public get email() {
    return this._email;
  }
  ...
  private _pagerduty = new NotificationPolicyMechanismsPagerdutyList(this, "pagerduty", true);
  ...
  private _webhooks = new NotificationPolicyMechanismsWebhooksList(this, "webhooks", true);
  public get webhooks() {
...
export class NotificationPolicy extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing NotificationPolicy that should be imported. Refer to the {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.21.1/docs/resources/notification_policy#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.21.1/docs/resources/notification_policy cloudflare_notification_policy} Resource
  *
  * @param scope The scope in which to define this construct

...
// https://registry.terraform.io/providers/cloudflare/cloudflare/5.20.0/docs/resources/list
...
export class List extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing List that should be imported. Refer to the {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.20.0/docs/resources/list#import import section} in the documentation of this resource for the id to use

...
// https://registry.terraform.io/providers/cloudflare/cloudflare/5.22.0/docs/resources/email_routing_dns
...
export class EmailRoutingDns extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing EmailRoutingDns that should be imported. Refer to the {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.22.0/docs/resources/email_routing_dns#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.22.0/docs/resources/email_routing_dns cloudflare_email_routing_dns} Resource
  *
  * @param scope The scope in which to define this construct

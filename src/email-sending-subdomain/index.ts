...
export interface EmailSendingSubdomainConfig extends cdktn.TerraformMetaArguments {
  /**
...
export class EmailSendingSubdomain extends cdktn.TerraformResource {
  ...
  */
  public static generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: cdktn.TerraformProvider) {
        return new cdktn.ImportableResource(scope, importToId, { terraformResourceType: "cloudflare_email_sending_subdomain", importId: importFromId, provider });
      }
  ...
  */
  ...
  private _dropSuppressedRecipients?: boolean | cdktn.IResolvable; 
  public get dropSuppressedRecipients() {
    return this.getBooleanAttribute('drop_suppressed_recipients');
  }
  public set dropSuppressedRecipients(value: boolean | cdktn.IResolvable) {
  ...
  private _previewEnabled?: boolean | cdktn.IResolvable; 
  public get previewEnabled() {
    return this.getBooleanAttribute('preview_enabled');
  }
  public set previewEnabled(value: boolean | cdktn.IResolvable) {
  ...
  protected synthesizeAttributes(): { [name: string]: any } {
    return {
      drop_suppressed_recipients: cdktn.booleanToTerraform(this._dropSuppressedRecipients),
      name: cdktn.stringToTerraform(this._name),
      preview_enabled: cdktn.booleanToTerraform(this._previewEnabled),
  ...
  protected synthesizeHclAttributes(): { [name: string]: any } {
    const attrs = {
      drop_suppressed_recipients: {
        value: cdktn.booleanToHclTerraform(this._dropSuppressedRecipients),
        isBlock: false,
        type: "simple",
      ...
      preview_enabled: {
        value: cdktn.booleanToHclTerraform(this._previewEnabled),
        isBlock: false,
        type: "simple",
        storageClassType: "boolean",
      },

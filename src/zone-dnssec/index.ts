...
// https://registry.terraform.io/providers/cloudflare/cloudflare/5.20.0/docs/resources/zone_dnssec
...
export interface ZoneDnssecConfig extends cdktn.TerraformMetaArguments {
  /**
  ...
  */
  readonly dnssecMultiSigner?: boolean | cdktn.IResolvable;
  /**
  ...
  */
  readonly dnssecPresigned?: boolean | cdktn.IResolvable;
  /**
  ...
  */
  readonly dnssecUseNsec3?: boolean | cdktn.IResolvable;
  /**
...
*/
export class ZoneDnssec extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing ZoneDnssec that should be imported. Refer to the {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.20.0/docs/resources/zone_dnssec#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.20.0/docs/resources/zone_dnssec cloudflare_zone_dnssec} Resource
  *
  * @param scope The scope in which to define this construct
  ...
  */
  ...
  private _dnssecMultiSigner?: boolean | cdktn.IResolvable; 
  public get dnssecMultiSigner() {
    return this.getBooleanAttribute('dnssec_multi_signer');
  }
  public set dnssecMultiSigner(value: boolean | cdktn.IResolvable) {
  ...
  private _dnssecPresigned?: boolean | cdktn.IResolvable; 
  public get dnssecPresigned() {
    return this.getBooleanAttribute('dnssec_presigned');
  }
  public set dnssecPresigned(value: boolean | cdktn.IResolvable) {
  ...
  private _dnssecUseNsec3?: boolean | cdktn.IResolvable; 
  public get dnssecUseNsec3() {
    return this.getBooleanAttribute('dnssec_use_nsec3');
  }
  public set dnssecUseNsec3(value: boolean | cdktn.IResolvable) {
  ...
  protected synthesizeAttributes(): { [name: string]: any } {
    return {
      dnssec_multi_signer: cdktn.booleanToTerraform(this._dnssecMultiSigner),
      dnssec_presigned: cdktn.booleanToTerraform(this._dnssecPresigned),
      dnssec_use_nsec3: cdktn.booleanToTerraform(this._dnssecUseNsec3),
  ...
  protected synthesizeHclAttributes(): { [name: string]: any } {
    const attrs = {
      dnssec_multi_signer: {
        value: cdktn.booleanToHclTerraform(this._dnssecMultiSigner),
        isBlock: false,
        type: "simple",
        storageClassType: "boolean",
      },
      dnssec_presigned: {
        value: cdktn.booleanToHclTerraform(this._dnssecPresigned),
        isBlock: false,
        type: "simple",
        storageClassType: "boolean",
      },
      dnssec_use_nsec3: {
        value: cdktn.booleanToHclTerraform(this._dnssecUseNsec3),
        isBlock: false,
        type: "simple",
        storageClassType: "boolean",
      },

...
// https://registry.terraform.io/providers/cloudflare/cloudflare/5.18.0/docs/resources/zero_trust_gateway_certificate
...
export interface ZeroTrustGatewayCertificateConfig extends cdktn.TerraformMetaArguments {
  /**
...
*/
export class ZeroTrustGatewayCertificate extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing ZeroTrustGatewayCertificate that should be imported. Refer to the {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.18.0/docs/resources/zero_trust_gateway_certificate#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  protected synthesizeAttributes(): { [name: string]: any } {
    return {
      ...
      validity_period_days: cdktn.numberToTerraform(this._validityPeriodDays),
    };
  }
  ...
  protected synthesizeHclAttributes(): { [name: string]: any } {
    const attrs = {
      ...
      validity_period_days: {
        value: cdktn.numberToHclTerraform(this._validityPeriodDays),
        isBlock: false,
        type: "simple",

...
// https://registry.terraform.io/providers/cloudflare/cloudflare/5.21.0/docs/data-sources/secrets_store_secrets
...
export class DataCloudflareSecretsStoreSecrets extends cdktn.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataCloudflareSecretsStoreSecrets that should be imported. Refer to the {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.21.0/docs/data-sources/secrets_store_secrets#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.21.0/docs/data-sources/secrets_store_secrets cloudflare_secrets_store_secrets} Data Source
  *
  * @param scope The scope in which to define this construct
  ...
  */
  ...
  protected synthesizeAttributes(): { [name: string]: any } {
    return {
      ...
      scopes: cdktn.listMapper(cdktn.listMapper(cdktn.stringToTerraform, false), false)(this._scopes),
  ...
  protected synthesizeHclAttributes(): { [name: string]: any } {
    const attrs = {
      ...
      scopes: {
        value: cdktn.listMapperHcl(cdktn.listMapperHcl(cdktn.stringToHclTerraform, false), false)(this._scopes),
        isBlock: false,
        type: "list",

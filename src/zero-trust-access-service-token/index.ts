...
// https://registry.terraform.io/providers/cloudflare/cloudflare/5.18.0/docs/resources/zero_trust_access_service_token
...
export interface ZeroTrustAccessServiceTokenConfig extends cdktn.TerraformMetaArguments {
  /**
...
*/
export class ZeroTrustAccessServiceToken extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing ZeroTrustAccessServiceToken that should be imported. Refer to the {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.18.0/docs/resources/zero_trust_access_service_token#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  protected synthesizeAttributes(): { [name: string]: any } {
    return {
      ...
      client_secret_version: cdktn.numberToTerraform(this._clientSecretVersion),
      duration: cdktn.stringToTerraform(this._duration),
      name: cdktn.stringToTerraform(this._name),
      previous_client_secret_expires_at: cdktn.stringToTerraform(this._previousClientSecretExpiresAt),
  ...
  protected synthesizeHclAttributes(): { [name: string]: any } {
    const attrs = {
      ...
      client_secret_version: {
        value: cdktn.numberToHclTerraform(this._clientSecretVersion),
        isBlock: false,
        type: "simple",
      ...
      previous_client_secret_expires_at: {
        value: cdktn.stringToHclTerraform(this._previousClientSecretExpiresAt),
        isBlock: false,
        type: "simple",
        storageClassType: "string",
      },

...
// https://registry.terraform.io/providers/cloudflare/cloudflare/5.20.0/docs/resources/dns_record
...
export interface DnsRecordConfig extends cdktn.TerraformMetaArguments {
  ...
  */
  readonly privateRouting?: boolean | cdktn.IResolvable;
  /**
...
export class DnsRecord extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing DnsRecord that should be imported. Refer to the {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.20.0/docs/resources/dns_record#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  private _privateRouting?: boolean | cdktn.IResolvable; 
  public get privateRouting() {
    return this.getBooleanAttribute('private_routing');
  }
  public set privateRouting(value: boolean | cdktn.IResolvable) {
  ...
  protected synthesizeAttributes(): { [name: string]: any } {
    return {
      ...
      private_routing: cdktn.booleanToTerraform(this._privateRouting),
  ...
  protected synthesizeHclAttributes(): { [name: string]: any } {
    const attrs = {
      ...
      private_routing: {
        value: cdktn.booleanToHclTerraform(this._privateRouting),
        isBlock: false,
        type: "simple",
        storageClassType: "boolean",
      },

...
// https://registry.terraform.io/providers/cloudflare/cloudflare/5.19.1/docs/resources/dns_record
...
export class DnsRecord extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing DnsRecord that should be imported. Refer to the {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.19.1/docs/resources/dns_record#import import section} in the documentation of this resource for the id to use

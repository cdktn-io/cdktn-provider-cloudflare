...
// https://registry.terraform.io/providers/cloudflare/cloudflare/5.25.0/docs/resources/ct_alerting
...
export interface CtAlertingConfig extends cdktn.TerraformMetaArguments {
  /**
...
*/
export class CtAlerting extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing CtAlerting that should be imported. Refer to the {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.25.0/docs/resources/ct_alerting#import import section} in the documentation of this resource for the id to use
  * @param provider? Optional instance of the provider where the CtAlerting to import is found
  */
  public static generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: cdktn.TerraformProvider) {
        return new cdktn.ImportableResource(scope, importToId, { terraformResourceType: "cloudflare_ct_alerting", importId: importFromId, provider });
      }
  ...
  */
  ...
  protected synthesizeAttributes(): { [name: string]: any } {
    return {
      emails: cdktn.listMapper(cdktn.stringToTerraform, false)(this._emails),
  ...
  protected synthesizeHclAttributes(): { [name: string]: any } {
    const attrs = {
      emails: {
        value: cdktn.listMapperHcl(cdktn.stringToHclTerraform, false)(this._emails),
        isBlock: false,
        type: "list",

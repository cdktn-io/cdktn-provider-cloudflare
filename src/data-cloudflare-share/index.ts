...
// https://registry.terraform.io/providers/cloudflare/cloudflare/5.20.0/docs/data-sources/share
...
export function dataCloudflareShareFilterToTerraform(struct?: DataCloudflareShareFilter | cdktn.IResolvable): any {
...
export function dataCloudflareShareFilterToHclTerraform(struct?: DataCloudflareShareFilter | cdktn.IResolvable): any {
  if (!cdktn.canInspect(struct) || cdktn.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktn.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdktn.io/docs/concepts/resources#references");
  }
...
export class DataCloudflareShareFilterOutputReference extends cdktn.ComplexObject {
  ...
  */
  ...
  public get internalValue(): DataCloudflareShareFilter | cdktn.IResolvable | undefined {
  ...
  public set internalValue(value: DataCloudflareShareFilter | cdktn.IResolvable | undefined) {
    if (value === undefined) {
...
export class DataCloudflareShareResourcesOutputReference extends cdktn.ComplexObject {
  private isEmptyObject = false;
...
export class DataCloudflareShareResourcesList extends cdktn.ComplexList {
...
*/
export class DataCloudflareShare extends cdktn.TerraformDataSource {

...
// https://registry.terraform.io/providers/cloudflare/cloudflare/5.18.0/docs/data-sources/r2_bucket_sippy
...
export interface DataCloudflareR2BucketSippyConfig extends cdktn.TerraformMetaArguments {
  /**
  * Account ID.
  *
...
export class DataCloudflareR2BucketSippyDestinationOutputReference extends cdktn.ComplexObject {
...
export class DataCloudflareR2BucketSippySourceOutputReference extends cdktn.ComplexObject {
  private isEmptyObject = false;
...
/**
* Represents a {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.18.0/docs/data-sources/r2_bucket_sippy cloudflare_r2_bucket_sippy}
*/
export class DataCloudflareR2BucketSippy extends cdktn.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataCloudflareR2BucketSippy that should be imported. Refer to the {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.18.0/docs/data-sources/r2_bucket_sippy#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.18.0/docs/data-sources/r2_bucket_sippy cloudflare_r2_bucket_sippy} Data Source
  *
  * @param scope The scope in which to define this construct

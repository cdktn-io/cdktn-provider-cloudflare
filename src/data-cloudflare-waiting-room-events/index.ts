...
// https://registry.terraform.io/providers/cloudflare/cloudflare/5.18.0/docs/data-sources/waiting_room_events
...
export interface DataCloudflareWaitingRoomEventsConfig extends cdktn.TerraformMetaArguments {
  /**
...
export class DataCloudflareWaitingRoomEventsResultOutputReference extends cdktn.ComplexObject {
...
export class DataCloudflareWaitingRoomEventsResultList extends cdktn.ComplexList {
...
*/
export class DataCloudflareWaitingRoomEvents extends cdktn.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataCloudflareWaitingRoomEvents that should be imported. Refer to the {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.18.0/docs/data-sources/waiting_room_events#import import section} in the documentation of this resource for the id to use
  ...
  */
  public static generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: cdktn.TerraformProvider) {
        return new cdktn.ImportableResource(scope, importToId, { terraformResourceType: "cloudflare_waiting_room_events", importId: importFromId, provider });
      }
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.18.0/docs/data-sources/waiting_room_events cloudflare_waiting_room_events} Data Source
  *
  * @param scope The scope in which to define this construct

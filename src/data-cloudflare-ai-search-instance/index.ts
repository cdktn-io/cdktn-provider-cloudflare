...
// https://registry.terraform.io/providers/cloudflare/cloudflare/5.19.1/docs/data-sources/ai_search_instance
...
export function dataCloudflareAiSearchInstanceFilterToTerraform(struct?: DataCloudflareAiSearchInstanceFilter | cdktn.IResolvable): any {
  ...
  return {
    ...
    order_by_direction: cdktn.stringToTerraform(struct!.orderByDirection),
...
export function dataCloudflareAiSearchInstanceFilterToHclTerraform(struct?: DataCloudflareAiSearchInstanceFilter | cdktn.IResolvable): any {
  ...
  const attrs = {
    ...
    order_by_direction: {
      value: cdktn.stringToHclTerraform(struct!.orderByDirection),
      isBlock: false,
      type: "simple",
      storageClassType: "string",
    },
...
export class DataCloudflareAiSearchInstanceIndexMethodOutputReference extends cdktn.ComplexObject {
  private isEmptyObject = false;
...
export class DataCloudflareAiSearchInstanceIndexingOptionsOutputReference extends cdktn.ComplexObject {
  private isEmptyObject = false;
...
export function dataCloudflareAiSearchInstanceMetadataSearchForAgentsToTerraform(struct?: DataCloudflareAiSearchInstanceMetadataSearchForAgents): any {
  if (!cdktn.canInspect(struct) || cdktn.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktn.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
...
export function dataCloudflareAiSearchInstanceMetadataSearchForAgentsToHclTerraform(struct?: DataCloudflareAiSearchInstanceMetadataSearchForAgents): any {
  if (!cdktn.canInspect(struct) || cdktn.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktn.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
...
export class DataCloudflareAiSearchInstanceMetadataSearchForAgentsOutputReference extends cdktn.ComplexObject {
  private isEmptyObject = false;
  ...
  */
  ...
  public get internalValue(): DataCloudflareAiSearchInstanceMetadataSearchForAgents | undefined {
    let hasAnyValues = this.isEmptyObject;
    const internalValueResult: any = {};
    return hasAnyValues ? internalValueResult : undefined;
  }

  public set internalValue(value: DataCloudflareAiSearchInstanceMetadataSearchForAgents | undefined) {
    if (value === undefined) {
      this.isEmptyObject = false;
    }
    else {
...
export class DataCloudflareAiSearchInstanceMetadataOutputReference extends cdktn.ComplexObject {
  ...
  */
  ...
  private _searchForAgents = new DataCloudflareAiSearchInstanceMetadataSearchForAgentsOutputReference(this, "search_for_agents");
...
export class DataCloudflareAiSearchInstanceRetrievalOptionsBoostByOutputReference extends cdktn.ComplexObject {
  private isEmptyObject = false;
...
export class DataCloudflareAiSearchInstanceRetrievalOptionsBoostByList extends cdktn.ComplexList {
...
export class DataCloudflareAiSearchInstanceSourceParamsWebCrawlerCrawlOptionsOutputReference extends cdktn.ComplexObject {
  private isEmptyObject = false;
...
export class DataCloudflareAiSearchInstanceSourceParamsWebCrawlerParseOptionsContentSelectorOutputReference extends cdktn.ComplexObject {
  private isEmptyObject = false;
...
export class DataCloudflareAiSearchInstanceSourceParamsWebCrawlerParseOptionsContentSelectorList extends cdktn.ComplexList {
...
export class DataCloudflareAiSearchInstance extends cdktn.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataCloudflareAiSearchInstance that should be imported. Refer to the {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.19.1/docs/data-sources/ai_search_instance#import import section} in the documentation of this resource for the id to use

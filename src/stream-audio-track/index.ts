...
// https://registry.terraform.io/providers/cloudflare/cloudflare/5.19.1/docs/resources/stream_audio_track
...
export class StreamAudioTrackAudioOutputReference extends cdktn.ComplexObject {
...
export class StreamAudioTrackAudioList extends cdktn.ComplexList {
...
export class StreamAudioTrack extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing StreamAudioTrack that should be imported. Refer to the {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.19.1/docs/resources/stream_audio_track#import import section} in the documentation of this resource for the id to use

...
// https://registry.terraform.io/providers/cloudflare/cloudflare/5.20.0/docs/resources/zero_trust_device_deployment_groups
...
export interface ZeroTrustDeviceDeploymentGroupsConfig extends cdktn.TerraformMetaArguments {
  /**
  ...
  */
  readonly versionConfig: ZeroTrustDeviceDeploymentGroupsVersionConfig[] | cdktn.IResolvable;
}
...
export function zeroTrustDeviceDeploymentGroupsVersionConfigToTerraform(struct?: ZeroTrustDeviceDeploymentGroupsVersionConfig | cdktn.IResolvable): any {
  if (!cdktn.canInspect(struct) || cdktn.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktn.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdktn.io/docs/concepts/resources#references");
  }
  return {
    target_environment: cdktn.stringToTerraform(struct!.targetEnvironment),
    version: cdktn.stringToTerraform(struct!.version),
  }
}


export function zeroTrustDeviceDeploymentGroupsVersionConfigToHclTerraform(struct?: ZeroTrustDeviceDeploymentGroupsVersionConfig | cdktn.IResolvable): any {
  if (!cdktn.canInspect(struct) || cdktn.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktn.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdktn.io/docs/concepts/resources#references");
  }
  const attrs = {
    target_environment: {
      value: cdktn.stringToHclTerraform(struct!.targetEnvironment),
      isBlock: false,
      type: "simple",
...
export class ZeroTrustDeviceDeploymentGroupsVersionConfigOutputReference extends cdktn.ComplexObject {
  ...
  */
  ...
  public get internalValue(): ZeroTrustDeviceDeploymentGroupsVersionConfig | cdktn.IResolvable | undefined {
  ...
  public set internalValue(value: ZeroTrustDeviceDeploymentGroupsVersionConfig | cdktn.IResolvable | undefined) {
    if (value === undefined) {
...
export class ZeroTrustDeviceDeploymentGroupsVersionConfigList extends cdktn.ComplexList {
  public internalValue? : ZeroTrustDeviceDeploymentGroupsVersionConfig[] | cdktn.IResolvable
...
*/
export class ZeroTrustDeviceDeploymentGroups extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing ZeroTrustDeviceDeploymentGroups that should be imported. Refer to the {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.20.0/docs/resources/zero_trust_device_deployment_groups#import import section} in the documentation of this resource for the id to use
  ...
  */
  public static generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: cdktn.TerraformProvider) {
        return new cdktn.ImportableResource(scope, importToId, { terraformResourceType: "cloudflare_zero_trust_device_deployment_groups", importId: importFromId, provider });
      }
  ...
  */
  ...
  public putVersionConfig(value: ZeroTrustDeviceDeploymentGroupsVersionConfig[] | cdktn.IResolvable) {
  ...
  protected synthesizeAttributes(): { [name: string]: any } {
    return {
      ...
      policy_ids: cdktn.listMapper(cdktn.stringToTerraform, false)(this._policyIds),
      version_config: cdktn.listMapper(zeroTrustDeviceDeploymentGroupsVersionConfigToTerraform, false)(this._versionConfig.internalValue),
    };
  }
  ...
  protected synthesizeHclAttributes(): { [name: string]: any } {
    const attrs = {
      ...
      policy_ids: {
        value: cdktn.listMapperHcl(cdktn.stringToHclTerraform, false)(this._policyIds),
        isBlock: false,
        type: "list",
        storageClassType: "stringList",
      },
      version_config: {
        value: cdktn.listMapperHcl(zeroTrustDeviceDeploymentGroupsVersionConfigToHclTerraform, false)(this._versionConfig.internalValue),
        isBlock: true,
        type: "list",

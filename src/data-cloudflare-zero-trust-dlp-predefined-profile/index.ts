...
// https://registry.terraform.io/providers/cloudflare/cloudflare/5.18.0/docs/data-sources/zero_trust_dlp_predefined_profile
...
export class DataCloudflareZeroTrustDlpPredefinedProfileEntriesConfidenceOutputReference extends cdktn.ComplexObject {
...
export class DataCloudflareZeroTrustDlpPredefinedProfileEntriesPatternOutputReference extends cdktn.ComplexObject {
  private isEmptyObject = false;
...
export function dataCloudflareZeroTrustDlpPredefinedProfileEntriesVariantToTerraform(struct?: DataCloudflareZeroTrustDlpPredefinedProfileEntriesVariant): any {
  if (!cdktn.canInspect(struct) || cdktn.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktn.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
...
export function dataCloudflareZeroTrustDlpPredefinedProfileEntriesVariantToHclTerraform(struct?: DataCloudflareZeroTrustDlpPredefinedProfileEntriesVariant): any {
  if (!cdktn.canInspect(struct) || cdktn.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktn.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
...
export class DataCloudflareZeroTrustDlpPredefinedProfileEntriesVariantOutputReference extends cdktn.ComplexObject {
  private isEmptyObject = false;
  ...
  */
  ...
  public get internalValue(): DataCloudflareZeroTrustDlpPredefinedProfileEntriesVariant | undefined {
    let hasAnyValues = this.isEmptyObject;
    const internalValueResult: any = {};
    return hasAnyValues ? internalValueResult : undefined;
  }

  public set internalValue(value: DataCloudflareZeroTrustDlpPredefinedProfileEntriesVariant | undefined) {
    if (value === undefined) {
      this.isEmptyObject = false;
    }
    else {
...
export class DataCloudflareZeroTrustDlpPredefinedProfileEntriesOutputReference extends cdktn.ComplexObject {
  private isEmptyObject = false;
  ...
  */
  ...
  private _variant = new DataCloudflareZeroTrustDlpPredefinedProfileEntriesVariantOutputReference(this, "variant");
  public get variant() {
...
export class DataCloudflareZeroTrustDlpPredefinedProfileEntriesList extends cdktn.ComplexList {
...
*/
export class DataCloudflareZeroTrustDlpPredefinedProfile extends cdktn.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataCloudflareZeroTrustDlpPredefinedProfile that should be imported. Refer to the {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.18.0/docs/data-sources/zero_trust_dlp_predefined_profile#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.18.0/docs/data-sources/zero_trust_dlp_predefined_profile cloudflare_zero_trust_dlp_predefined_profile} Data Source
  *
  * @param scope The scope in which to define this construct

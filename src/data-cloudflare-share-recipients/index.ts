...
// https://registry.terraform.io/providers/cloudflare/cloudflare/5.20.0/docs/data-sources/share_recipients
...
export class DataCloudflareShareRecipientsResultResourcesOutputReference extends cdktn.ComplexObject {
...
export class DataCloudflareShareRecipientsResultResourcesList extends cdktn.ComplexList {
...
export class DataCloudflareShareRecipientsResultOutputReference extends cdktn.ComplexObject {
  private isEmptyObject = false;
...
export class DataCloudflareShareRecipientsResultList extends cdktn.ComplexList {
...
*/
export class DataCloudflareShareRecipients extends cdktn.TerraformDataSource {
  ...
  */
  public static generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: cdktn.TerraformProvider) {
        return new cdktn.ImportableResource(scope, importToId, { terraformResourceType: "cloudflare_share_recipients", importId: importFromId, provider });
      }

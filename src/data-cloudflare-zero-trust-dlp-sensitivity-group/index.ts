...
// https://registry.terraform.io/providers/cloudflare/cloudflare/5.20.0/docs/data-sources/zero_trust_dlp_sensitivity_group
...
export class DataCloudflareZeroTrustDlpSensitivityGroupLevelsOutputReference extends cdktn.ComplexObject {
...
export class DataCloudflareZeroTrustDlpSensitivityGroupLevelsList extends cdktn.ComplexList {
...
*/
export class DataCloudflareZeroTrustDlpSensitivityGroup extends cdktn.TerraformDataSource {
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.20.0/docs/data-sources/zero_trust_dlp_sensitivity_group cloudflare_zero_trust_dlp_sensitivity_group} Data Source
  *
  * @param scope The scope in which to define this construct

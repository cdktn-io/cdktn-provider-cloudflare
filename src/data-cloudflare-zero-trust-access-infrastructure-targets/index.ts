...
// https://registry.terraform.io/providers/cloudflare/cloudflare/5.17.0/docs/data-sources/zero_trust_access_infrastructure_targets
...
export interface DataCloudflareZeroTrustAccessInfrastructureTargetsConfig extends cdktn.TerraformMetaArguments {
  /**
  * Account identifier
  *
...
export class DataCloudflareZeroTrustAccessInfrastructureTargetsResultIpIpv4OutputReference extends cdktn.ComplexObject {
...
export class DataCloudflareZeroTrustAccessInfrastructureTargetsResultIpIpv6OutputReference extends cdktn.ComplexObject {
  private isEmptyObject = false;
...
export class DataCloudflareZeroTrustAccessInfrastructureTargetsResultIpOutputReference extends cdktn.ComplexObject {
  private isEmptyObject = false;
...
export class DataCloudflareZeroTrustAccessInfrastructureTargetsResultOutputReference extends cdktn.ComplexObject {
  private isEmptyObject = false;
...
export class DataCloudflareZeroTrustAccessInfrastructureTargetsResultList extends cdktn.ComplexList {
...
*/
export class DataCloudflareZeroTrustAccessInfrastructureTargets extends cdktn.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataCloudflareZeroTrustAccessInfrastructureTargets that should be imported. Refer to the {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.17.0/docs/data-sources/zero_trust_access_infrastructure_targets#import import section} in the documentation of this resource for the id to use
  ...
  */
  public static generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: cdktn.TerraformProvider) {
        return new cdktn.ImportableResource(scope, importToId, { terraformResourceType: "cloudflare_zero_trust_access_infrastructure_targets", importId: importFromId, provider });
      }
  ...
  */
  ...
  protected synthesizeAttributes(): { [name: string]: any } {
    return {
      ...
      hostname_contains: cdktn.stringToTerraform(this._hostnameContains),
      ip_like: cdktn.stringToTerraform(this._ipLike),
      ip_v4: cdktn.stringToTerraform(this._ipV4),
      ip_v6: cdktn.stringToTerraform(this._ipV6),
      ips: cdktn.listMapper(cdktn.stringToTerraform, false)(this._ips),
      ipv4_end: cdktn.stringToTerraform(this._ipv4End),
      ipv4_start: cdktn.stringToTerraform(this._ipv4Start),
      ipv6_end: cdktn.stringToTerraform(this._ipv6End),
      ipv6_start: cdktn.stringToTerraform(this._ipv6Start),
      max_items: cdktn.numberToTerraform(this._maxItems),
      modified_after: cdktn.stringToTerraform(this._modifiedAfter),
      modified_before: cdktn.stringToTerraform(this._modifiedBefore),
  ...
  protected synthesizeHclAttributes(): { [name: string]: any } {
    const attrs = {
      ...
      hostname_contains: {
        value: cdktn.stringToHclTerraform(this._hostnameContains),
        isBlock: false,
        type: "simple",
        storageClassType: "string",
      },
      ip_like: {
        value: cdktn.stringToHclTerraform(this._ipLike),
        isBlock: false,
        type: "simple",
        storageClassType: "string",
      },
      ip_v4: {
        value: cdktn.stringToHclTerraform(this._ipV4),
        isBlock: false,
        type: "simple",
        storageClassType: "string",
      },
      ip_v6: {
        value: cdktn.stringToHclTerraform(this._ipV6),
        isBlock: false,
        type: "simple",
        storageClassType: "string",
      },
      ...
      ipv4_end: {
        value: cdktn.stringToHclTerraform(this._ipv4End),
        isBlock: false,
        type: "simple",
        storageClassType: "string",
      },
      ipv4_start: {
        value: cdktn.stringToHclTerraform(this._ipv4Start),
        isBlock: false,
        type: "simple",
        storageClassType: "string",
      },
      ipv6_end: {
        value: cdktn.stringToHclTerraform(this._ipv6End),
        isBlock: false,
        type: "simple",
        storageClassType: "string",
      },
      ipv6_start: {
        value: cdktn.stringToHclTerraform(this._ipv6Start),
        isBlock: false,
        type: "simple",
        storageClassType: "string",
      },
      ...
      modified_after: {
        value: cdktn.stringToHclTerraform(this._modifiedAfter),
        isBlock: false,
        type: "simple",
        storageClassType: "string",
      },
      modified_before: {
        value: cdktn.stringToHclTerraform(this._modifiedBefore),
        isBlock: false,
        type: "simple",
        storageClassType: "string",
      },

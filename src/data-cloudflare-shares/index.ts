...
// https://registry.terraform.io/providers/cloudflare/cloudflare/5.24.0/docs/data-sources/shares
...
export class DataCloudflareSharesResultResourcesOutputReference extends cdktn.ComplexObject {
...
export class DataCloudflareSharesResultResourcesList extends cdktn.ComplexList {
...
export class DataCloudflareSharesResultOutputReference extends cdktn.ComplexObject {
  private isEmptyObject = false;
...
export class DataCloudflareSharesResultList extends cdktn.ComplexList {
...
/**
* Represents a {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.24.0/docs/data-sources/shares cloudflare_shares}
*/
export class DataCloudflareShares extends cdktn.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataCloudflareShares that should be imported. Refer to the {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.24.0/docs/data-sources/shares#import import section} in the documentation of this resource for the id to use
  ...
  */
  public static generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: cdktn.TerraformProvider) {
        return new cdktn.ImportableResource(scope, importToId, { terraformResourceType: "cloudflare_shares", importId: importFromId, provider });
      }
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.24.0/docs/data-sources/shares cloudflare_shares} Data Source
  *
  * @param scope The scope in which to define this construct
  ...
  */
  ...
  protected synthesizeAttributes(): { [name: string]: any } {
    return {
      ...
      tag: cdktn.listMapper(cdktn.stringToTerraform, false)(this._tag),
  ...
  protected synthesizeHclAttributes(): { [name: string]: any } {
    const attrs = {
      ...
      tag: {
        value: cdktn.listMapperHcl(cdktn.stringToHclTerraform, false)(this._tag),
        isBlock: false,
        type: "list",
        storageClassType: "stringList",
      },

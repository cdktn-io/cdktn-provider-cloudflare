...
export interface EmailSecurityDomainConfig extends cdktn.TerraformMetaArguments {
  /**
  * Identifier.
  *
...
export class EmailSecurityDomainAuthorizationOutputReference extends cdktn.ComplexObject {
...
export class EmailSecurityDomainEmailsProcessedOutputReference extends cdktn.ComplexObject {
  private isEmptyObject = false;
...
export class EmailSecurityDomain extends cdktn.TerraformResource {
  ...
  */
  ...
  private _requireTlsInbound?: boolean | cdktn.IResolvable; 
  public get requireTlsInbound() {
    return this.getBooleanAttribute('require_tls_inbound');
  }
  public set requireTlsInbound(value: boolean | cdktn.IResolvable) {
  ...
  private _requireTlsOutbound?: boolean | cdktn.IResolvable; 
  public get requireTlsOutbound() {
    return this.getBooleanAttribute('require_tls_outbound');
  }
  public set requireTlsOutbound(value: boolean | cdktn.IResolvable) {
  ...
  protected synthesizeAttributes(): { [name: string]: any } {
    return {
      ...
      allowed_delivery_modes: cdktn.listMapper(cdktn.stringToTerraform, false)(this._allowedDeliveryModes),
      domain: cdktn.stringToTerraform(this._domain),
      drop_dispositions: cdktn.listMapper(cdktn.stringToTerraform, false)(this._dropDispositions),
      folder: cdktn.stringToTerraform(this._folder),
      integration_id: cdktn.stringToTerraform(this._integrationId),
      ip_restrictions: cdktn.listMapper(cdktn.stringToTerraform, false)(this._ipRestrictions),
      lookback_hops: cdktn.numberToTerraform(this._lookbackHops),
      regions: cdktn.listMapper(cdktn.stringToTerraform, false)(this._regions),
      require_tls_inbound: cdktn.booleanToTerraform(this._requireTlsInbound),
      require_tls_outbound: cdktn.booleanToTerraform(this._requireTlsOutbound),
      transport: cdktn.stringToTerraform(this._transport),
    };
  }
  ...
  protected synthesizeHclAttributes(): { [name: string]: any } {
    const attrs = {
      ...
      allowed_delivery_modes: {
        value: cdktn.listMapperHcl(cdktn.stringToHclTerraform, false)(this._allowedDeliveryModes),
        isBlock: false,
        type: "set",
      ...
      drop_dispositions: {
        value: cdktn.listMapperHcl(cdktn.stringToHclTerraform, false)(this._dropDispositions),
        isBlock: false,
        type: "set",
        storageClassType: "stringList",
      },
      ...
      ip_restrictions: {
        value: cdktn.listMapperHcl(cdktn.stringToHclTerraform, false)(this._ipRestrictions),
        isBlock: false,
        type: "set",
        storageClassType: "stringList",
      },
      lookback_hops: {
        value: cdktn.numberToHclTerraform(this._lookbackHops),
        isBlock: false,
        type: "simple",
      ...
      require_tls_inbound: {
        value: cdktn.booleanToHclTerraform(this._requireTlsInbound),
        isBlock: false,
        type: "simple",
        storageClassType: "boolean",
      },
      require_tls_outbound: {
        value: cdktn.booleanToHclTerraform(this._requireTlsOutbound),
        isBlock: false,
        type: "simple",
        storageClassType: "boolean",
      },
      transport: {
        value: cdktn.stringToHclTerraform(this._transport),
        isBlock: false,
        type: "simple",
        storageClassType: "string",
      },

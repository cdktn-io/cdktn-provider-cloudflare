...
export interface DataCloudflareEmailSendingSubdomainConfig extends cdktn.TerraformMetaArguments {
  /**
...
*/
export class DataCloudflareEmailSendingSubdomain extends cdktn.TerraformDataSource {
  ...
  */
  ...
  protected synthesizeAttributes(): { [name: string]: any } {
    return {
      subdomain_id: cdktn.stringToTerraform(this._subdomainId),
  ...
  protected synthesizeHclAttributes(): { [name: string]: any } {
    const attrs = {
      subdomain_id: {
        value: cdktn.stringToHclTerraform(this._subdomainId),
        isBlock: false,
        type: "simple",

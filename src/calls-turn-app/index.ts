...
// https://registry.terraform.io/providers/cloudflare/cloudflare/5.19.1/docs/resources/calls_turn_app
...
export class CallsTurnApp extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing CallsTurnApp that should be imported. Refer to the {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.19.1/docs/resources/calls_turn_app#import import section} in the documentation of this resource for the id to use

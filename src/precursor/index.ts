...
export interface PrecursorConfig extends cdktn.TerraformMetaArguments {
  /**
...
export function precursorEnforcementRulesToTerraform(struct?: PrecursorEnforcementRules | cdktn.IResolvable): any {
...
export function precursorEnforcementRulesToHclTerraform(struct?: PrecursorEnforcementRules | cdktn.IResolvable): any {
  if (!cdktn.canInspect(struct) || cdktn.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktn.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdktn.io/docs/concepts/resources#references");
  }
...
export class PrecursorEnforcementRulesOutputReference extends cdktn.ComplexObject {
  ...
  */
  ...
  public get internalValue(): PrecursorEnforcementRules | cdktn.IResolvable | undefined {
  ...
  public set internalValue(value: PrecursorEnforcementRules | cdktn.IResolvable | undefined) {
    if (value === undefined) {
...
export class PrecursorEnforcementRulesList extends cdktn.ComplexList {
  public internalValue? : PrecursorEnforcementRules[] | cdktn.IResolvable
...
export class Precursor extends cdktn.TerraformResource {
  ...
  */
  public static generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: cdktn.TerraformProvider) {
        return new cdktn.ImportableResource(scope, importToId, { terraformResourceType: "cloudflare_precursor", importId: importFromId, provider });
      }
  ...
  */
  ...
  public putEnforcementRules(value: PrecursorEnforcementRules[] | cdktn.IResolvable) {
  ...
  protected synthesizeAttributes(): { [name: string]: any } {
    return {
      default_mode: cdktn.stringToTerraform(this._defaultMode),
      enforcement_rules: cdktn.listMapper(precursorEnforcementRulesToTerraform, false)(this._enforcementRules.internalValue),
  ...
  protected synthesizeHclAttributes(): { [name: string]: any } {
    const attrs = {
      default_mode: {
        value: cdktn.stringToHclTerraform(this._defaultMode),
        isBlock: false,
        type: "simple",
        storageClassType: "string",
      },
      enforcement_rules: {
        value: cdktn.listMapperHcl(precursorEnforcementRulesToHclTerraform, false)(this._enforcementRules.internalValue),
        isBlock: true,
        type: "list",

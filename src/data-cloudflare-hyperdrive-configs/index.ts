...
// https://registry.terraform.io/providers/cloudflare/cloudflare/5.18.0/docs/data-sources/hyperdrive_configs
...
export interface DataCloudflareHyperdriveConfigsConfig extends cdktn.TerraformMetaArguments {
  /**
...
export class DataCloudflareHyperdriveConfigsResultCachingOutputReference extends cdktn.ComplexObject {
...
export class DataCloudflareHyperdriveConfigsResultMtlsOutputReference extends cdktn.ComplexObject {
  private isEmptyObject = false;
...
export class DataCloudflareHyperdriveConfigsResultOriginOutputReference extends cdktn.ComplexObject {
  private isEmptyObject = false;
...
export class DataCloudflareHyperdriveConfigsResultOutputReference extends cdktn.ComplexObject {
  private isEmptyObject = false;
...
export class DataCloudflareHyperdriveConfigsResultList extends cdktn.ComplexList {
...
export class DataCloudflareHyperdriveConfigs extends cdktn.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataCloudflareHyperdriveConfigs that should be imported. Refer to the {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.18.0/docs/data-sources/hyperdrive_configs#import import section} in the documentation of this resource for the id to use
  ...
  */
  public static generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: cdktn.TerraformProvider) {
        return new cdktn.ImportableResource(scope, importToId, { terraformResourceType: "cloudflare_hyperdrive_configs", importId: importFromId, provider });
      }

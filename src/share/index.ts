...
// https://registry.terraform.io/providers/cloudflare/cloudflare/5.20.0/docs/resources/share
...
export function shareRecipientsToTerraform(struct?: ShareRecipients | cdktn.IResolvable): any {
  ...
  return {
    ...
    recipient_account_id: cdktn.stringToTerraform(struct!.recipientAccountId),
  }
}


export function shareRecipientsToHclTerraform(struct?: ShareRecipients | cdktn.IResolvable): any {
  if (!cdktn.canInspect(struct) || cdktn.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktn.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdktn.io/docs/concepts/resources#references");
  }
  const attrs = {
    ...
    recipient_account_id: {
      value: cdktn.stringToHclTerraform(struct!.recipientAccountId),
      isBlock: false,
      type: "simple",
      storageClassType: "string",
    },
...
export class ShareRecipientsOutputReference extends cdktn.ComplexObject {
  ...
  */
  ...
  public get internalValue(): ShareRecipients | cdktn.IResolvable | undefined {
  ...
  public set internalValue(value: ShareRecipients | cdktn.IResolvable | undefined) {
    if (value === undefined) {
...
export class ShareRecipientsList extends cdktn.ComplexList {
  public internalValue? : ShareRecipients[] | cdktn.IResolvable
...
export function shareResourcesToTerraform(struct?: ShareResources | cdktn.IResolvable): any {
  if (!cdktn.canInspect(struct) || cdktn.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktn.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdktn.io/docs/concepts/resources#references");
  }
  return {
    meta: cdktn.stringToTerraform(struct!.meta),
    resource_account_id: cdktn.stringToTerraform(struct!.resourceAccountId),
...
export function shareResourcesToHclTerraform(struct?: ShareResources | cdktn.IResolvable): any {
  if (!cdktn.canInspect(struct) || cdktn.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktn.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdktn.io/docs/concepts/resources#references");
  }
  const attrs = {
    meta: {
      value: cdktn.stringToHclTerraform(struct!.meta),
      isBlock: false,
      type: "simple",
      storageClassType: "string",
    },
    resource_account_id: {
      value: cdktn.stringToHclTerraform(struct!.resourceAccountId),
      isBlock: false,
      type: "simple",
      storageClassType: "string",
    },
...
export class ShareResourcesOutputReference extends cdktn.ComplexObject {
  private isEmptyObject = false;
  private resolvableValue?: cdktn.IResolvable;
  ...
  */
  ...
  public get internalValue(): ShareResources | cdktn.IResolvable | undefined {
    if (this.resolvableValue) {
      return this.resolvableValue;
    }
    let hasAnyValues = this.isEmptyObject;
  ...
  public set internalValue(value: ShareResources | cdktn.IResolvable | undefined) {
    if (value === undefined) {
      this.isEmptyObject = false;
      this.resolvableValue = undefined;
...
export class ShareResourcesList extends cdktn.ComplexList {
  public internalValue? : ShareResources[] | cdktn.IResolvable
...
export class Share extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing Share that should be imported. Refer to the {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.20.0/docs/resources/share#import import section} in the documentation of this resource for the id to use
  * @param provider? Optional instance of the provider where the Share to import is found
  */
  public static generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: cdktn.TerraformProvider) {
        return new cdktn.ImportableResource(scope, importToId, { terraformResourceType: "cloudflare_share", importId: importFromId, provider });
      }
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.20.0/docs/resources/share cloudflare_share} Resource
  *
  * @param scope The scope in which to define this construct
  ...
  */
  ...
  public putRecipients(value: ShareRecipients[] | cdktn.IResolvable) {
  ...
  public putResources(value: ShareResources[] | cdktn.IResolvable) {
  ...
  protected synthesizeHclAttributes(): { [name: string]: any } {
    const attrs = {
      ...
      recipients: {
        value: cdktn.listMapperHcl(shareRecipientsToHclTerraform, false)(this._recipients.internalValue),
        isBlock: true,
        type: "list",
        storageClassType: "ShareRecipientsList",
      },
      resources: {
        value: cdktn.listMapperHcl(shareResourcesToHclTerraform, false)(this._resources.internalValue),
        isBlock: true,
        type: "list",

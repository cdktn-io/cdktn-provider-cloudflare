...
export interface OriginTlsComplianceModesConfig extends cdktn.TerraformMetaArguments {
  /**
...
export class OriginTlsComplianceModes extends cdktn.TerraformResource {
  ...
  */
  ...
  protected synthesizeAttributes(): { [name: string]: any } {
    return {
      value: cdktn.listMapper(cdktn.stringToTerraform, false)(this._value),
  ...
  protected synthesizeHclAttributes(): { [name: string]: any } {
    const attrs = {
      value: {
        value: cdktn.listMapperHcl(cdktn.stringToHclTerraform, false)(this._value),
        isBlock: false,
        type: "list",

...
// https://registry.terraform.io/providers/cloudflare/cloudflare/5.20.0/docs/data-sources/secrets_store
...
export function dataCloudflareSecretsStoreFilterToTerraform(struct?: DataCloudflareSecretsStoreFilter | cdktn.IResolvable): any {
...
export function dataCloudflareSecretsStoreFilterToHclTerraform(struct?: DataCloudflareSecretsStoreFilter | cdktn.IResolvable): any {
  if (!cdktn.canInspect(struct) || cdktn.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktn.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdktn.io/docs/concepts/resources#references");
  }
...
export class DataCloudflareSecretsStoreFilterOutputReference extends cdktn.ComplexObject {
  ...
  */
  ...
  public get internalValue(): DataCloudflareSecretsStoreFilter | cdktn.IResolvable | undefined {
  ...
  public set internalValue(value: DataCloudflareSecretsStoreFilter | cdktn.IResolvable | undefined) {
    if (value === undefined) {
...
*/
export class DataCloudflareSecretsStore extends cdktn.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataCloudflareSecretsStore that should be imported. Refer to the {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.20.0/docs/data-sources/secrets_store#import import section} in the documentation of this resource for the id to use
  ...
  */
  public static generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: cdktn.TerraformProvider) {
        return new cdktn.ImportableResource(scope, importToId, { terraformResourceType: "cloudflare_secrets_store", importId: importFromId, provider });
      }
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.20.0/docs/data-sources/secrets_store cloudflare_secrets_store} Data Source
  *
  * @param scope The scope in which to define this construct

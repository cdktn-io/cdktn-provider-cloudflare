...
// https://registry.terraform.io/providers/cloudflare/cloudflare/5.20.0/docs/data-sources/zero_trust_resource_library_categories
...
export interface DataCloudflareZeroTrustResourceLibraryCategoriesConfig extends cdktn.TerraformMetaArguments {
  /**
...
export class DataCloudflareZeroTrustResourceLibraryCategoriesResultOutputReference extends cdktn.ComplexObject {
...
export class DataCloudflareZeroTrustResourceLibraryCategoriesResultList extends cdktn.ComplexList {
...
*/
export class DataCloudflareZeroTrustResourceLibraryCategories extends cdktn.TerraformDataSource {
  ...
  */
  public static generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: cdktn.TerraformProvider) {
        return new cdktn.ImportableResource(scope, importToId, { terraformResourceType: "cloudflare_zero_trust_resource_library_categories", importId: importFromId, provider });
      }

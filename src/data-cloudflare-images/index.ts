...
// https://registry.terraform.io/providers/cloudflare/cloudflare/5.17.0/docs/data-sources/images
...
export interface DataCloudflareImagesConfig extends cdktn.TerraformMetaArguments {
  /**
...
export class DataCloudflareImagesResultImagesOutputReference extends cdktn.ComplexObject {
...
export class DataCloudflareImagesResultImagesList extends cdktn.ComplexList {
...
export class DataCloudflareImagesResultOutputReference extends cdktn.ComplexObject {
  private isEmptyObject = false;
...
export class DataCloudflareImagesResultList extends cdktn.ComplexList {
...
export class DataCloudflareImages extends cdktn.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataCloudflareImages that should be imported. Refer to the {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.17.0/docs/data-sources/images#import import section} in the documentation of this resource for the id to use
  ...
  */
  public static generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: cdktn.TerraformProvider) {
        return new cdktn.ImportableResource(scope, importToId, { terraformResourceType: "cloudflare_images", importId: importFromId, provider });
      }
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.17.0/docs/data-sources/images cloudflare_images} Data Source
  *
  * @param scope The scope in which to define this construct

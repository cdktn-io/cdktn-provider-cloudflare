...
// https://registry.terraform.io/providers/cloudflare/cloudflare/5.20.0/docs/resources/zero_trust_dlp_sensitivity_level
...
export interface ZeroTrustDlpSensitivityLevelConfig extends cdktn.TerraformMetaArguments {
  /**
...
*/
export class ZeroTrustDlpSensitivityLevel extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing ZeroTrustDlpSensitivityLevel that should be imported. Refer to the {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.20.0/docs/resources/zero_trust_dlp_sensitivity_level#import import section} in the documentation of this resource for the id to use

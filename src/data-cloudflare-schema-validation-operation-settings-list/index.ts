...
// https://registry.terraform.io/providers/cloudflare/cloudflare/5.18.0/docs/data-sources/schema_validation_operation_settings_list
...
export interface DataCloudflareSchemaValidationOperationSettingsListConfig extends cdktn.TerraformMetaArguments {
  /**
...
export class DataCloudflareSchemaValidationOperationSettingsListResultOutputReference extends cdktn.ComplexObject {
...
export class DataCloudflareSchemaValidationOperationSettingsListResultList extends cdktn.ComplexList {
...
*/
export class DataCloudflareSchemaValidationOperationSettingsList extends cdktn.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataCloudflareSchemaValidationOperationSettingsList that should be imported. Refer to the {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.18.0/docs/data-sources/schema_validation_operation_settings_list#import import section} in the documentation of this resource for the id to use
  ...
  */
  public static generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: cdktn.TerraformProvider) {
        return new cdktn.ImportableResource(scope, importToId, { terraformResourceType: "cloudflare_schema_validation_operation_settings_list", importId: importFromId, provider });
      }
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.18.0/docs/data-sources/schema_validation_operation_settings_list cloudflare_schema_validation_operation_settings_list} Data Source
  *
  * @param scope The scope in which to define this construct

...
// https://registry.terraform.io/providers/cloudflare/cloudflare/5.18.0/docs/resources/zero_trust_access_mtls_certificate
...
export interface ZeroTrustAccessMtlsCertificateConfig extends cdktn.TerraformMetaArguments {
  /**
...
*/
export class ZeroTrustAccessMtlsCertificate extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing ZeroTrustAccessMtlsCertificate that should be imported. Refer to the {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.18.0/docs/resources/zero_trust_access_mtls_certificate#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  public get associatedHostnames() {
    return cdktn.Fn.tolist(this.getListAttribute('associated_hostnames'));
  }
  ...
  protected synthesizeAttributes(): { [name: string]: any } {
    return {
      ...
      associated_hostnames: cdktn.listMapper(cdktn.stringToTerraform, false)(this._associatedHostnames),
  ...
  protected synthesizeHclAttributes(): { [name: string]: any } {
    const attrs = {
      ...
      associated_hostnames: {
        value: cdktn.listMapperHcl(cdktn.stringToHclTerraform, false)(this._associatedHostnames),
        isBlock: false,
        type: "set",

...
// https://registry.terraform.io/providers/cloudflare/cloudflare/5.20.0/docs/resources/secrets_store_secret
...
export interface SecretsStoreSecretConfig extends cdktn.TerraformMetaArguments {
  /**
  * Account Identifier
  *
...
*/
export class SecretsStoreSecret extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing SecretsStoreSecret that should be imported. Refer to the {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.20.0/docs/resources/secrets_store_secret#import import section} in the documentation of this resource for the id to use

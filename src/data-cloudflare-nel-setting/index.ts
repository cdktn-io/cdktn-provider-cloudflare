...
export interface DataCloudflareNelSettingConfig extends cdktn.TerraformMetaArguments {
  /**
...
export class DataCloudflareNelSettingValueOutputReference extends cdktn.ComplexObject {
...
*/
export class DataCloudflareNelSetting extends cdktn.TerraformDataSource {
  ...
  */
  public static generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: cdktn.TerraformProvider) {
        return new cdktn.ImportableResource(scope, importToId, { terraformResourceType: "cloudflare_nel_setting", importId: importFromId, provider });
      }

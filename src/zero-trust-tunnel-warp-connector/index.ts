...
// https://registry.terraform.io/providers/cloudflare/cloudflare/5.19.1/docs/resources/zero_trust_tunnel_warp_connector
...
export interface ZeroTrustTunnelWarpConnectorConfig extends cdktn.TerraformMetaArguments {
  /**
...
export class ZeroTrustTunnelWarpConnectorConnectionsOutputReference extends cdktn.ComplexObject {
...
export class ZeroTrustTunnelWarpConnectorConnectionsList extends cdktn.ComplexList {
...
*/
export class ZeroTrustTunnelWarpConnector extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing ZeroTrustTunnelWarpConnector that should be imported. Refer to the {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.19.1/docs/resources/zero_trust_tunnel_warp_connector#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  private _ha?: boolean | cdktn.IResolvable; 
  public get ha() {
    return this.getBooleanAttribute('ha');
  }
  public set ha(value: boolean | cdktn.IResolvable) {
    this._ha = value;
  }
  public resetHa() {
    this._ha = undefined;
  ...
  protected synthesizeAttributes(): { [name: string]: any } {
    return {
      ...
      ha: cdktn.booleanToTerraform(this._ha),
  ...
  protected synthesizeHclAttributes(): { [name: string]: any } {
    const attrs = {
      ...
      ha: {
        value: cdktn.booleanToHclTerraform(this._ha),
        isBlock: false,
        type: "simple",

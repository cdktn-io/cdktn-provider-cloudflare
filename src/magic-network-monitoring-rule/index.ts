...
// https://registry.terraform.io/providers/cloudflare/cloudflare/5.17.0/docs/resources/magic_network_monitoring_rule
...
export class MagicNetworkMonitoringRule extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing MagicNetworkMonitoringRule that should be imported. Refer to the {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.17.0/docs/resources/magic_network_monitoring_rule#import import section} in the documentation of this resource for the id to use
  ...
  protected synthesizeHclAttributes(): { [name: string]: any } {
    const attrs = {
      ...
      automatic_advertisement: {
        value: cdktn.booleanToHclTerraform(this._automaticAdvertisement),
        isBlock: false,
        type: "simple",
      ...
      packet_threshold: {
        value: cdktn.numberToHclTerraform(this._packetThreshold),
        isBlock: false,
        type: "simple",
        storageClassType: "number",
      },

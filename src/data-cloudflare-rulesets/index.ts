...
// https://registry.terraform.io/providers/cloudflare/cloudflare/5.17.0/docs/data-sources/rulesets
...
export interface DataCloudflareRulesetsConfig extends cdktn.TerraformMetaArguments {
  /**
...
export class DataCloudflareRulesetsResultOutputReference extends cdktn.ComplexObject {
...
export class DataCloudflareRulesetsResultList extends cdktn.ComplexList {
...
export class DataCloudflareRulesetsRulesetsOutputReference extends cdktn.ComplexObject {
  private isEmptyObject = false;
...
export class DataCloudflareRulesetsRulesetsList extends cdktn.ComplexList {
...
*/
export class DataCloudflareRulesets extends cdktn.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataCloudflareRulesets that should be imported. Refer to the {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.17.0/docs/data-sources/rulesets#import import section} in the documentation of this resource for the id to use
  ...
  */
  public static generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: cdktn.TerraformProvider) {
        return new cdktn.ImportableResource(scope, importToId, { terraformResourceType: "cloudflare_rulesets", importId: importFromId, provider });
      }

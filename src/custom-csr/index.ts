...
// https://registry.terraform.io/providers/cloudflare/cloudflare/5.20.0/docs/resources/custom_csr
...
*/
export class CustomCsr extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing CustomCsr that should be imported. Refer to the {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.20.0/docs/resources/custom_csr#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  protected synthesizeAttributes(): { [name: string]: any } {
    return {
      ...
      sans: cdktn.listMapper(cdktn.stringToTerraform, false)(this._sans),
  ...
  protected synthesizeHclAttributes(): { [name: string]: any } {
    const attrs = {
      ...
      sans: {
        value: cdktn.listMapperHcl(cdktn.stringToHclTerraform, false)(this._sans),
        isBlock: false,
        type: "list",

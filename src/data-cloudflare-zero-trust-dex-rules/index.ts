...
// https://registry.terraform.io/providers/cloudflare/cloudflare/5.18.0/docs/data-sources/zero_trust_dex_rules
...
export interface DataCloudflareZeroTrustDexRulesConfig extends cdktn.TerraformMetaArguments {
  /**
...
export class DataCloudflareZeroTrustDexRulesResultRulesTargetedTestsDataOutputReference extends cdktn.ComplexObject {
...
export class DataCloudflareZeroTrustDexRulesResultRulesTargetedTestsOutputReference extends cdktn.ComplexObject {
  private isEmptyObject = false;
...
export class DataCloudflareZeroTrustDexRulesResultRulesTargetedTestsList extends cdktn.ComplexList {
...
export class DataCloudflareZeroTrustDexRulesResultRulesOutputReference extends cdktn.ComplexObject {
  private isEmptyObject = false;
...
export class DataCloudflareZeroTrustDexRulesResultRulesList extends cdktn.ComplexList {
...
export class DataCloudflareZeroTrustDexRulesResultOutputReference extends cdktn.ComplexObject {
  private isEmptyObject = false;
...
export class DataCloudflareZeroTrustDexRulesResultList extends cdktn.ComplexList {
...
*/
export class DataCloudflareZeroTrustDexRules extends cdktn.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataCloudflareZeroTrustDexRules that should be imported. Refer to the {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.18.0/docs/data-sources/zero_trust_dex_rules#import import section} in the documentation of this resource for the id to use
  ...
  */
  public static generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: cdktn.TerraformProvider) {
        return new cdktn.ImportableResource(scope, importToId, { terraformResourceType: "cloudflare_zero_trust_dex_rules", importId: importFromId, provider });
      }

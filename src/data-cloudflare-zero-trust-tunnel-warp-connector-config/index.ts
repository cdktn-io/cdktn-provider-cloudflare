...
// https://registry.terraform.io/providers/cloudflare/cloudflare/5.20.0/docs/data-sources/zero_trust_tunnel_warp_connector_config
...
export class DataCloudflareZeroTrustTunnelWarpConnectorConfigConfigVipsOutputReference extends cdktn.ComplexObject {
...
export class DataCloudflareZeroTrustTunnelWarpConnectorConfigConfigVipsList extends cdktn.ComplexList {
...
export class DataCloudflareZeroTrustTunnelWarpConnectorConfigConfigVipsPreviousOutputReference extends cdktn.ComplexObject {
  private isEmptyObject = false;
...
export class DataCloudflareZeroTrustTunnelWarpConnectorConfigConfigVipsPreviousList extends cdktn.ComplexList {
...
export class DataCloudflareZeroTrustTunnelWarpConnectorConfigConfigOutputReference extends cdktn.ComplexObject {
  private isEmptyObject = false;
...
*/
export class DataCloudflareZeroTrustTunnelWarpConnectorConfigA extends cdktn.TerraformDataSource {
  ...
  */
  public static generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: cdktn.TerraformProvider) {
        return new cdktn.ImportableResource(scope, importToId, { terraformResourceType: "cloudflare_zero_trust_tunnel_warp_connector_config", importId: importFromId, provider });
      }
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.20.0/docs/data-sources/zero_trust_tunnel_warp_connector_config cloudflare_zero_trust_tunnel_warp_connector_config} Data Source
  *
  * @param scope The scope in which to define this construct

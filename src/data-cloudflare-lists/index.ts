...
// https://registry.terraform.io/providers/cloudflare/cloudflare/5.18.0/docs/data-sources/lists
...
export interface DataCloudflareListsConfig extends cdktn.TerraformMetaArguments {
  /**
...
export class DataCloudflareListsResultOutputReference extends cdktn.ComplexObject {
...
export class DataCloudflareListsResultList extends cdktn.ComplexList {
...
*/
export class DataCloudflareLists extends cdktn.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataCloudflareLists that should be imported. Refer to the {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.18.0/docs/data-sources/lists#import import section} in the documentation of this resource for the id to use
  ...
  */
  public static generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: cdktn.TerraformProvider) {
        return new cdktn.ImportableResource(scope, importToId, { terraformResourceType: "cloudflare_lists", importId: importFromId, provider });
      }

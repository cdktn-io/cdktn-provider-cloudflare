...
// https://registry.terraform.io/providers/cloudflare/cloudflare/5.18.0/docs/resources/r2_bucket_cors
...
export interface R2BucketCorsConfig extends cdktn.TerraformMetaArguments {
  /**
  * Account ID.
  *
  ...
  */
  readonly rules?: R2BucketCorsRules[] | cdktn.IResolvable;
}
...
export function r2BucketCorsRulesAllowedToTerraform(struct?: R2BucketCorsRulesAllowed | cdktn.IResolvable): any {
...
export function r2BucketCorsRulesAllowedToHclTerraform(struct?: R2BucketCorsRulesAllowed | cdktn.IResolvable): any {
  if (!cdktn.canInspect(struct) || cdktn.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktn.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
...
export class R2BucketCorsRulesAllowedOutputReference extends cdktn.ComplexObject {
  ...
  */
  ...
  public get internalValue(): R2BucketCorsRulesAllowed | cdktn.IResolvable | undefined {
  ...
  public set internalValue(value: R2BucketCorsRulesAllowed | cdktn.IResolvable | undefined) {
    if (value === undefined) {
...
export function r2BucketCorsRulesToTerraform(struct?: R2BucketCorsRules | cdktn.IResolvable): any {
  if (!cdktn.canInspect(struct) || cdktn.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktn.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
...
export function r2BucketCorsRulesToHclTerraform(struct?: R2BucketCorsRules | cdktn.IResolvable): any {
  if (!cdktn.canInspect(struct) || cdktn.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktn.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
...
export class R2BucketCorsRulesOutputReference extends cdktn.ComplexObject {
  private isEmptyObject = false;
  private resolvableValue?: cdktn.IResolvable;
  ...
  */
  ...
  public get internalValue(): R2BucketCorsRules | cdktn.IResolvable | undefined {
    if (this.resolvableValue) {
      return this.resolvableValue;
    }
    let hasAnyValues = this.isEmptyObject;
  ...
  public set internalValue(value: R2BucketCorsRules | cdktn.IResolvable | undefined) {
    if (value === undefined) {
      this.isEmptyObject = false;
      this.resolvableValue = undefined;
...
export class R2BucketCorsRulesList extends cdktn.ComplexList {
  public internalValue? : R2BucketCorsRules[] | cdktn.IResolvable
...
*/
export class R2BucketCors extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing R2BucketCors that should be imported. Refer to the {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.18.0/docs/resources/r2_bucket_cors#import import section} in the documentation of this resource for the id to use
  * @param provider? Optional instance of the provider where the R2BucketCors to import is found
  */
  public static generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: cdktn.TerraformProvider) {
        return new cdktn.ImportableResource(scope, importToId, { terraformResourceType: "cloudflare_r2_bucket_cors", importId: importFromId, provider });
      }
  ...
  */
  ...
  public putRules(value: R2BucketCorsRules[] | cdktn.IResolvable) {
  ...
  protected synthesizeAttributes(): { [name: string]: any } {
    return {
      ...
      rules: cdktn.listMapper(r2BucketCorsRulesToTerraform, false)(this._rules.internalValue),
    };
  }
  ...
  protected synthesizeHclAttributes(): { [name: string]: any } {
    const attrs = {
      ...
      rules: {
        value: cdktn.listMapperHcl(r2BucketCorsRulesToHclTerraform, false)(this._rules.internalValue),
        isBlock: true,
        type: "list",

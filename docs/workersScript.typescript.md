...
```typescript
import { workersScript } from '@cdktn/provider-cloudflare'
...
```typescript
public putAnnotations(value: WorkersScriptAnnotations): void
```
...
- *Type:* cdktn.IResolvable | <a href="#@cdktn/provider-cloudflare.workersScript.WorkersScriptBindings">WorkersScriptBindings</a>[]
...
```typescript
public putCacheOptions(value: WorkersScriptCacheOptions): void
```
...
```typescript
public putExports(value: IResolvable | {[ key: string ]: WorkersScriptExports}): void
```
...
- *Type:* cdktn.IResolvable | {[ key: string ]: <a href="#@cdktn/provider-cloudflare.workersScript.WorkersScriptExports">WorkersScriptExports</a>}
...
```typescript
public putFiles(value: IResolvable | {[ key: string ]: WorkersScriptFiles}): void
```

###### `value`<sup>Required</sup> <a name="value" id="@cdktn/provider-cloudflare.workersScript.WorkersScript.putFiles.parameter.value"></a>

- *Type:* cdktn.IResolvable | {[ key: string ]: <a href="#@cdktn/provider-cloudflare.workersScript.WorkersScriptFiles">WorkersScriptFiles</a>}
...
```typescript
public putPackageDependencies(value: IResolvable | WorkersScriptPackageDependencies[]): void
```
...
- *Type:* cdktn.IResolvable | <a href="#@cdktn/provider-cloudflare.workersScript.WorkersScriptPackageDependencies">WorkersScriptPackageDependencies</a>[]
...
- *Type:* cdktn.IResolvable | <a href="#@cdktn/provider-cloudflare.workersScript.WorkersScriptTailConsumers">WorkersScriptTailConsumers</a>[]
...
```typescript
public resetPackageDependencies(): void
```
...
| <code><a href="#@cdktn/provider-cloudflare.workersScript.WorkersScript.property.cdktfStack">cdktfStack</a></code> | <code>cdktn.TerraformStack</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-cloudflare.workersScript.WorkersScript.property.terraformMetaArguments">terraformMetaArguments</a></code> | <code>{[ key: string ]: any}</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-cloudflare.workersScript.WorkersScript.property.terraformGeneratorMetadata">terraformGeneratorMetadata</a></code> | <code>cdktn.TerraformProviderGeneratorMetadata</code> | *No description.* |
| <code><a href="#@cdktn/provider-cloudflare.workersScript.WorkersScript.property.connection">connection</a></code> | <code>cdktn.SSHProvisionerConnection \| cdktn.WinrmProvisionerConnection</code> | *No description.* |
| <code><a href="#@cdktn/provider-cloudflare.workersScript.WorkersScript.property.count">count</a></code> | <code>number \| cdktn.TerraformCount</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-cloudflare.workersScript.WorkersScript.property.forEach">forEach</a></code> | <code>cdktn.ITerraformIterator</code> | *No description.* |
| <code><a href="#@cdktn/provider-cloudflare.workersScript.WorkersScript.property.lifecycle">lifecycle</a></code> | <code>cdktn.TerraformResourceLifecycle</code> | *No description.* |
| <code><a href="#@cdktn/provider-cloudflare.workersScript.WorkersScript.property.provider">provider</a></code> | <code>cdktn.TerraformProvider</code> | *No description.* |
| <code><a href="#@cdktn/provider-cloudflare.workersScript.WorkersScript.property.provisioners">provisioners</a></code> | <code>cdktn.FileProvisioner \| cdktn.LocalExecProvisioner \| cdktn.RemoteExecProvisioner[]</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-cloudflare.workersScript.WorkersScript.property.hasAssets">hasAssets</a></code> | <code>cdktn.IResolvable</code> | *No description.* |
| <code><a href="#@cdktn/provider-cloudflare.workersScript.WorkersScript.property.hasModules">hasModules</a></code> | <code>cdktn.IResolvable</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-cloudflare.workersScript.WorkersScript.property.startupTimeMs">startupTimeMs</a></code> | <code>number</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-cloudflare.workersScript.WorkersScript.property.annotationsInput">annotationsInput</a></code> | <code>cdktn.IResolvable \| <a href="#@cdktn/provider-cloudflare.workersScript.WorkersScriptAnnotations">WorkersScriptAnnotations</a></code> | *No description.* |
| <code><a href="#@cdktn/provider-cloudflare.workersScript.WorkersScript.property.assetsInput">assetsInput</a></code> | <code>cdktn.IResolvable \| <a href="#@cdktn/provider-cloudflare.workersScript.WorkersScriptAssets">WorkersScriptAssets</a></code> | *No description.* |
| <code><a href="#@cdktn/provider-cloudflare.workersScript.WorkersScript.property.bindingsInput">bindingsInput</a></code> | <code>cdktn.IResolvable \| <a href="#@cdktn/provider-cloudflare.workersScript.WorkersScriptBindings">WorkersScriptBindings</a>[]</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-cloudflare.workersScript.WorkersScript.property.cacheOptionsInput">cacheOptionsInput</a></code> | <code>cdktn.IResolvable \| <a href="#@cdktn/provider-cloudflare.workersScript.WorkersScriptCacheOptions">WorkersScriptCacheOptions</a></code> | *No description.* |
...
| <code><a href="#@cdktn/provider-cloudflare.workersScript.WorkersScript.property.exportsInput">exportsInput</a></code> | <code>cdktn.IResolvable \| {[ key: string ]: <a href="#@cdktn/provider-cloudflare.workersScript.WorkersScriptExports">WorkersScriptExports</a>}</code> | *No description.* |
| <code><a href="#@cdktn/provider-cloudflare.workersScript.WorkersScript.property.filesInput">filesInput</a></code> | <code>cdktn.IResolvable \| {[ key: string ]: <a href="#@cdktn/provider-cloudflare.workersScript.WorkersScriptFiles">WorkersScriptFiles</a>}</code> | *No description.* |
| <code><a href="#@cdktn/provider-cloudflare.workersScript.WorkersScript.property.keepAssetsInput">keepAssetsInput</a></code> | <code>boolean \| cdktn.IResolvable</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-cloudflare.workersScript.WorkersScript.property.limitsInput">limitsInput</a></code> | <code>cdktn.IResolvable \| <a href="#@cdktn/provider-cloudflare.workersScript.WorkersScriptLimits">WorkersScriptLimits</a></code> | *No description.* |
| <code><a href="#@cdktn/provider-cloudflare.workersScript.WorkersScript.property.logpushInput">logpushInput</a></code> | <code>boolean \| cdktn.IResolvable</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-cloudflare.workersScript.WorkersScript.property.migrationsInput">migrationsInput</a></code> | <code>cdktn.IResolvable \| <a href="#@cdktn/provider-cloudflare.workersScript.WorkersScriptMigrations">WorkersScriptMigrations</a></code> | *No description.* |
| <code><a href="#@cdktn/provider-cloudflare.workersScript.WorkersScript.property.observabilityInput">observabilityInput</a></code> | <code>cdktn.IResolvable \| <a href="#@cdktn/provider-cloudflare.workersScript.WorkersScriptObservability">WorkersScriptObservability</a></code> | *No description.* |
| <code><a href="#@cdktn/provider-cloudflare.workersScript.WorkersScript.property.packageDependenciesInput">packageDependenciesInput</a></code> | <code>cdktn.IResolvable \| <a href="#@cdktn/provider-cloudflare.workersScript.WorkersScriptPackageDependencies">WorkersScriptPackageDependencies</a>[]</code> | *No description.* |
| <code><a href="#@cdktn/provider-cloudflare.workersScript.WorkersScript.property.placementInput">placementInput</a></code> | <code>cdktn.IResolvable \| <a href="#@cdktn/provider-cloudflare.workersScript.WorkersScriptPlacement">WorkersScriptPlacement</a></code> | *No description.* |
...
| <code><a href="#@cdktn/provider-cloudflare.workersScript.WorkersScript.property.tailConsumersInput">tailConsumersInput</a></code> | <code>cdktn.IResolvable \| <a href="#@cdktn/provider-cloudflare.workersScript.WorkersScriptTailConsumers">WorkersScriptTailConsumers</a>[]</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-cloudflare.workersScript.WorkersScript.property.keepAssets">keepAssets</a></code> | <code>boolean \| cdktn.IResolvable</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-cloudflare.workersScript.WorkersScript.property.logpush">logpush</a></code> | <code>boolean \| cdktn.IResolvable</code> | *No description.* |
...
```typescript
public readonly annotations: WorkersScriptAnnotationsOutputReference;
```
...
```typescript
public readonly cacheOptions: WorkersScriptCacheOptionsOutputReference;
```
...
```typescript
public readonly exports: WorkersScriptExportsMap;
```
...
```typescript
public readonly files: WorkersScriptFilesMap;
```
...
```typescript
public readonly packageDependencies: WorkersScriptPackageDependenciesList;
```
...
```typescript
public readonly annotationsInput: IResolvable | WorkersScriptAnnotations;
```

- *Type:* cdktn.IResolvable | <a href="#@cdktn/provider-cloudflare.workersScript.WorkersScriptAnnotations">WorkersScriptAnnotations</a>
...
- *Type:* cdktn.IResolvable | <a href="#@cdktn/provider-cloudflare.workersScript.WorkersScriptAssets">WorkersScriptAssets</a>
...
```typescript
public readonly cacheOptionsInput: IResolvable | WorkersScriptCacheOptions;
```

- *Type:* cdktn.IResolvable | <a href="#@cdktn/provider-cloudflare.workersScript.WorkersScriptCacheOptions">WorkersScriptCacheOptions</a>
...
```typescript
public readonly exportsInput: IResolvable | {[ key: string ]: WorkersScriptExports};
```
...
```typescript
public readonly filesInput: IResolvable | {[ key: string ]: WorkersScriptFiles};
```
...
- *Type:* cdktn.IResolvable | <a href="#@cdktn/provider-cloudflare.workersScript.WorkersScriptLimits">WorkersScriptLimits</a>
...
- *Type:* cdktn.IResolvable | <a href="#@cdktn/provider-cloudflare.workersScript.WorkersScriptMigrations">WorkersScriptMigrations</a>
...
- *Type:* cdktn.IResolvable | <a href="#@cdktn/provider-cloudflare.workersScript.WorkersScriptObservability">WorkersScriptObservability</a>
...
```typescript
public readonly packageDependenciesInput: IResolvable | WorkersScriptPackageDependencies[];
```
...
- *Type:* cdktn.IResolvable | <a href="#@cdktn/provider-cloudflare.workersScript.WorkersScriptPlacement">WorkersScriptPlacement</a>
...
const workersScriptAnnotations: workersScript.WorkersScriptAnnotations = { ... }
```
...
| <code><a href="#@cdktn/provider-cloudflare.workersScript.WorkersScriptAssetsConfig.property.runWorkerFirst">runWorkerFirst</a></code> | <code>{[ key: string ]: any}</code> | When a boolean true, requests will always invoke the Worker script. |
| <code><a href="#@cdktn/provider-cloudflare.workersScript.WorkersScriptAssetsConfig.property.serveDirectly">serveDirectly</a></code> | <code>boolean \| cdktn.IResolvable</code> | When true and the incoming request matches an asset, that will be served instead of invoking the Worker script. |
...
```typescript
public readonly runWorkerFirst: {[ key: string ]: any};
```
...
```typescript
public readonly simple: WorkersScriptBindingsSimple;
```
...
const workersScriptBindingsSimple: workersScript.WorkersScriptBindingsSimple = { ... }
```
...
| **Name** | **Type** | **Description** |
| --- | --- | --- |
| <code><a href="#@cdktn/provider-cloudflare.workersScript.WorkersScriptBindingsSimple.property.limit">limit</a></code> | <code>number</code> | The rate limit value. |
| <code><a href="#@cdktn/provider-cloudflare.workersScript.WorkersScriptBindingsSimple.property.period">period</a></code> | <code>number</code> | The rate limit period in seconds. |
| <code><a href="#@cdktn/provider-cloudflare.workersScript.WorkersScriptBindingsSimple.property.mitigationTimeout">mitigationTimeout</a></code> | <code>number</code> | Duration in seconds to apply the mitigation action after the rate limit is exceeded. |
...
const workersScriptCacheOptions: workersScript.WorkersScriptCacheOptions = { ... }
```
...
| **Name** | **Type** | **Description** |
| --- | --- | --- |
| <code><a href="#@cdktn/provider-cloudflare.workersScript.WorkersScriptCacheOptions.property.crossVersionCache">crossVersionCache</a></code> | <code>boolean \| cdktn.IResolvable</code> | Whether cached responses are shared across Worker version uploads. |
| <code><a href="#@cdktn/provider-cloudflare.workersScript.WorkersScriptCacheOptions.property.enabled">enabled</a></code> | <code>boolean \| cdktn.IResolvable</code> | Whether caching is enabled for this Worker. |
...
| **Name** | **Type** | **Description** |
| --- | --- | --- |
| <code><a href="#@cdktn/provider-cloudflare.workersScript.WorkersScriptConfig.property.connection">connection</a></code> | <code>cdktn.SSHProvisionerConnection \| cdktn.WinrmProvisionerConnection</code> | *No description.* |
| <code><a href="#@cdktn/provider-cloudflare.workersScript.WorkersScriptConfig.property.count">count</a></code> | <code>number \| cdktn.TerraformCount</code> | *No description.* |
| <code><a href="#@cdktn/provider-cloudflare.workersScript.WorkersScriptConfig.property.dependsOn">dependsOn</a></code> | <code>cdktn.ITerraformDependable[]</code> | *No description.* |
| <code><a href="#@cdktn/provider-cloudflare.workersScript.WorkersScriptConfig.property.forEach">forEach</a></code> | <code>cdktn.ITerraformIterator</code> | *No description.* |
| <code><a href="#@cdktn/provider-cloudflare.workersScript.WorkersScriptConfig.property.lifecycle">lifecycle</a></code> | <code>cdktn.TerraformResourceLifecycle</code> | *No description.* |
| <code><a href="#@cdktn/provider-cloudflare.workersScript.WorkersScriptConfig.property.provider">provider</a></code> | <code>cdktn.TerraformProvider</code> | *No description.* |
| <code><a href="#@cdktn/provider-cloudflare.workersScript.WorkersScriptConfig.property.provisioners">provisioners</a></code> | <code>cdktn.FileProvisioner \| cdktn.LocalExecProvisioner \| cdktn.RemoteExecProvisioner[]</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-cloudflare.workersScript.WorkersScriptConfig.property.keepAssets">keepAssets</a></code> | <code>boolean \| cdktn.IResolvable</code> | Retain assets which exist for a previously uploaded Worker version; |
...
| <code><a href="#@cdktn/provider-cloudflare.workersScript.WorkersScriptConfig.property.logpush">logpush</a></code> | <code>boolean \| cdktn.IResolvable</code> | Whether Logpush is turned on for the Worker. |
...
```typescript
public readonly annotations: WorkersScriptAnnotations;
```
...
```typescript
public readonly assets: WorkersScriptAssets;
```
...
```typescript
public readonly bindings: IResolvable | WorkersScriptBindings[];
```
...
```typescript
public readonly cacheOptions: WorkersScriptCacheOptions;
```
...
```typescript
public readonly exports: IResolvable | {[ key: string ]: WorkersScriptExports};
```
...
```typescript
public readonly files: IResolvable | {[ key: string ]: WorkersScriptFiles};
```
...
```typescript
public readonly limits: WorkersScriptLimits;
```
...
```typescript
public readonly migrations: WorkersScriptMigrations;
```
...
```typescript
public readonly observability: WorkersScriptObservability;
```
...
```typescript
public readonly packageDependencies: IResolvable | WorkersScriptPackageDependencies[];
```
...
```typescript
public readonly placement: WorkersScriptPlacement;
```
...
```typescript
public readonly tailConsumers: IResolvable | WorkersScriptTailConsumers[];
```
...
const workersScriptExports: workersScript.WorkersScriptExports = { ... }
```
...
| **Name** | **Type** | **Description** |
| --- | --- | --- |
| <code><a href="#@cdktn/provider-cloudflare.workersScript.WorkersScriptExports.property.type">type</a></code> | <code>string</code> | The kind of entrypoint. A `type: worker` entry overrides the top-level `cache_options` for this specific entrypoint. |
...
```typescript
public readonly cache: WorkersScriptExportsCache;
```
...
const workersScriptExportsCache: workersScript.WorkersScriptExportsCache = { ... }
```
...
| **Name** | **Type** | **Description** |
| --- | --- | --- |
| <code><a href="#@cdktn/provider-cloudflare.workersScript.WorkersScriptExportsCache.property.enabled">enabled</a></code> | <code>boolean \| cdktn.IResolvable</code> | Whether caching is enabled for this entrypoint. |
...
const workersScriptFiles: workersScript.WorkersScriptFiles = { ... }
```
...
| **Name** | **Type** | **Description** |
| --- | --- | --- |
| <code><a href="#@cdktn/provider-cloudflare.workersScript.WorkersScriptFiles.property.contentType">contentType</a></code> | <code>string</code> | Content type of the file, such as `application/wasm`, `text/plain`, or `application/octet-stream`. |
| <code><a href="#@cdktn/provider-cloudflare.workersScript.WorkersScriptFiles.property.contentBase64">contentBase64</a></code> | <code>string</code> | Base64-encoded file content. |
| <code><a href="#@cdktn/provider-cloudflare.workersScript.WorkersScriptFiles.property.contentFile">contentFile</a></code> | <code>string</code> | Path to the file content. |
...
const workersScriptLimits: workersScript.WorkersScriptLimits = { ... }
```
...
| **Name** | **Type** | **Description** |
| --- | --- | --- |
| <code><a href="#@cdktn/provider-cloudflare.workersScript.WorkersScriptLimits.property.cpuMs">cpuMs</a></code> | <code>number</code> | The amount of CPU time this Worker can use in milliseconds. |
| <code><a href="#@cdktn/provider-cloudflare.workersScript.WorkersScriptLimits.property.subrequests">subrequests</a></code> | <code>number</code> | The number of subrequests this Worker can make per request. |
...
const workersScriptMigrations: workersScript.WorkersScriptMigrations = { ... }
```
...
| <code><a href="#@cdktn/provider-cloudflare.workersScript.WorkersScriptMigrations.property.steps">steps</a></code> | <code>cdktn.IResolvable \| <a href="#@cdktn/provider-cloudflare.workersScript.WorkersScriptMigrationsSteps">WorkersScriptMigrationsSteps</a>[]</code> | Migrations to apply in order. |
...
```typescript
public readonly renamedClasses: IResolvable | WorkersScriptMigrationsRenamedClasses[];
```

- *Type:* cdktn.IResolvable | <a href="#@cdktn/provider-cloudflare.workersScript.WorkersScriptMigrationsRenamedClasses">WorkersScriptMigrationsRenamedClasses</a>[]
...
```typescript
public readonly steps: IResolvable | WorkersScriptMigrationsSteps[];
```

- *Type:* cdktn.IResolvable | <a href="#@cdktn/provider-cloudflare.workersScript.WorkersScriptMigrationsSteps">WorkersScriptMigrationsSteps</a>[]
...
```typescript
public readonly transferredClasses: IResolvable | WorkersScriptMigrationsTransferredClasses[];
```

- *Type:* cdktn.IResolvable | <a href="#@cdktn/provider-cloudflare.workersScript.WorkersScriptMigrationsTransferredClasses">WorkersScriptMigrationsTransferredClasses</a>[]
...
const workersScriptMigrationsRenamedClasses: workersScript.WorkersScriptMigrationsRenamedClasses = { ... }
```
...
const workersScriptMigrationsSteps: workersScript.WorkersScriptMigrationsSteps = { ... }
```
...
```typescript
public readonly renamedClasses: IResolvable | WorkersScriptMigrationsStepsRenamedClasses[];
```

- *Type:* cdktn.IResolvable | <a href="#@cdktn/provider-cloudflare.workersScript.WorkersScriptMigrationsStepsRenamedClasses">WorkersScriptMigrationsStepsRenamedClasses</a>[]
...
```typescript
public readonly transferredClasses: IResolvable | WorkersScriptMigrationsStepsTransferredClasses[];
```

- *Type:* cdktn.IResolvable | <a href="#@cdktn/provider-cloudflare.workersScript.WorkersScriptMigrationsStepsTransferredClasses">WorkersScriptMigrationsStepsTransferredClasses</a>[]
...
const workersScriptMigrationsStepsRenamedClasses: workersScript.WorkersScriptMigrationsStepsRenamedClasses = { ... }
```
...
const workersScriptMigrationsStepsTransferredClasses: workersScript.WorkersScriptMigrationsStepsTransferredClasses = { ... }
```
...
const workersScriptMigrationsTransferredClasses: workersScript.WorkersScriptMigrationsTransferredClasses = { ... }
```
...
const workersScriptNamedHandlers: workersScript.WorkersScriptNamedHandlers = { ... }
```
...
const workersScriptObservability: workersScript.WorkersScriptObservability = { ... }
```
...
| **Name** | **Type** | **Description** |
| --- | --- | --- |
| <code><a href="#@cdktn/provider-cloudflare.workersScript.WorkersScriptObservability.property.enabled">enabled</a></code> | <code>boolean \| cdktn.IResolvable</code> | Whether observability is enabled for the Worker. |
| <code><a href="#@cdktn/provider-cloudflare.workersScript.WorkersScriptObservability.property.headSamplingRate">headSamplingRate</a></code> | <code>number</code> | The sampling rate for incoming requests. From 0 to 1 (1 = 100%, 0.1 = 10%). Default is 1. |
...
```typescript
public readonly logs: WorkersScriptObservabilityLogs;
```
...
```typescript
public readonly traces: WorkersScriptObservabilityTraces;
```
...
const workersScriptObservabilityLogs: workersScript.WorkersScriptObservabilityLogs = { ... }
```
...
| **Name** | **Type** | **Description** |
| --- | --- | --- |
| <code><a href="#@cdktn/provider-cloudflare.workersScript.WorkersScriptObservabilityLogs.property.enabled">enabled</a></code> | <code>boolean \| cdktn.IResolvable</code> | Whether logs are enabled for the Worker. |
...
| <code><a href="#@cdktn/provider-cloudflare.workersScript.WorkersScriptObservabilityLogs.property.headSamplingRate">headSamplingRate</a></code> | <code>number</code> | The sampling rate for logs. From 0 to 1 (1 = 100%, 0.1 = 10%). Default is 1. |
| <code><a href="#@cdktn/provider-cloudflare.workersScript.WorkersScriptObservabilityLogs.property.persist">persist</a></code> | <code>boolean \| cdktn.IResolvable</code> | Whether log persistence is enabled for the Worker. |
...
const workersScriptObservabilityTraces: workersScript.WorkersScriptObservabilityTraces = { ... }
```
...
| <code><a href="#@cdktn/provider-cloudflare.workersScript.WorkersScriptObservabilityTraces.property.enabled">enabled</a></code> | <code>boolean \| cdktn.IResolvable</code> | Whether traces are enabled for the Worker. |
| <code><a href="#@cdktn/provider-cloudflare.workersScript.WorkersScriptObservabilityTraces.property.headSamplingRate">headSamplingRate</a></code> | <code>number</code> | The sampling rate for traces. From 0 to 1 (1 = 100%, 0.1 = 10%). Default is 1. |
| <code><a href="#@cdktn/provider-cloudflare.workersScript.WorkersScriptObservabilityTraces.property.persist">persist</a></code> | <code>boolean \| cdktn.IResolvable</code> | Whether trace persistence is enabled for the Worker. |
| <code><a href="#@cdktn/provider-cloudflare.workersScript.WorkersScriptObservabilityTraces.property.propagationPolicy">propagationPolicy</a></code> | <code>string</code> | Controls how inbound trace context (traceparent/tracestate) headers on incoming requests are handled. |
...
const workersScriptPackageDependencies: workersScript.WorkersScriptPackageDependencies = { ... }
```
...
| **Name** | **Type** | **Description** |
| --- | --- | --- |
| <code><a href="#@cdktn/provider-cloudflare.workersScript.WorkersScriptPackageDependencies.property.installedVersion">installedVersion</a></code> | <code>string</code> | The exact version that was resolved and installed by the package manager. |
| <code><a href="#@cdktn/provider-cloudflare.workersScript.WorkersScriptPackageDependencies.property.name">name</a></code> | <code>string</code> | The npm package name. |
| <code><a href="#@cdktn/provider-cloudflare.workersScript.WorkersScriptPackageDependencies.property.packageJsonVersion">packageJsonVersion</a></code> | <code>string</code> | The version constraint as written in package.json. |
...
const workersScriptPlacementTarget: workersScript.WorkersScriptPlacementTarget = { ... }
```
...
const workersScriptTailConsumers: workersScript.WorkersScriptTailConsumers = { ... }
```
...
new workersScript.WorkersScriptAnnotationsOutputReference(terraformResource: IInterpolatingParent, terraformAttribute: string)
```

| **Name** | **Type** | **Description** |
| --- | --- | --- |
| <code><a href="#@cdktn/provider-cloudflare.workersScript.WorkersScriptAnnotationsOutputReference.Initializer.parameter.terraformResource">terraformResource</a></code> | <code>cdktn.IInterpolatingParent</code> | The parent resource. |
...
| <code><a href="#@cdktn/provider-cloudflare.workersScript.WorkersScriptAnnotationsOutputReference.property.internalValue">internalValue</a></code> | <code>cdktn.IResolvable \| <a href="#@cdktn/provider-cloudflare.workersScript.WorkersScriptAnnotations">WorkersScriptAnnotations</a></code> | *No description.* |
...
```typescript
public readonly internalValue: IResolvable | WorkersScriptAnnotations;
```
...
new workersScript.WorkersScriptAssetsConfigOutputReference(terraformResource: IInterpolatingParent, terraformAttribute: string)
```

| **Name** | **Type** | **Description** |
| --- | --- | --- |
| <code><a href="#@cdktn/provider-cloudflare.workersScript.WorkersScriptAssetsConfigOutputReference.Initializer.parameter.terraformResource">terraformResource</a></code> | <code>cdktn.IInterpolatingParent</code> | The parent resource. |
...
```typescript
public resetServeDirectly(): void
```
...
| <code><a href="#@cdktn/provider-cloudflare.workersScript.WorkersScriptAssetsConfigOutputReference.property.runWorkerFirstInput">runWorkerFirstInput</a></code> | <code>{[ key: string ]: any}</code> | *No description.* |
| <code><a href="#@cdktn/provider-cloudflare.workersScript.WorkersScriptAssetsConfigOutputReference.property.serveDirectlyInput">serveDirectlyInput</a></code> | <code>boolean \| cdktn.IResolvable</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-cloudflare.workersScript.WorkersScriptAssetsConfigOutputReference.property.runWorkerFirst">runWorkerFirst</a></code> | <code>{[ key: string ]: any}</code> | *No description.* |
| <code><a href="#@cdktn/provider-cloudflare.workersScript.WorkersScriptAssetsConfigOutputReference.property.serveDirectly">serveDirectly</a></code> | <code>boolean \| cdktn.IResolvable</code> | *No description.* |
| <code><a href="#@cdktn/provider-cloudflare.workersScript.WorkersScriptAssetsConfigOutputReference.property.internalValue">internalValue</a></code> | <code>cdktn.IResolvable \| <a href="#@cdktn/provider-cloudflare.workersScript.WorkersScriptAssetsConfig">WorkersScriptAssetsConfig</a></code> | *No description.* |
...
```typescript
public readonly redirectsInput: string;
```
...
```typescript
public readonly runWorkerFirstInput: {[ key: string ]: any};
```
...
```typescript
public readonly serveDirectlyInput: boolean | IResolvable;
```
...
```typescript
public readonly internalValue: IResolvable | WorkersScriptAssetsConfig;
```

- *Type:* cdktn.IResolvable | <a href="#@cdktn/provider-cloudflare.workersScript.WorkersScriptAssetsConfig">WorkersScriptAssetsConfig</a>
...
new workersScript.WorkersScriptAssetsOutputReference(terraformResource: IInterpolatingParent, terraformAttribute: string)
```

| **Name** | **Type** | **Description** |
| --- | --- | --- |
| <code><a href="#@cdktn/provider-cloudflare.workersScript.WorkersScriptAssetsOutputReference.Initializer.parameter.terraformResource">terraformResource</a></code> | <code>cdktn.IInterpolatingParent</code> | The parent resource. |
...
```typescript
public putConfig(value: WorkersScriptAssetsConfig): void
```
...
| <code><a href="#@cdktn/provider-cloudflare.workersScript.WorkersScriptAssetsOutputReference.property.configInput">configInput</a></code> | <code>cdktn.IResolvable \| <a href="#@cdktn/provider-cloudflare.workersScript.WorkersScriptAssetsConfig">WorkersScriptAssetsConfig</a></code> | *No description.* |
...
| <code><a href="#@cdktn/provider-cloudflare.workersScript.WorkersScriptAssetsOutputReference.property.internalValue">internalValue</a></code> | <code>cdktn.IResolvable \| <a href="#@cdktn/provider-cloudflare.workersScript.WorkersScriptAssets">WorkersScriptAssets</a></code> | *No description.* |
...
```typescript
public readonly config: WorkersScriptAssetsConfigOutputReference;
```
...
```typescript
public readonly configInput: IResolvable | WorkersScriptAssetsConfig;
```
...
```typescript
public readonly internalValue: IResolvable | WorkersScriptAssets;
```
...
new workersScript.WorkersScriptBindingsList(terraformResource: IInterpolatingParent, terraformAttribute: string, wrapsSet: boolean)
```

| **Name** | **Type** | **Description** |
| --- | --- | --- |
| <code><a href="#@cdktn/provider-cloudflare.workersScript.WorkersScriptBindingsList.Initializer.parameter.terraformResource">terraformResource</a></code> | <code>cdktn.IInterpolatingParent</code> | The parent resource. |
...
| <code><a href="#@cdktn/provider-cloudflare.workersScript.WorkersScriptBindingsList.Initializer.parameter.wrapsSet">wrapsSet</a></code> | <code>boolean</code> | whether the list is wrapping a set (will add tolist() to be able to access an item via an index). |
...
| <code><a href="#@cdktn/provider-cloudflare.workersScript.WorkersScriptBindingsList.property.internalValue">internalValue</a></code> | <code>cdktn.IResolvable \| <a href="#@cdktn/provider-cloudflare.workersScript.WorkersScriptBindings">WorkersScriptBindings</a>[]</code> | *No description.* |
...
```typescript
public readonly internalValue: IResolvable | WorkersScriptBindings[];
```
...
new workersScript.WorkersScriptBindingsOutboundOutputReference(terraformResource: IInterpolatingParent, terraformAttribute: string)
```

| **Name** | **Type** | **Description** |
| --- | --- | --- |
| <code><a href="#@cdktn/provider-cloudflare.workersScript.WorkersScriptBindingsOutboundOutputReference.Initializer.parameter.terraformResource">terraformResource</a></code> | <code>cdktn.IInterpolatingParent</code> | The parent resource. |
...
```typescript
public putWorker(value: WorkersScriptBindingsOutboundWorker): void
```
...
| <code><a href="#@cdktn/provider-cloudflare.workersScript.WorkersScriptBindingsOutboundOutputReference.property.workerInput">workerInput</a></code> | <code>cdktn.IResolvable \| <a href="#@cdktn/provider-cloudflare.workersScript.WorkersScriptBindingsOutboundWorker">WorkersScriptBindingsOutboundWorker</a></code> | *No description.* |
...
| <code><a href="#@cdktn/provider-cloudflare.workersScript.WorkersScriptBindingsOutboundOutputReference.property.internalValue">internalValue</a></code> | <code>cdktn.IResolvable \| <a href="#@cdktn/provider-cloudflare.workersScript.WorkersScriptBindingsOutbound">WorkersScriptBindingsOutbound</a></code> | *No description.* |
...
```typescript
public readonly worker: WorkersScriptBindingsOutboundWorkerOutputReference;
```
...
```typescript
public readonly workerInput: IResolvable | WorkersScriptBindingsOutboundWorker;
```

- *Type:* cdktn.IResolvable | <a href="#@cdktn/provider-cloudflare.workersScript.WorkersScriptBindingsOutboundWorker">WorkersScriptBindingsOutboundWorker</a>
...
```typescript
public readonly internalValue: IResolvable | WorkersScriptBindingsOutbound;
```

- *Type:* cdktn.IResolvable | <a href="#@cdktn/provider-cloudflare.workersScript.WorkersScriptBindingsOutbound">WorkersScriptBindingsOutbound</a>
...
new workersScript.WorkersScriptBindingsOutboundWorkerOutputReference(terraformResource: IInterpolatingParent, terraformAttribute: string)
```

| **Name** | **Type** | **Description** |
| --- | --- | --- |
| <code><a href="#@cdktn/provider-cloudflare.workersScript.WorkersScriptBindingsOutboundWorkerOutputReference.Initializer.parameter.terraformResource">terraformResource</a></code> | <code>cdktn.IInterpolatingParent</code> | The parent resource. |
...
```typescript
public readonly internalValue: IResolvable | WorkersScriptBindingsOutboundWorker;
```
...
new workersScript.WorkersScriptBindingsOutputReference(terraformResource: IInterpolatingParent, terraformAttribute: string, complexObjectIndex: number, complexObjectIsFromSet: boolean)
```

| **Name** | **Type** | **Description** |
| --- | --- | --- |
| <code><a href="#@cdktn/provider-cloudflare.workersScript.WorkersScriptBindingsOutputReference.Initializer.parameter.terraformResource">terraformResource</a></code> | <code>cdktn.IInterpolatingParent</code> | The parent resource. |
...
| <code><a href="#@cdktn/provider-cloudflare.workersScript.WorkersScriptBindingsOutputReference.Initializer.parameter.complexObjectIndex">complexObjectIndex</a></code> | <code>number</code> | the index of this item in the list. |
| <code><a href="#@cdktn/provider-cloudflare.workersScript.WorkersScriptBindingsOutputReference.Initializer.parameter.complexObjectIsFromSet">complexObjectIsFromSet</a></code> | <code>boolean</code> | whether the list is wrapping a set (will add tolist() to be able to access an item via an index). |
...
```typescript
public putOutbound(value: WorkersScriptBindingsOutbound): void
```
...
```typescript
public putSimple(value: WorkersScriptBindingsSimple): void
```
...
| <code><a href="#@cdktn/provider-cloudflare.workersScript.WorkersScriptBindingsOutputReference.property.outboundInput">outboundInput</a></code> | <code>cdktn.IResolvable \| <a href="#@cdktn/provider-cloudflare.workersScript.WorkersScriptBindingsOutbound">WorkersScriptBindingsOutbound</a></code> | *No description.* |
...
| <code><a href="#@cdktn/provider-cloudflare.workersScript.WorkersScriptBindingsOutputReference.property.simpleInput">simpleInput</a></code> | <code>cdktn.IResolvable \| <a href="#@cdktn/provider-cloudflare.workersScript.WorkersScriptBindingsSimple">WorkersScriptBindingsSimple</a></code> | *No description.* |
...
| <code><a href="#@cdktn/provider-cloudflare.workersScript.WorkersScriptBindingsOutputReference.property.internalValue">internalValue</a></code> | <code>cdktn.IResolvable \| <a href="#@cdktn/provider-cloudflare.workersScript.WorkersScriptBindings">WorkersScriptBindings</a></code> | *No description.* |
...
```typescript
public readonly outbound: WorkersScriptBindingsOutboundOutputReference;
```
...
```typescript
public readonly simple: WorkersScriptBindingsSimpleOutputReference;
```
...
```typescript
public readonly outboundInput: IResolvable | WorkersScriptBindingsOutbound;
```
...
```typescript
public readonly simpleInput: IResolvable | WorkersScriptBindingsSimple;
```

- *Type:* cdktn.IResolvable | <a href="#@cdktn/provider-cloudflare.workersScript.WorkersScriptBindingsSimple">WorkersScriptBindingsSimple</a>
...
new workersScript.WorkersScriptBindingsSimpleOutputReference(terraformResource: IInterpolatingParent, terraformAttribute: string)
```

| **Name** | **Type** | **Description** |
| --- | --- | --- |
| <code><a href="#@cdktn/provider-cloudflare.workersScript.WorkersScriptBindingsSimpleOutputReference.Initializer.parameter.terraformResource">terraformResource</a></code> | <code>cdktn.IInterpolatingParent</code> | The parent resource. |
...
| <code><a href="#@cdktn/provider-cloudflare.workersScript.WorkersScriptBindingsSimpleOutputReference.property.limitInput">limitInput</a></code> | <code>number</code> | *No description.* |
| <code><a href="#@cdktn/provider-cloudflare.workersScript.WorkersScriptBindingsSimpleOutputReference.property.mitigationTimeoutInput">mitigationTimeoutInput</a></code> | <code>number</code> | *No description.* |
| <code><a href="#@cdktn/provider-cloudflare.workersScript.WorkersScriptBindingsSimpleOutputReference.property.periodInput">periodInput</a></code> | <code>number</code> | *No description.* |
| <code><a href="#@cdktn/provider-cloudflare.workersScript.WorkersScriptBindingsSimpleOutputReference.property.limit">limit</a></code> | <code>number</code> | *No description.* |
| <code><a href="#@cdktn/provider-cloudflare.workersScript.WorkersScriptBindingsSimpleOutputReference.property.mitigationTimeout">mitigationTimeout</a></code> | <code>number</code> | *No description.* |
| <code><a href="#@cdktn/provider-cloudflare.workersScript.WorkersScriptBindingsSimpleOutputReference.property.period">period</a></code> | <code>number</code> | *No description.* |
| <code><a href="#@cdktn/provider-cloudflare.workersScript.WorkersScriptBindingsSimpleOutputReference.property.internalValue">internalValue</a></code> | <code>cdktn.IResolvable \| <a href="#@cdktn/provider-cloudflare.workersScript.WorkersScriptBindingsSimple">WorkersScriptBindingsSimple</a></code> | *No description.* |
...
```typescript
public readonly internalValue: IResolvable | WorkersScriptBindingsSimple;
```
...
new workersScript.WorkersScriptCacheOptionsOutputReference(terraformResource: IInterpolatingParent, terraformAttribute: string)
```

| **Name** | **Type** | **Description** |
| --- | --- | --- |
| <code><a href="#@cdktn/provider-cloudflare.workersScript.WorkersScriptCacheOptionsOutputReference.Initializer.parameter.terraformResource">terraformResource</a></code> | <code>cdktn.IInterpolatingParent</code> | The parent resource. |
| <code><a href="#@cdktn/provider-cloudflare.workersScript.WorkersScriptCacheOptionsOutputReference.Initializer.parameter.terraformAttribute">terraformAttribute</a></code> | <code>string</code> | The attribute on the parent resource this class is referencing. |
...
| **Name** | **Type** | **Description** |
| --- | --- | --- |
| <code><a href="#@cdktn/provider-cloudflare.workersScript.WorkersScriptCacheOptionsOutputReference.property.creationStack">creationStack</a></code> | <code>string[]</code> | The creation stack of this resolvable which will be appended to errors thrown during resolution. |
| <code><a href="#@cdktn/provider-cloudflare.workersScript.WorkersScriptCacheOptionsOutputReference.property.fqn">fqn</a></code> | <code>string</code> | *No description.* |
| <code><a href="#@cdktn/provider-cloudflare.workersScript.WorkersScriptCacheOptionsOutputReference.property.crossVersionCacheInput">crossVersionCacheInput</a></code> | <code>boolean \| cdktn.IResolvable</code> | *No description.* |
| <code><a href="#@cdktn/provider-cloudflare.workersScript.WorkersScriptCacheOptionsOutputReference.property.enabledInput">enabledInput</a></code> | <code>boolean \| cdktn.IResolvable</code> | *No description.* |
| <code><a href="#@cdktn/provider-cloudflare.workersScript.WorkersScriptCacheOptionsOutputReference.property.crossVersionCache">crossVersionCache</a></code> | <code>boolean \| cdktn.IResolvable</code> | *No description.* |
| <code><a href="#@cdktn/provider-cloudflare.workersScript.WorkersScriptCacheOptionsOutputReference.property.enabled">enabled</a></code> | <code>boolean \| cdktn.IResolvable</code> | *No description.* |
| <code><a href="#@cdktn/provider-cloudflare.workersScript.WorkersScriptCacheOptionsOutputReference.property.internalValue">internalValue</a></code> | <code>cdktn.IResolvable \| <a href="#@cdktn/provider-cloudflare.workersScript.WorkersScriptCacheOptions">WorkersScriptCacheOptions</a></code> | *No description.* |
...
```typescript
public readonly internalValue: IResolvable | WorkersScriptCacheOptions;
```
...
new workersScript.WorkersScriptExportsCacheOutputReference(terraformResource: IInterpolatingParent, terraformAttribute: string)
```

| **Name** | **Type** | **Description** |
| --- | --- | --- |
| <code><a href="#@cdktn/provider-cloudflare.workersScript.WorkersScriptExportsCacheOutputReference.Initializer.parameter.terraformResource">terraformResource</a></code> | <code>cdktn.IInterpolatingParent</code> | The parent resource. |
| <code><a href="#@cdktn/provider-cloudflare.workersScript.WorkersScriptExportsCacheOutputReference.Initializer.parameter.terraformAttribute">terraformAttribute</a></code> | <code>string</code> | The attribute on the parent resource this class is referencing. |
...
| **Name** | **Type** | **Description** |
| --- | --- | --- |
| <code><a href="#@cdktn/provider-cloudflare.workersScript.WorkersScriptExportsCacheOutputReference.property.creationStack">creationStack</a></code> | <code>string[]</code> | The creation stack of this resolvable which will be appended to errors thrown during resolution. |
| <code><a href="#@cdktn/provider-cloudflare.workersScript.WorkersScriptExportsCacheOutputReference.property.fqn">fqn</a></code> | <code>string</code> | *No description.* |
| <code><a href="#@cdktn/provider-cloudflare.workersScript.WorkersScriptExportsCacheOutputReference.property.enabledInput">enabledInput</a></code> | <code>boolean \| cdktn.IResolvable</code> | *No description.* |
| <code><a href="#@cdktn/provider-cloudflare.workersScript.WorkersScriptExportsCacheOutputReference.property.enabled">enabled</a></code> | <code>boolean \| cdktn.IResolvable</code> | *No description.* |
| <code><a href="#@cdktn/provider-cloudflare.workersScript.WorkersScriptExportsCacheOutputReference.property.internalValue">internalValue</a></code> | <code>cdktn.IResolvable \| <a href="#@cdktn/provider-cloudflare.workersScript.WorkersScriptExportsCache">WorkersScriptExportsCache</a></code> | *No description.* |
...
```typescript
public readonly internalValue: IResolvable | WorkersScriptExportsCache;
```

- *Type:* cdktn.IResolvable | <a href="#@cdktn/provider-cloudflare.workersScript.WorkersScriptExportsCache">WorkersScriptExportsCache</a>
...
new workersScript.WorkersScriptExportsMap(terraformResource: IInterpolatingParent, terraformAttribute: string)
```

| **Name** | **Type** | **Description** |
| --- | --- | --- |
| <code><a href="#@cdktn/provider-cloudflare.workersScript.WorkersScriptExportsMap.Initializer.parameter.terraformResource">terraformResource</a></code> | <code>cdktn.IInterpolatingParent</code> | The parent resource. |
| <code><a href="#@cdktn/provider-cloudflare.workersScript.WorkersScriptExportsMap.Initializer.parameter.terraformAttribute">terraformAttribute</a></code> | <code>string</code> | The attribute on the parent resource this class is referencing. |
...
```typescript
public get(key: string): WorkersScriptExportsOutputReference
```
...
| **Name** | **Type** | **Description** |
| --- | --- | --- |
| <code><a href="#@cdktn/provider-cloudflare.workersScript.WorkersScriptExportsMap.property.creationStack">creationStack</a></code> | <code>string[]</code> | The creation stack of this resolvable which will be appended to errors thrown during resolution. |
| <code><a href="#@cdktn/provider-cloudflare.workersScript.WorkersScriptExportsMap.property.fqn">fqn</a></code> | <code>string</code> | *No description.* |
| <code><a href="#@cdktn/provider-cloudflare.workersScript.WorkersScriptExportsMap.property.internalValue">internalValue</a></code> | <code>cdktn.IResolvable \| {[ key: string ]: <a href="#@cdktn/provider-cloudflare.workersScript.WorkersScriptExports">WorkersScriptExports</a>}</code> | *No description.* |
...
```typescript
public readonly internalValue: IResolvable | {[ key: string ]: WorkersScriptExports};
```
...
new workersScript.WorkersScriptExportsOutputReference(terraformResource: IInterpolatingParent, terraformAttribute: string, complexObjectKey: string)
```

| **Name** | **Type** | **Description** |
| --- | --- | --- |
| <code><a href="#@cdktn/provider-cloudflare.workersScript.WorkersScriptExportsOutputReference.Initializer.parameter.terraformResource">terraformResource</a></code> | <code>cdktn.IInterpolatingParent</code> | The parent resource. |
| <code><a href="#@cdktn/provider-cloudflare.workersScript.WorkersScriptExportsOutputReference.Initializer.parameter.terraformAttribute">terraformAttribute</a></code> | <code>string</code> | The attribute on the parent resource this class is referencing. |
| <code><a href="#@cdktn/provider-cloudflare.workersScript.WorkersScriptExportsOutputReference.Initializer.parameter.complexObjectKey">complexObjectKey</a></code> | <code>string</code> | the key of this item in the map. |
...
```typescript
public putCache(value: WorkersScriptExportsCache): void
```
...
| **Name** | **Type** | **Description** |
| --- | --- | --- |
| <code><a href="#@cdktn/provider-cloudflare.workersScript.WorkersScriptExportsOutputReference.property.creationStack">creationStack</a></code> | <code>string[]</code> | The creation stack of this resolvable which will be appended to errors thrown during resolution. |
| <code><a href="#@cdktn/provider-cloudflare.workersScript.WorkersScriptExportsOutputReference.property.fqn">fqn</a></code> | <code>string</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-cloudflare.workersScript.WorkersScriptExportsOutputReference.property.cacheInput">cacheInput</a></code> | <code>cdktn.IResolvable \| <a href="#@cdktn/provider-cloudflare.workersScript.WorkersScriptExportsCache">WorkersScriptExportsCache</a></code> | *No description.* |
| <code><a href="#@cdktn/provider-cloudflare.workersScript.WorkersScriptExportsOutputReference.property.typeInput">typeInput</a></code> | <code>string</code> | *No description.* |
| <code><a href="#@cdktn/provider-cloudflare.workersScript.WorkersScriptExportsOutputReference.property.type">type</a></code> | <code>string</code> | *No description.* |
| <code><a href="#@cdktn/provider-cloudflare.workersScript.WorkersScriptExportsOutputReference.property.internalValue">internalValue</a></code> | <code>cdktn.IResolvable \| <a href="#@cdktn/provider-cloudflare.workersScript.WorkersScriptExports">WorkersScriptExports</a></code> | *No description.* |
...
```typescript
public readonly cache: WorkersScriptExportsCacheOutputReference;
```
...
```typescript
public readonly cacheInput: IResolvable | WorkersScriptExportsCache;
```
...
```typescript
public readonly internalValue: IResolvable | WorkersScriptExports;
```

- *Type:* cdktn.IResolvable | <a href="#@cdktn/provider-cloudflare.workersScript.WorkersScriptExports">WorkersScriptExports</a>
...
new workersScript.WorkersScriptFilesMap(terraformResource: IInterpolatingParent, terraformAttribute: string)
```

| **Name** | **Type** | **Description** |
| --- | --- | --- |
| <code><a href="#@cdktn/provider-cloudflare.workersScript.WorkersScriptFilesMap.Initializer.parameter.terraformResource">terraformResource</a></code> | <code>cdktn.IInterpolatingParent</code> | The parent resource. |
| <code><a href="#@cdktn/provider-cloudflare.workersScript.WorkersScriptFilesMap.Initializer.parameter.terraformAttribute">terraformAttribute</a></code> | <code>string</code> | The attribute on the parent resource this class is referencing. |
...
```typescript
public get(key: string): WorkersScriptFilesOutputReference
```
...
| **Name** | **Type** | **Description** |
| --- | --- | --- |
| <code><a href="#@cdktn/provider-cloudflare.workersScript.WorkersScriptFilesMap.property.creationStack">creationStack</a></code> | <code>string[]</code> | The creation stack of this resolvable which will be appended to errors thrown during resolution. |
| <code><a href="#@cdktn/provider-cloudflare.workersScript.WorkersScriptFilesMap.property.fqn">fqn</a></code> | <code>string</code> | *No description.* |
| <code><a href="#@cdktn/provider-cloudflare.workersScript.WorkersScriptFilesMap.property.internalValue">internalValue</a></code> | <code>cdktn.IResolvable \| {[ key: string ]: <a href="#@cdktn/provider-cloudflare.workersScript.WorkersScriptFiles">WorkersScriptFiles</a>}</code> | *No description.* |
...
```typescript
public readonly internalValue: IResolvable | {[ key: string ]: WorkersScriptFiles};
```
...
new workersScript.WorkersScriptFilesOutputReference(terraformResource: IInterpolatingParent, terraformAttribute: string, complexObjectKey: string)
```

| **Name** | **Type** | **Description** |
| --- | --- | --- |
| <code><a href="#@cdktn/provider-cloudflare.workersScript.WorkersScriptFilesOutputReference.Initializer.parameter.terraformResource">terraformResource</a></code> | <code>cdktn.IInterpolatingParent</code> | The parent resource. |
| <code><a href="#@cdktn/provider-cloudflare.workersScript.WorkersScriptFilesOutputReference.Initializer.parameter.terraformAttribute">terraformAttribute</a></code> | <code>string</code> | The attribute on the parent resource this class is referencing. |
| <code><a href="#@cdktn/provider-cloudflare.workersScript.WorkersScriptFilesOutputReference.Initializer.parameter.complexObjectKey">complexObjectKey</a></code> | <code>string</code> | the key of this item in the map. |
...
| **Name** | **Type** | **Description** |
| --- | --- | --- |
| <code><a href="#@cdktn/provider-cloudflare.workersScript.WorkersScriptFilesOutputReference.property.creationStack">creationStack</a></code> | <code>string[]</code> | The creation stack of this resolvable which will be appended to errors thrown during resolution. |
| <code><a href="#@cdktn/provider-cloudflare.workersScript.WorkersScriptFilesOutputReference.property.fqn">fqn</a></code> | <code>string</code> | *No description.* |
| <code><a href="#@cdktn/provider-cloudflare.workersScript.WorkersScriptFilesOutputReference.property.contentSha256">contentSha256</a></code> | <code>string</code> | *No description.* |
| <code><a href="#@cdktn/provider-cloudflare.workersScript.WorkersScriptFilesOutputReference.property.contentBase64Input">contentBase64Input</a></code> | <code>string</code> | *No description.* |
| <code><a href="#@cdktn/provider-cloudflare.workersScript.WorkersScriptFilesOutputReference.property.contentFileInput">contentFileInput</a></code> | <code>string</code> | *No description.* |
| <code><a href="#@cdktn/provider-cloudflare.workersScript.WorkersScriptFilesOutputReference.property.contentTypeInput">contentTypeInput</a></code> | <code>string</code> | *No description.* |
| <code><a href="#@cdktn/provider-cloudflare.workersScript.WorkersScriptFilesOutputReference.property.contentBase64">contentBase64</a></code> | <code>string</code> | *No description.* |
| <code><a href="#@cdktn/provider-cloudflare.workersScript.WorkersScriptFilesOutputReference.property.contentFile">contentFile</a></code> | <code>string</code> | *No description.* |
| <code><a href="#@cdktn/provider-cloudflare.workersScript.WorkersScriptFilesOutputReference.property.contentType">contentType</a></code> | <code>string</code> | *No description.* |
| <code><a href="#@cdktn/provider-cloudflare.workersScript.WorkersScriptFilesOutputReference.property.internalValue">internalValue</a></code> | <code>cdktn.IResolvable \| <a href="#@cdktn/provider-cloudflare.workersScript.WorkersScriptFiles">WorkersScriptFiles</a></code> | *No description.* |
...
```typescript
public readonly internalValue: IResolvable | WorkersScriptFiles;
```

- *Type:* cdktn.IResolvable | <a href="#@cdktn/provider-cloudflare.workersScript.WorkersScriptFiles">WorkersScriptFiles</a>
...
new workersScript.WorkersScriptLimitsOutputReference(terraformResource: IInterpolatingParent, terraformAttribute: string)
```

| **Name** | **Type** | **Description** |
| --- | --- | --- |
| <code><a href="#@cdktn/provider-cloudflare.workersScript.WorkersScriptLimitsOutputReference.Initializer.parameter.terraformResource">terraformResource</a></code> | <code>cdktn.IInterpolatingParent</code> | The parent resource. |
...
| <code><a href="#@cdktn/provider-cloudflare.workersScript.WorkersScriptLimitsOutputReference.property.cpuMsInput">cpuMsInput</a></code> | <code>number</code> | *No description.* |
| <code><a href="#@cdktn/provider-cloudflare.workersScript.WorkersScriptLimitsOutputReference.property.subrequestsInput">subrequestsInput</a></code> | <code>number</code> | *No description.* |
| <code><a href="#@cdktn/provider-cloudflare.workersScript.WorkersScriptLimitsOutputReference.property.cpuMs">cpuMs</a></code> | <code>number</code> | *No description.* |
| <code><a href="#@cdktn/provider-cloudflare.workersScript.WorkersScriptLimitsOutputReference.property.subrequests">subrequests</a></code> | <code>number</code> | *No description.* |
| <code><a href="#@cdktn/provider-cloudflare.workersScript.WorkersScriptLimitsOutputReference.property.internalValue">internalValue</a></code> | <code>cdktn.IResolvable \| <a href="#@cdktn/provider-cloudflare.workersScript.WorkersScriptLimits">WorkersScriptLimits</a></code> | *No description.* |
...
```typescript
public readonly internalValue: IResolvable | WorkersScriptLimits;
```
...
new workersScript.WorkersScriptMigrationsOutputReference(terraformResource: IInterpolatingParent, terraformAttribute: string)
```

| **Name** | **Type** | **Description** |
| --- | --- | --- |
| <code><a href="#@cdktn/provider-cloudflare.workersScript.WorkersScriptMigrationsOutputReference.Initializer.parameter.terraformResource">terraformResource</a></code> | <code>cdktn.IInterpolatingParent</code> | The parent resource. |
...
```typescript
public putRenamedClasses(value: IResolvable | WorkersScriptMigrationsRenamedClasses[]): void
```
...
```typescript
public putSteps(value: IResolvable | WorkersScriptMigrationsSteps[]): void
```
...
```typescript
public putTransferredClasses(value: IResolvable | WorkersScriptMigrationsTransferredClasses[]): void
```
...
| <code><a href="#@cdktn/provider-cloudflare.workersScript.WorkersScriptMigrationsOutputReference.property.stepsInput">stepsInput</a></code> | <code>cdktn.IResolvable \| <a href="#@cdktn/provider-cloudflare.workersScript.WorkersScriptMigrationsSteps">WorkersScriptMigrationsSteps</a>[]</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-cloudflare.workersScript.WorkersScriptMigrationsOutputReference.property.internalValue">internalValue</a></code> | <code>cdktn.IResolvable \| <a href="#@cdktn/provider-cloudflare.workersScript.WorkersScriptMigrations">WorkersScriptMigrations</a></code> | *No description.* |
...
```typescript
public readonly renamedClasses: WorkersScriptMigrationsRenamedClassesList;
```
...
```typescript
public readonly steps: WorkersScriptMigrationsStepsList;
```
...
```typescript
public readonly transferredClasses: WorkersScriptMigrationsTransferredClassesList;
```
...
```typescript
public readonly renamedClassesInput: IResolvable | WorkersScriptMigrationsRenamedClasses[];
```
...
```typescript
public readonly stepsInput: IResolvable | WorkersScriptMigrationsSteps[];
```
...
```typescript
public readonly transferredClassesInput: IResolvable | WorkersScriptMigrationsTransferredClasses[];
```
...
```typescript
public readonly internalValue: IResolvable | WorkersScriptMigrations;
```
...
new workersScript.WorkersScriptMigrationsRenamedClassesList(terraformResource: IInterpolatingParent, terraformAttribute: string, wrapsSet: boolean)
```

| **Name** | **Type** | **Description** |
| --- | --- | --- |
| <code><a href="#@cdktn/provider-cloudflare.workersScript.WorkersScriptMigrationsRenamedClassesList.Initializer.parameter.terraformResource">terraformResource</a></code> | <code>cdktn.IInterpolatingParent</code> | The parent resource. |
...
| <code><a href="#@cdktn/provider-cloudflare.workersScript.WorkersScriptMigrationsRenamedClassesList.Initializer.parameter.wrapsSet">wrapsSet</a></code> | <code>boolean</code> | whether the list is wrapping a set (will add tolist() to be able to access an item via an index). |
...
```typescript
public readonly internalValue: IResolvable | WorkersScriptMigrationsRenamedClasses[];
```
...
new workersScript.WorkersScriptMigrationsRenamedClassesOutputReference(terraformResource: IInterpolatingParent, terraformAttribute: string, complexObjectIndex: number, complexObjectIsFromSet: boolean)
```

| **Name** | **Type** | **Description** |
| --- | --- | --- |
| <code><a href="#@cdktn/provider-cloudflare.workersScript.WorkersScriptMigrationsRenamedClassesOutputReference.Initializer.parameter.terraformResource">terraformResource</a></code> | <code>cdktn.IInterpolatingParent</code> | The parent resource. |
...
| <code><a href="#@cdktn/provider-cloudflare.workersScript.WorkersScriptMigrationsRenamedClassesOutputReference.Initializer.parameter.complexObjectIndex">complexObjectIndex</a></code> | <code>number</code> | the index of this item in the list. |
| <code><a href="#@cdktn/provider-cloudflare.workersScript.WorkersScriptMigrationsRenamedClassesOutputReference.Initializer.parameter.complexObjectIsFromSet">complexObjectIsFromSet</a></code> | <code>boolean</code> | whether the list is wrapping a set (will add tolist() to be able to access an item via an index). |
...
new workersScript.WorkersScriptMigrationsStepsList(terraformResource: IInterpolatingParent, terraformAttribute: string, wrapsSet: boolean)
```

| **Name** | **Type** | **Description** |
| --- | --- | --- |
| <code><a href="#@cdktn/provider-cloudflare.workersScript.WorkersScriptMigrationsStepsList.Initializer.parameter.terraformResource">terraformResource</a></code> | <code>cdktn.IInterpolatingParent</code> | The parent resource. |
...
| <code><a href="#@cdktn/provider-cloudflare.workersScript.WorkersScriptMigrationsStepsList.Initializer.parameter.wrapsSet">wrapsSet</a></code> | <code>boolean</code> | whether the list is wrapping a set (will add tolist() to be able to access an item via an index). |
...
| <code><a href="#@cdktn/provider-cloudflare.workersScript.WorkersScriptMigrationsStepsList.property.internalValue">internalValue</a></code> | <code>cdktn.IResolvable \| <a href="#@cdktn/provider-cloudflare.workersScript.WorkersScriptMigrationsSteps">WorkersScriptMigrationsSteps</a>[]</code> | *No description.* |
...
```typescript
public readonly internalValue: IResolvable | WorkersScriptMigrationsSteps[];
```
...
new workersScript.WorkersScriptMigrationsStepsOutputReference(terraformResource: IInterpolatingParent, terraformAttribute: string, complexObjectIndex: number, complexObjectIsFromSet: boolean)
```

| **Name** | **Type** | **Description** |
| --- | --- | --- |
| <code><a href="#@cdktn/provider-cloudflare.workersScript.WorkersScriptMigrationsStepsOutputReference.Initializer.parameter.terraformResource">terraformResource</a></code> | <code>cdktn.IInterpolatingParent</code> | The parent resource. |
...
| <code><a href="#@cdktn/provider-cloudflare.workersScript.WorkersScriptMigrationsStepsOutputReference.Initializer.parameter.complexObjectIndex">complexObjectIndex</a></code> | <code>number</code> | the index of this item in the list. |
| <code><a href="#@cdktn/provider-cloudflare.workersScript.WorkersScriptMigrationsStepsOutputReference.Initializer.parameter.complexObjectIsFromSet">complexObjectIsFromSet</a></code> | <code>boolean</code> | whether the list is wrapping a set (will add tolist() to be able to access an item via an index). |
...
```typescript
public putRenamedClasses(value: IResolvable | WorkersScriptMigrationsStepsRenamedClasses[]): void
```
...
```typescript
public putTransferredClasses(value: IResolvable | WorkersScriptMigrationsStepsTransferredClasses[]): void
```
...
| <code><a href="#@cdktn/provider-cloudflare.workersScript.WorkersScriptMigrationsStepsOutputReference.property.internalValue">internalValue</a></code> | <code>cdktn.IResolvable \| <a href="#@cdktn/provider-cloudflare.workersScript.WorkersScriptMigrationsSteps">WorkersScriptMigrationsSteps</a></code> | *No description.* |
...
```typescript
public readonly renamedClasses: WorkersScriptMigrationsStepsRenamedClassesList;
```
...
```typescript
public readonly transferredClasses: WorkersScriptMigrationsStepsTransferredClassesList;
```
...
```typescript
public readonly renamedClassesInput: IResolvable | WorkersScriptMigrationsStepsRenamedClasses[];
```
...
```typescript
public readonly transferredClassesInput: IResolvable | WorkersScriptMigrationsStepsTransferredClasses[];
```
...
new workersScript.WorkersScriptMigrationsStepsRenamedClassesList(terraformResource: IInterpolatingParent, terraformAttribute: string, wrapsSet: boolean)
```

| **Name** | **Type** | **Description** |
| --- | --- | --- |
| <code><a href="#@cdktn/provider-cloudflare.workersScript.WorkersScriptMigrationsStepsRenamedClassesList.Initializer.parameter.terraformResource">terraformResource</a></code> | <code>cdktn.IInterpolatingParent</code> | The parent resource. |
...
| <code><a href="#@cdktn/provider-cloudflare.workersScript.WorkersScriptMigrationsStepsRenamedClassesList.Initializer.parameter.wrapsSet">wrapsSet</a></code> | <code>boolean</code> | whether the list is wrapping a set (will add tolist() to be able to access an item via an index). |
...
```typescript
public readonly internalValue: IResolvable | WorkersScriptMigrationsStepsRenamedClasses[];
```
...
new workersScript.WorkersScriptMigrationsStepsRenamedClassesOutputReference(terraformResource: IInterpolatingParent, terraformAttribute: string, complexObjectIndex: number, complexObjectIsFromSet: boolean)
```

| **Name** | **Type** | **Description** |
| --- | --- | --- |
| <code><a href="#@cdktn/provider-cloudflare.workersScript.WorkersScriptMigrationsStepsRenamedClassesOutputReference.Initializer.parameter.terraformResource">terraformResource</a></code> | <code>cdktn.IInterpolatingParent</code> | The parent resource. |
...
| <code><a href="#@cdktn/provider-cloudflare.workersScript.WorkersScriptMigrationsStepsRenamedClassesOutputReference.Initializer.parameter.complexObjectIndex">complexObjectIndex</a></code> | <code>number</code> | the index of this item in the list. |
| <code><a href="#@cdktn/provider-cloudflare.workersScript.WorkersScriptMigrationsStepsRenamedClassesOutputReference.Initializer.parameter.complexObjectIsFromSet">complexObjectIsFromSet</a></code> | <code>boolean</code> | whether the list is wrapping a set (will add tolist() to be able to access an item via an index). |
...
new workersScript.WorkersScriptMigrationsStepsTransferredClassesList(terraformResource: IInterpolatingParent, terraformAttribute: string, wrapsSet: boolean)
```

| **Name** | **Type** | **Description** |
| --- | --- | --- |
| <code><a href="#@cdktn/provider-cloudflare.workersScript.WorkersScriptMigrationsStepsTransferredClassesList.Initializer.parameter.terraformResource">terraformResource</a></code> | <code>cdktn.IInterpolatingParent</code> | The parent resource. |
...
| <code><a href="#@cdktn/provider-cloudflare.workersScript.WorkersScriptMigrationsStepsTransferredClassesList.Initializer.parameter.wrapsSet">wrapsSet</a></code> | <code>boolean</code> | whether the list is wrapping a set (will add tolist() to be able to access an item via an index). |
...
```typescript
public readonly internalValue: IResolvable | WorkersScriptMigrationsStepsTransferredClasses[];
```
...
new workersScript.WorkersScriptMigrationsStepsTransferredClassesOutputReference(terraformResource: IInterpolatingParent, terraformAttribute: string, complexObjectIndex: number, complexObjectIsFromSet: boolean)
```

| **Name** | **Type** | **Description** |
| --- | --- | --- |
| <code><a href="#@cdktn/provider-cloudflare.workersScript.WorkersScriptMigrationsStepsTransferredClassesOutputReference.Initializer.parameter.terraformResource">terraformResource</a></code> | <code>cdktn.IInterpolatingParent</code> | The parent resource. |
...
| <code><a href="#@cdktn/provider-cloudflare.workersScript.WorkersScriptMigrationsStepsTransferredClassesOutputReference.Initializer.parameter.complexObjectIndex">complexObjectIndex</a></code> | <code>number</code> | the index of this item in the list. |
| <code><a href="#@cdktn/provider-cloudflare.workersScript.WorkersScriptMigrationsStepsTransferredClassesOutputReference.Initializer.parameter.complexObjectIsFromSet">complexObjectIsFromSet</a></code> | <code>boolean</code> | whether the list is wrapping a set (will add tolist() to be able to access an item via an index). |
...
new workersScript.WorkersScriptMigrationsTransferredClassesList(terraformResource: IInterpolatingParent, terraformAttribute: string, wrapsSet: boolean)
```

| **Name** | **Type** | **Description** |
| --- | --- | --- |
| <code><a href="#@cdktn/provider-cloudflare.workersScript.WorkersScriptMigrationsTransferredClassesList.Initializer.parameter.terraformResource">terraformResource</a></code> | <code>cdktn.IInterpolatingParent</code> | The parent resource. |
...
| <code><a href="#@cdktn/provider-cloudflare.workersScript.WorkersScriptMigrationsTransferredClassesList.Initializer.parameter.wrapsSet">wrapsSet</a></code> | <code>boolean</code> | whether the list is wrapping a set (will add tolist() to be able to access an item via an index). |
...
```typescript
public readonly internalValue: IResolvable | WorkersScriptMigrationsTransferredClasses[];
```
...
new workersScript.WorkersScriptMigrationsTransferredClassesOutputReference(terraformResource: IInterpolatingParent, terraformAttribute: string, complexObjectIndex: number, complexObjectIsFromSet: boolean)
```

| **Name** | **Type** | **Description** |
| --- | --- | --- |
| <code><a href="#@cdktn/provider-cloudflare.workersScript.WorkersScriptMigrationsTransferredClassesOutputReference.Initializer.parameter.terraformResource">terraformResource</a></code> | <code>cdktn.IInterpolatingParent</code> | The parent resource. |
...
| <code><a href="#@cdktn/provider-cloudflare.workersScript.WorkersScriptMigrationsTransferredClassesOutputReference.Initializer.parameter.complexObjectIndex">complexObjectIndex</a></code> | <code>number</code> | the index of this item in the list. |
| <code><a href="#@cdktn/provider-cloudflare.workersScript.WorkersScriptMigrationsTransferredClassesOutputReference.Initializer.parameter.complexObjectIsFromSet">complexObjectIsFromSet</a></code> | <code>boolean</code> | whether the list is wrapping a set (will add tolist() to be able to access an item via an index). |
...
new workersScript.WorkersScriptNamedHandlersList(terraformResource: IInterpolatingParent, terraformAttribute: string, wrapsSet: boolean)
```

| **Name** | **Type** | **Description** |
| --- | --- | --- |
| <code><a href="#@cdktn/provider-cloudflare.workersScript.WorkersScriptNamedHandlersList.Initializer.parameter.terraformResource">terraformResource</a></code> | <code>cdktn.IInterpolatingParent</code> | The parent resource. |
...
| <code><a href="#@cdktn/provider-cloudflare.workersScript.WorkersScriptNamedHandlersList.Initializer.parameter.wrapsSet">wrapsSet</a></code> | <code>boolean</code> | whether the list is wrapping a set (will add tolist() to be able to access an item via an index). |
...
new workersScript.WorkersScriptNamedHandlersOutputReference(terraformResource: IInterpolatingParent, terraformAttribute: string, complexObjectIndex: number, complexObjectIsFromSet: boolean)
```

| **Name** | **Type** | **Description** |
| --- | --- | --- |
| <code><a href="#@cdktn/provider-cloudflare.workersScript.WorkersScriptNamedHandlersOutputReference.Initializer.parameter.terraformResource">terraformResource</a></code> | <code>cdktn.IInterpolatingParent</code> | The parent resource. |
...
| <code><a href="#@cdktn/provider-cloudflare.workersScript.WorkersScriptNamedHandlersOutputReference.Initializer.parameter.complexObjectIndex">complexObjectIndex</a></code> | <code>number</code> | the index of this item in the list. |
| <code><a href="#@cdktn/provider-cloudflare.workersScript.WorkersScriptNamedHandlersOutputReference.Initializer.parameter.complexObjectIsFromSet">complexObjectIsFromSet</a></code> | <code>boolean</code> | whether the list is wrapping a set (will add tolist() to be able to access an item via an index). |
...
```typescript
public readonly internalValue: WorkersScriptNamedHandlers;
```
...
new workersScript.WorkersScriptObservabilityLogsOutputReference(terraformResource: IInterpolatingParent, terraformAttribute: string)
```

| **Name** | **Type** | **Description** |
| --- | --- | --- |
| <code><a href="#@cdktn/provider-cloudflare.workersScript.WorkersScriptObservabilityLogsOutputReference.Initializer.parameter.terraformResource">terraformResource</a></code> | <code>cdktn.IInterpolatingParent</code> | The parent resource. |
...
| <code><a href="#@cdktn/provider-cloudflare.workersScript.WorkersScriptObservabilityLogsOutputReference.property.enabledInput">enabledInput</a></code> | <code>boolean \| cdktn.IResolvable</code> | *No description.* |
| <code><a href="#@cdktn/provider-cloudflare.workersScript.WorkersScriptObservabilityLogsOutputReference.property.headSamplingRateInput">headSamplingRateInput</a></code> | <code>number</code> | *No description.* |
| <code><a href="#@cdktn/provider-cloudflare.workersScript.WorkersScriptObservabilityLogsOutputReference.property.invocationLogsInput">invocationLogsInput</a></code> | <code>boolean \| cdktn.IResolvable</code> | *No description.* |
| <code><a href="#@cdktn/provider-cloudflare.workersScript.WorkersScriptObservabilityLogsOutputReference.property.persistInput">persistInput</a></code> | <code>boolean \| cdktn.IResolvable</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-cloudflare.workersScript.WorkersScriptObservabilityLogsOutputReference.property.enabled">enabled</a></code> | <code>boolean \| cdktn.IResolvable</code> | *No description.* |
| <code><a href="#@cdktn/provider-cloudflare.workersScript.WorkersScriptObservabilityLogsOutputReference.property.headSamplingRate">headSamplingRate</a></code> | <code>number</code> | *No description.* |
| <code><a href="#@cdktn/provider-cloudflare.workersScript.WorkersScriptObservabilityLogsOutputReference.property.invocationLogs">invocationLogs</a></code> | <code>boolean \| cdktn.IResolvable</code> | *No description.* |
| <code><a href="#@cdktn/provider-cloudflare.workersScript.WorkersScriptObservabilityLogsOutputReference.property.persist">persist</a></code> | <code>boolean \| cdktn.IResolvable</code> | *No description.* |
| <code><a href="#@cdktn/provider-cloudflare.workersScript.WorkersScriptObservabilityLogsOutputReference.property.internalValue">internalValue</a></code> | <code>cdktn.IResolvable \| <a href="#@cdktn/provider-cloudflare.workersScript.WorkersScriptObservabilityLogs">WorkersScriptObservabilityLogs</a></code> | *No description.* |
...
```typescript
public readonly internalValue: IResolvable | WorkersScriptObservabilityLogs;
```

- *Type:* cdktn.IResolvable | <a href="#@cdktn/provider-cloudflare.workersScript.WorkersScriptObservabilityLogs">WorkersScriptObservabilityLogs</a>
...
new workersScript.WorkersScriptObservabilityOutputReference(terraformResource: IInterpolatingParent, terraformAttribute: string)
```

| **Name** | **Type** | **Description** |
| --- | --- | --- |
| <code><a href="#@cdktn/provider-cloudflare.workersScript.WorkersScriptObservabilityOutputReference.Initializer.parameter.terraformResource">terraformResource</a></code> | <code>cdktn.IInterpolatingParent</code> | The parent resource. |
...
```typescript
public putLogs(value: WorkersScriptObservabilityLogs): void
```
...
```typescript
public putTraces(value: WorkersScriptObservabilityTraces): void
```
...
| <code><a href="#@cdktn/provider-cloudflare.workersScript.WorkersScriptObservabilityOutputReference.property.enabledInput">enabledInput</a></code> | <code>boolean \| cdktn.IResolvable</code> | *No description.* |
| <code><a href="#@cdktn/provider-cloudflare.workersScript.WorkersScriptObservabilityOutputReference.property.headSamplingRateInput">headSamplingRateInput</a></code> | <code>number</code> | *No description.* |
| <code><a href="#@cdktn/provider-cloudflare.workersScript.WorkersScriptObservabilityOutputReference.property.logsInput">logsInput</a></code> | <code>cdktn.IResolvable \| <a href="#@cdktn/provider-cloudflare.workersScript.WorkersScriptObservabilityLogs">WorkersScriptObservabilityLogs</a></code> | *No description.* |
| <code><a href="#@cdktn/provider-cloudflare.workersScript.WorkersScriptObservabilityOutputReference.property.tracesInput">tracesInput</a></code> | <code>cdktn.IResolvable \| <a href="#@cdktn/provider-cloudflare.workersScript.WorkersScriptObservabilityTraces">WorkersScriptObservabilityTraces</a></code> | *No description.* |
| <code><a href="#@cdktn/provider-cloudflare.workersScript.WorkersScriptObservabilityOutputReference.property.enabled">enabled</a></code> | <code>boolean \| cdktn.IResolvable</code> | *No description.* |
| <code><a href="#@cdktn/provider-cloudflare.workersScript.WorkersScriptObservabilityOutputReference.property.headSamplingRate">headSamplingRate</a></code> | <code>number</code> | *No description.* |
| <code><a href="#@cdktn/provider-cloudflare.workersScript.WorkersScriptObservabilityOutputReference.property.internalValue">internalValue</a></code> | <code>cdktn.IResolvable \| <a href="#@cdktn/provider-cloudflare.workersScript.WorkersScriptObservability">WorkersScriptObservability</a></code> | *No description.* |
...
```typescript
public readonly logs: WorkersScriptObservabilityLogsOutputReference;
```
...
```typescript
public readonly traces: WorkersScriptObservabilityTracesOutputReference;
```
...
```typescript
public readonly logsInput: IResolvable | WorkersScriptObservabilityLogs;
```
...
```typescript
public readonly tracesInput: IResolvable | WorkersScriptObservabilityTraces;
```

- *Type:* cdktn.IResolvable | <a href="#@cdktn/provider-cloudflare.workersScript.WorkersScriptObservabilityTraces">WorkersScriptObservabilityTraces</a>
...
```typescript
public readonly internalValue: IResolvable | WorkersScriptObservability;
```
...
new workersScript.WorkersScriptObservabilityTracesOutputReference(terraformResource: IInterpolatingParent, terraformAttribute: string)
```

| **Name** | **Type** | **Description** |
| --- | --- | --- |
| <code><a href="#@cdktn/provider-cloudflare.workersScript.WorkersScriptObservabilityTracesOutputReference.Initializer.parameter.terraformResource">terraformResource</a></code> | <code>cdktn.IInterpolatingParent</code> | The parent resource. |
...
| <code><a href="#@cdktn/provider-cloudflare.workersScript.WorkersScriptObservabilityTracesOutputReference.property.enabledInput">enabledInput</a></code> | <code>boolean \| cdktn.IResolvable</code> | *No description.* |
| <code><a href="#@cdktn/provider-cloudflare.workersScript.WorkersScriptObservabilityTracesOutputReference.property.headSamplingRateInput">headSamplingRateInput</a></code> | <code>number</code> | *No description.* |
| <code><a href="#@cdktn/provider-cloudflare.workersScript.WorkersScriptObservabilityTracesOutputReference.property.persistInput">persistInput</a></code> | <code>boolean \| cdktn.IResolvable</code> | *No description.* |
| <code><a href="#@cdktn/provider-cloudflare.workersScript.WorkersScriptObservabilityTracesOutputReference.property.propagationPolicyInput">propagationPolicyInput</a></code> | <code>string</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-cloudflare.workersScript.WorkersScriptObservabilityTracesOutputReference.property.enabled">enabled</a></code> | <code>boolean \| cdktn.IResolvable</code> | *No description.* |
| <code><a href="#@cdktn/provider-cloudflare.workersScript.WorkersScriptObservabilityTracesOutputReference.property.headSamplingRate">headSamplingRate</a></code> | <code>number</code> | *No description.* |
| <code><a href="#@cdktn/provider-cloudflare.workersScript.WorkersScriptObservabilityTracesOutputReference.property.persist">persist</a></code> | <code>boolean \| cdktn.IResolvable</code> | *No description.* |
| <code><a href="#@cdktn/provider-cloudflare.workersScript.WorkersScriptObservabilityTracesOutputReference.property.propagationPolicy">propagationPolicy</a></code> | <code>string</code> | *No description.* |
...
```typescript
public readonly internalValue: IResolvable | WorkersScriptObservabilityTraces;
```
...
new workersScript.WorkersScriptPackageDependenciesList(terraformResource: IInterpolatingParent, terraformAttribute: string, wrapsSet: boolean)
```

| **Name** | **Type** | **Description** |
| --- | --- | --- |
| <code><a href="#@cdktn/provider-cloudflare.workersScript.WorkersScriptPackageDependenciesList.Initializer.parameter.terraformResource">terraformResource</a></code> | <code>cdktn.IInterpolatingParent</code> | The parent resource. |
| <code><a href="#@cdktn/provider-cloudflare.workersScript.WorkersScriptPackageDependenciesList.Initializer.parameter.terraformAttribute">terraformAttribute</a></code> | <code>string</code> | The attribute on the parent resource this class is referencing. |
| <code><a href="#@cdktn/provider-cloudflare.workersScript.WorkersScriptPackageDependenciesList.Initializer.parameter.wrapsSet">wrapsSet</a></code> | <code>boolean</code> | whether the list is wrapping a set (will add tolist() to be able to access an item via an index). |
...
```typescript
public get(index: number): WorkersScriptPackageDependenciesOutputReference
```
...
| **Name** | **Type** | **Description** |
| --- | --- | --- |
| <code><a href="#@cdktn/provider-cloudflare.workersScript.WorkersScriptPackageDependenciesList.property.creationStack">creationStack</a></code> | <code>string[]</code> | The creation stack of this resolvable which will be appended to errors thrown during resolution. |
| <code><a href="#@cdktn/provider-cloudflare.workersScript.WorkersScriptPackageDependenciesList.property.fqn">fqn</a></code> | <code>string</code> | *No description.* |
| <code><a href="#@cdktn/provider-cloudflare.workersScript.WorkersScriptPackageDependenciesList.property.internalValue">internalValue</a></code> | <code>cdktn.IResolvable \| <a href="#@cdktn/provider-cloudflare.workersScript.WorkersScriptPackageDependencies">WorkersScriptPackageDependencies</a>[]</code> | *No description.* |
...
```typescript
public readonly internalValue: IResolvable | WorkersScriptPackageDependencies[];
```
...
new workersScript.WorkersScriptPackageDependenciesOutputReference(terraformResource: IInterpolatingParent, terraformAttribute: string, complexObjectIndex: number, complexObjectIsFromSet: boolean)
```

| **Name** | **Type** | **Description** |
| --- | --- | --- |
| <code><a href="#@cdktn/provider-cloudflare.workersScript.WorkersScriptPackageDependenciesOutputReference.Initializer.parameter.terraformResource">terraformResource</a></code> | <code>cdktn.IInterpolatingParent</code> | The parent resource. |
| <code><a href="#@cdktn/provider-cloudflare.workersScript.WorkersScriptPackageDependenciesOutputReference.Initializer.parameter.terraformAttribute">terraformAttribute</a></code> | <code>string</code> | The attribute on the parent resource this class is referencing. |
| <code><a href="#@cdktn/provider-cloudflare.workersScript.WorkersScriptPackageDependenciesOutputReference.Initializer.parameter.complexObjectIndex">complexObjectIndex</a></code> | <code>number</code> | the index of this item in the list. |
| <code><a href="#@cdktn/provider-cloudflare.workersScript.WorkersScriptPackageDependenciesOutputReference.Initializer.parameter.complexObjectIsFromSet">complexObjectIsFromSet</a></code> | <code>boolean</code> | whether the list is wrapping a set (will add tolist() to be able to access an item via an index). |
...
| **Name** | **Type** | **Description** |
| --- | --- | --- |
| <code><a href="#@cdktn/provider-cloudflare.workersScript.WorkersScriptPackageDependenciesOutputReference.property.creationStack">creationStack</a></code> | <code>string[]</code> | The creation stack of this resolvable which will be appended to errors thrown during resolution. |
| <code><a href="#@cdktn/provider-cloudflare.workersScript.WorkersScriptPackageDependenciesOutputReference.property.fqn">fqn</a></code> | <code>string</code> | *No description.* |
| <code><a href="#@cdktn/provider-cloudflare.workersScript.WorkersScriptPackageDependenciesOutputReference.property.installedVersionInput">installedVersionInput</a></code> | <code>string</code> | *No description.* |
| <code><a href="#@cdktn/provider-cloudflare.workersScript.WorkersScriptPackageDependenciesOutputReference.property.nameInput">nameInput</a></code> | <code>string</code> | *No description.* |
| <code><a href="#@cdktn/provider-cloudflare.workersScript.WorkersScriptPackageDependenciesOutputReference.property.packageJsonVersionInput">packageJsonVersionInput</a></code> | <code>string</code> | *No description.* |
| <code><a href="#@cdktn/provider-cloudflare.workersScript.WorkersScriptPackageDependenciesOutputReference.property.installedVersion">installedVersion</a></code> | <code>string</code> | *No description.* |
| <code><a href="#@cdktn/provider-cloudflare.workersScript.WorkersScriptPackageDependenciesOutputReference.property.name">name</a></code> | <code>string</code> | *No description.* |
| <code><a href="#@cdktn/provider-cloudflare.workersScript.WorkersScriptPackageDependenciesOutputReference.property.packageJsonVersion">packageJsonVersion</a></code> | <code>string</code> | *No description.* |
...
```typescript
public readonly installedVersionInput: string;
```
...
```typescript
public readonly packageJsonVersionInput: string;
```
...
new workersScript.WorkersScriptPlacementOutputReference(terraformResource: IInterpolatingParent, terraformAttribute: string)
```

| **Name** | **Type** | **Description** |
| --- | --- | --- |
| <code><a href="#@cdktn/provider-cloudflare.workersScript.WorkersScriptPlacementOutputReference.Initializer.parameter.terraformResource">terraformResource</a></code> | <code>cdktn.IInterpolatingParent</code> | The parent resource. |
...
| <code><a href="#@cdktn/provider-cloudflare.workersScript.WorkersScriptPlacementOutputReference.property.internalValue">internalValue</a></code> | <code>cdktn.IResolvable \| <a href="#@cdktn/provider-cloudflare.workersScript.WorkersScriptPlacement">WorkersScriptPlacement</a></code> | *No description.* |
...
```typescript
public readonly target: WorkersScriptPlacementTargetList;
```
...
new workersScript.WorkersScriptPlacementTargetList(terraformResource: IInterpolatingParent, terraformAttribute: string, wrapsSet: boolean)
```

| **Name** | **Type** | **Description** |
| --- | --- | --- |
| <code><a href="#@cdktn/provider-cloudflare.workersScript.WorkersScriptPlacementTargetList.Initializer.parameter.terraformResource">terraformResource</a></code> | <code>cdktn.IInterpolatingParent</code> | The parent resource. |
...
| <code><a href="#@cdktn/provider-cloudflare.workersScript.WorkersScriptPlacementTargetList.Initializer.parameter.wrapsSet">wrapsSet</a></code> | <code>boolean</code> | whether the list is wrapping a set (will add tolist() to be able to access an item via an index). |
...
new workersScript.WorkersScriptPlacementTargetOutputReference(terraformResource: IInterpolatingParent, terraformAttribute: string, complexObjectIndex: number, complexObjectIsFromSet: boolean)
```

| **Name** | **Type** | **Description** |
| --- | --- | --- |
| <code><a href="#@cdktn/provider-cloudflare.workersScript.WorkersScriptPlacementTargetOutputReference.Initializer.parameter.terraformResource">terraformResource</a></code> | <code>cdktn.IInterpolatingParent</code> | The parent resource. |
...
| <code><a href="#@cdktn/provider-cloudflare.workersScript.WorkersScriptPlacementTargetOutputReference.Initializer.parameter.complexObjectIndex">complexObjectIndex</a></code> | <code>number</code> | the index of this item in the list. |
| <code><a href="#@cdktn/provider-cloudflare.workersScript.WorkersScriptPlacementTargetOutputReference.Initializer.parameter.complexObjectIsFromSet">complexObjectIsFromSet</a></code> | <code>boolean</code> | whether the list is wrapping a set (will add tolist() to be able to access an item via an index). |
...
```typescript
public readonly internalValue: WorkersScriptPlacementTarget;
```
...
new workersScript.WorkersScriptTailConsumersList(terraformResource: IInterpolatingParent, terraformAttribute: string, wrapsSet: boolean)
```

| **Name** | **Type** | **Description** |
| --- | --- | --- |
| <code><a href="#@cdktn/provider-cloudflare.workersScript.WorkersScriptTailConsumersList.Initializer.parameter.terraformResource">terraformResource</a></code> | <code>cdktn.IInterpolatingParent</code> | The parent resource. |
...
| <code><a href="#@cdktn/provider-cloudflare.workersScript.WorkersScriptTailConsumersList.Initializer.parameter.wrapsSet">wrapsSet</a></code> | <code>boolean</code> | whether the list is wrapping a set (will add tolist() to be able to access an item via an index). |
...
| <code><a href="#@cdktn/provider-cloudflare.workersScript.WorkersScriptTailConsumersList.property.internalValue">internalValue</a></code> | <code>cdktn.IResolvable \| <a href="#@cdktn/provider-cloudflare.workersScript.WorkersScriptTailConsumers">WorkersScriptTailConsumers</a>[]</code> | *No description.* |
...
```typescript
public readonly internalValue: IResolvable | WorkersScriptTailConsumers[];
```
...
new workersScript.WorkersScriptTailConsumersOutputReference(terraformResource: IInterpolatingParent, terraformAttribute: string, complexObjectIndex: number, complexObjectIsFromSet: boolean)
```

| **Name** | **Type** | **Description** |
| --- | --- | --- |
| <code><a href="#@cdktn/provider-cloudflare.workersScript.WorkersScriptTailConsumersOutputReference.Initializer.parameter.terraformResource">terraformResource</a></code> | <code>cdktn.IInterpolatingParent</code> | The parent resource. |
...
| <code><a href="#@cdktn/provider-cloudflare.workersScript.WorkersScriptTailConsumersOutputReference.Initializer.parameter.complexObjectIndex">complexObjectIndex</a></code> | <code>number</code> | the index of this item in the list. |
| <code><a href="#@cdktn/provider-cloudflare.workersScript.WorkersScriptTailConsumersOutputReference.Initializer.parameter.complexObjectIsFromSet">complexObjectIsFromSet</a></code> | <code>boolean</code> | whether the list is wrapping a set (will add tolist() to be able to access an item via an index). |
...
| <code><a href="#@cdktn/provider-cloudflare.workersScript.WorkersScriptTailConsumersOutputReference.property.internalValue">internalValue</a></code> | <code>cdktn.IResolvable \| <a href="#@cdktn/provider-cloudflare.workersScript.WorkersScriptTailConsumers">WorkersScriptTailConsumers</a></code> | *No description.* |

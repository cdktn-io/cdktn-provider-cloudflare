...
```go
import "github.com/cdktn-io/cdktn-provider-cloudflare-go/cloudflare/v15/queue"
...
&queue.QueueConfig {
	...
	QueueName: *string,
	AccountId: *string,
	Settings: github.com/cdktn-io/cdktn-provider-cloudflare-go/cloudflare/v15.queue.QueueSettings,
}
```

...
```go
import "github.com/cdktn-io/cdktn-provider-cloudflare-go/cloudflare/v16/queue"
...
&queue.QueueConfig {
	...
	AccountId: *string,
	QueueName: *string,
	Settings: github.com/cdktn-io/cdktn-provider-cloudflare-go/cloudflare/v16.queue.QueueSettings,
}
```

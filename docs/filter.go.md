...
```go
import "github.com/cdktn-io/cdktn-provider-cloudflare-go/cloudflare/v16/filter"
...
| <code><a href="#@cdktn/provider-cloudflare.filter.FilterConfig.property.body">Body</a></code> | <code>interface{}</code> | Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.23.0/docs/resources/filter#body Filter#body}. |

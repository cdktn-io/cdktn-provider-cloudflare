...
| <code><a href="#@cdktn/provider-cloudflare.dataCloudflareAiGatewayDynamicRouting.DataCloudflareAiGatewayDynamicRoutingVersionOutputReference.property.isValid">is_valid</a></code> | <code>cdktn.IResolvable</code> | *No description.* |
...
##### `is_valid`<sup>Required</sup> <a name="is_valid" id="@cdktn/provider-cloudflare.dataCloudflareAiGatewayDynamicRouting.DataCloudflareAiGatewayDynamicRoutingVersionOutputReference.property.isValid"></a>

...
| <code><a href="#@cdktn/provider-cloudflare.dataCloudflareZeroTrustOrganization.DataCloudflareZeroTrustOrganization.property.warpAuthNonBrowser401">warpAuthNonBrowser401</a></code> | <code>cdktn.IResolvable</code> | *No description.* |
...
##### `warpAuthNonBrowser401`<sup>Required</sup> <a name="warpAuthNonBrowser401" id="@cdktn/provider-cloudflare.dataCloudflareZeroTrustOrganization.DataCloudflareZeroTrustOrganization.property.warpAuthNonBrowser401"></a>

```typescript
public readonly warpAuthNonBrowser401: IResolvable;
```

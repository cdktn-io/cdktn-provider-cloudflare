...
```typescript
import { dataCloudflareNelSetting } from '@cdktn/provider-cloudflare'

new dataCloudflareNelSetting.DataCloudflareNelSetting(scope: Construct, id: string, config: DataCloudflareNelSettingConfig)
```
...
dataCloudflareNelSetting.DataCloudflareNelSetting.isConstruct(x: any)
```
...
dataCloudflareNelSetting.DataCloudflareNelSetting.isTerraformElement(x: any)
```
...
dataCloudflareNelSetting.DataCloudflareNelSetting.isTerraformDataSource(x: any)
```
...
dataCloudflareNelSetting.DataCloudflareNelSetting.generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: TerraformProvider)
```
...
| <code><a href="#@cdktn/provider-cloudflare.dataCloudflareNelSetting.DataCloudflareNelSetting.property.cdktfStack">cdktfStack</a></code> | <code>cdktn.TerraformStack</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-cloudflare.dataCloudflareNelSetting.DataCloudflareNelSetting.property.terraformMetaArguments">terraformMetaArguments</a></code> | <code>{[ key: string ]: any}</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-cloudflare.dataCloudflareNelSetting.DataCloudflareNelSetting.property.terraformGeneratorMetadata">terraformGeneratorMetadata</a></code> | <code>cdktn.TerraformProviderGeneratorMetadata</code> | *No description.* |
| <code><a href="#@cdktn/provider-cloudflare.dataCloudflareNelSetting.DataCloudflareNelSetting.property.count">count</a></code> | <code>number \| cdktn.TerraformCount</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-cloudflare.dataCloudflareNelSetting.DataCloudflareNelSetting.property.forEach">forEach</a></code> | <code>cdktn.ITerraformIterator</code> | *No description.* |
...
```typescript
public readonly value: DataCloudflareNelSettingValueOutputReference;
```
...
const dataCloudflareNelSettingConfig: dataCloudflareNelSetting.DataCloudflareNelSettingConfig = { ... }
```
...
| <code><a href="#@cdktn/provider-cloudflare.dataCloudflareNelSetting.DataCloudflareNelSettingConfig.property.count">count</a></code> | <code>number \| cdktn.TerraformCount</code> | *No description.* |
| <code><a href="#@cdktn/provider-cloudflare.dataCloudflareNelSetting.DataCloudflareNelSettingConfig.property.dependsOn">dependsOn</a></code> | <code>cdktn.ITerraformDependable[]</code> | *No description.* |
| <code><a href="#@cdktn/provider-cloudflare.dataCloudflareNelSetting.DataCloudflareNelSettingConfig.property.forEach">forEach</a></code> | <code>cdktn.ITerraformIterator</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-cloudflare.dataCloudflareNelSetting.DataCloudflareNelSettingConfig.property.provisioners">provisioners</a></code> | <code>cdktn.FileProvisioner \| cdktn.LocalExecProvisioner \| cdktn.RemoteExecProvisioner[]</code> | *No description.* |
...
const dataCloudflareNelSettingValue: dataCloudflareNelSetting.DataCloudflareNelSettingValue = { ... }
```
...
new dataCloudflareNelSetting.DataCloudflareNelSettingValueOutputReference(terraformResource: IInterpolatingParent, terraformAttribute: string)
```

| **Name** | **Type** | **Description** |
| --- | --- | --- |
| <code><a href="#@cdktn/provider-cloudflare.dataCloudflareNelSetting.DataCloudflareNelSettingValueOutputReference.Initializer.parameter.terraformResource">terraformResource</a></code> | <code>cdktn.IInterpolatingParent</code> | The parent resource. |
...
```typescript
public readonly internalValue: DataCloudflareNelSettingValue;
```

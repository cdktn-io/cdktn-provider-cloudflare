...
```csharp
private void ResetBotPreferenceSyncEnabled()
```
...
```csharp
public bool|IResolvable BotPreferenceSyncEnabledInput { get; }
```
...
```csharp
public bool|IResolvable BotPreferenceSyncEnabled { get; }
```
...
```csharp
public bool|IResolvable BotPreferenceSyncEnabled { get; set; }
```

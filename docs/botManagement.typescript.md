...
```typescript
public resetBotPreferenceSyncEnabled(): void
```
...
```typescript
public readonly botPreferenceSyncEnabledInput: boolean | IResolvable;
```
...
```typescript
public readonly botPreferenceSyncEnabled: boolean | IResolvable;
```

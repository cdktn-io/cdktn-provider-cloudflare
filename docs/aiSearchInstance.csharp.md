...
| <code><a href="#@cdktn/provider-cloudflare.aiSearchInstance.AiSearchInstanceConfig.property.cache">Cache</a></code> | <code>bool\|Io.Cdktn.IResolvable</code> | Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.19.1/docs/resources/ai_search_instance#cache AiSearchInstance#cache}. |
...
| <code><a href="#@cdktn/provider-cloudflare.aiSearchInstance.AiSearchInstanceConfig.property.chunkOverlap">ChunkOverlap</a></code> | <code>double</code> | Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.19.1/docs/resources/ai_search_instance#chunk_overlap AiSearchInstance#chunk_overlap}. |
...
new AiSearchInstanceMetadata {
    ...
    AiSearchInstanceMetadataSearchForAgents SearchForAgents = null,
...
```csharp
public AiSearchInstanceMetadataSearchForAgents SearchForAgents { get; set; }
```
...
new AiSearchInstanceMetadataSearchForAgents {
    string Hostname,
    string ZoneId,
    string ZoneName
};
...
| <code><a href="#@cdktn/provider-cloudflare.aiSearchInstance.AiSearchInstanceSourceParamsWebCrawlerParseOptions.property.includeHeaders">IncludeHeaders</a></code> | <code>System.Collections.Generic.IDictionary<string, string></code> | Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.19.1/docs/resources/ai_search_instance#include_headers AiSearchInstance#include_headers}. |
...
```csharp
private void PutSearchForAgents(AiSearchInstanceMetadataSearchForAgents Value)
```
...
```csharp
private void ResetSearchForAgents()
```
...
```csharp
public AiSearchInstanceMetadataSearchForAgentsOutputReference SearchForAgents { get; }
```
...
```csharp
public IResolvable|AiSearchInstanceMetadataSearchForAgents SearchForAgentsInput { get; }
```

- *Type:* Io.Cdktn.IResolvable|<a href="#@cdktn/provider-cloudflare.aiSearchInstance.AiSearchInstanceMetadataSearchForAgents">AiSearchInstanceMetadataSearchForAgents</a>
...
new AiSearchInstanceMetadataSearchForAgentsOutputReference(IInterpolatingParent TerraformResource, string TerraformAttribute);
```

| **Name** | **Type** | **Description** |
| --- | --- | --- |
| <code><a href="#@cdktn/provider-cloudflare.aiSearchInstance.AiSearchInstanceMetadataSearchForAgentsOutputReference.Initializer.parameter.terraformResource">TerraformResource</a></code> | <code>Io.Cdktn.IInterpolatingParent</code> | The parent resource. |
...
###### `Context`<sup>Required</sup> <a name="Context" id="@cdktn/provider-cloudflare.aiSearchInstance.AiSearchInstanceMetadataSearchForAgentsOutputReference.resolve.parameter._context"></a>
...
```csharp
public IResolvable|AiSearchInstanceMetadataSearchForAgents InternalValue { get; }
```

...
| <code><a href="#@cdktn/provider-cloudflare.dataCloudflareZeroTrustGatewaySettings.DataCloudflareZeroTrustGatewaySettingsSettingsOutputReference.property.maxTtlSecs">MaxTtlSecs</a></code> | <code>double</code> | *No description.* |

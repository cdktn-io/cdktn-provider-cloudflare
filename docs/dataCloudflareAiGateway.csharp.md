...
| <code><a href="#@cdktn/provider-cloudflare.dataCloudflareAiGateway.DataCloudflareAiGateway.property.logClassification">LogClassification</a></code> | <code>Io.Cdktn.IResolvable</code> | *No description.* |
...
```csharp
public IResolvable LogClassification { get; }
```

...
```typescript
import { dataCloudflarePrecursor } from '@cdktn/provider-cloudflare'

new dataCloudflarePrecursor.DataCloudflarePrecursor(scope: Construct, id: string, config: DataCloudflarePrecursorConfig)
```
...
dataCloudflarePrecursor.DataCloudflarePrecursor.isConstruct(x: any)
```
...
dataCloudflarePrecursor.DataCloudflarePrecursor.isTerraformElement(x: any)
```
...
dataCloudflarePrecursor.DataCloudflarePrecursor.isTerraformDataSource(x: any)
```
...
dataCloudflarePrecursor.DataCloudflarePrecursor.generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: TerraformProvider)
```
...
| <code><a href="#@cdktn/provider-cloudflare.dataCloudflarePrecursor.DataCloudflarePrecursor.property.cdktfStack">cdktfStack</a></code> | <code>cdktn.TerraformStack</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-cloudflare.dataCloudflarePrecursor.DataCloudflarePrecursor.property.terraformMetaArguments">terraformMetaArguments</a></code> | <code>{[ key: string ]: any}</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-cloudflare.dataCloudflarePrecursor.DataCloudflarePrecursor.property.terraformGeneratorMetadata">terraformGeneratorMetadata</a></code> | <code>cdktn.TerraformProviderGeneratorMetadata</code> | *No description.* |
| <code><a href="#@cdktn/provider-cloudflare.dataCloudflarePrecursor.DataCloudflarePrecursor.property.count">count</a></code> | <code>number \| cdktn.TerraformCount</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-cloudflare.dataCloudflarePrecursor.DataCloudflarePrecursor.property.forEach">forEach</a></code> | <code>cdktn.ITerraformIterator</code> | *No description.* |
...
```typescript
public readonly enforcementRules: DataCloudflarePrecursorEnforcementRulesList;
```
...
const dataCloudflarePrecursorConfig: dataCloudflarePrecursor.DataCloudflarePrecursorConfig = { ... }
```
...
| <code><a href="#@cdktn/provider-cloudflare.dataCloudflarePrecursor.DataCloudflarePrecursorConfig.property.count">count</a></code> | <code>number \| cdktn.TerraformCount</code> | *No description.* |
| <code><a href="#@cdktn/provider-cloudflare.dataCloudflarePrecursor.DataCloudflarePrecursorConfig.property.dependsOn">dependsOn</a></code> | <code>cdktn.ITerraformDependable[]</code> | *No description.* |
| <code><a href="#@cdktn/provider-cloudflare.dataCloudflarePrecursor.DataCloudflarePrecursorConfig.property.forEach">forEach</a></code> | <code>cdktn.ITerraformIterator</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-cloudflare.dataCloudflarePrecursor.DataCloudflarePrecursorConfig.property.provisioners">provisioners</a></code> | <code>cdktn.FileProvisioner \| cdktn.LocalExecProvisioner \| cdktn.RemoteExecProvisioner[]</code> | *No description.* |
...
const dataCloudflarePrecursorEnforcementRules: dataCloudflarePrecursor.DataCloudflarePrecursorEnforcementRules = { ... }
```
...
new dataCloudflarePrecursor.DataCloudflarePrecursorEnforcementRulesList(terraformResource: IInterpolatingParent, terraformAttribute: string, wrapsSet: boolean)
```

| **Name** | **Type** | **Description** |
| --- | --- | --- |
| <code><a href="#@cdktn/provider-cloudflare.dataCloudflarePrecursor.DataCloudflarePrecursorEnforcementRulesList.Initializer.parameter.terraformResource">terraformResource</a></code> | <code>cdktn.IInterpolatingParent</code> | The parent resource. |
...
| <code><a href="#@cdktn/provider-cloudflare.dataCloudflarePrecursor.DataCloudflarePrecursorEnforcementRulesList.Initializer.parameter.wrapsSet">wrapsSet</a></code> | <code>boolean</code> | whether the list is wrapping a set (will add tolist() to be able to access an item via an index). |
...
new dataCloudflarePrecursor.DataCloudflarePrecursorEnforcementRulesOutputReference(terraformResource: IInterpolatingParent, terraformAttribute: string, complexObjectIndex: number, complexObjectIsFromSet: boolean)
```

| **Name** | **Type** | **Description** |
| --- | --- | --- |
| <code><a href="#@cdktn/provider-cloudflare.dataCloudflarePrecursor.DataCloudflarePrecursorEnforcementRulesOutputReference.Initializer.parameter.terraformResource">terraformResource</a></code> | <code>cdktn.IInterpolatingParent</code> | The parent resource. |
...
| <code><a href="#@cdktn/provider-cloudflare.dataCloudflarePrecursor.DataCloudflarePrecursorEnforcementRulesOutputReference.Initializer.parameter.complexObjectIndex">complexObjectIndex</a></code> | <code>number</code> | the index of this item in the list. |
...
```typescript
public readonly internalValue: DataCloudflarePrecursorEnforcementRules;
```

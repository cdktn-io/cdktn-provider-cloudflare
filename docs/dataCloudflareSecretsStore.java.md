...
| <code><a href="#@cdktn/provider-cloudflare.dataCloudflareSecretsStore.DataCloudflareSecretsStoreFilter.property.order">order</a></code> | <code>java.lang.String</code> | Order stores by values in the given field. Available values: "name", "created", "modified". |

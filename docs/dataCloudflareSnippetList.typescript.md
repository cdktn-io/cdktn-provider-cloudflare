...
| <code><a href="#@cdktn/provider-cloudflare.dataCloudflareSnippetList.DataCloudflareSnippetListConfig.property.zoneId">zoneId</a></code> | <code>string</code> | The unique ID of the zone. |

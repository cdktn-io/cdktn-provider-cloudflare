...
##### `botPreferenceSyncEnabled`<sup>Optional</sup> <a name="botPreferenceSyncEnabled" id="@cdktn/provider-cloudflare.botManagement.BotManagement.Initializer.parameter.botPreferenceSyncEnabled"></a>
...
```java
public void resetBotPreferenceSyncEnabled()
```
...
```java
public java.lang.Boolean|IResolvable getBotPreferenceSyncEnabledInput();
```
...
```java
public java.lang.Boolean|IResolvable getBotPreferenceSyncEnabled();
```

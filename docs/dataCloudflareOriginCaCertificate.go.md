...
```go
import "github.com/cdktn-io/cdktn-provider-cloudflare-go/cloudflare/v16/datacloudflareorigincacertificate"
...
&datacloudflareorigincacertificate.DataCloudflareOriginCaCertificateConfig {
	...
	Filter: github.com/cdktn-io/cdktn-provider-cloudflare-go/cloudflare/v16.dataCloudflareOriginCaCertificate.DataCloudflareOriginCaCertificateFilter,
}
```

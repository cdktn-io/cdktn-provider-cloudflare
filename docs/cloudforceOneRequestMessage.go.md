...
Represents a {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.19.1/docs/resources/cloudforce_one_request_message cloudflare_cloudforce_one_request_message}.
...
```go
import "github.com/cdktn-io/cdktn-provider-cloudflare-go/cloudflare/v15/cloudforceonerequestmessage"
...
| <code><a href="#@cdktn/provider-cloudflare.cloudforceOneRequestMessage.CloudforceOneRequestMessage.with">With</a></code> | Applies one or more mixins to this construct. |
...
| <code><a href="#@cdktn/provider-cloudflare.cloudforceOneRequestMessage.CloudforceOneRequestMessage.resetAccountId">ResetAccountId</a></code> | *No description.* |
...
##### `With` <a name="With" id="@cdktn/provider-cloudflare.cloudforceOneRequestMessage.CloudforceOneRequestMessage.with"></a>
...
###### `mixins`<sup>Required</sup> <a name="mixins" id="@cdktn/provider-cloudflare.cloudforceOneRequestMessage.CloudforceOneRequestMessage.with.parameter.mixins"></a>
...
##### `ResetAccountId` <a name="ResetAccountId" id="@cdktn/provider-cloudflare.cloudforceOneRequestMessage.CloudforceOneRequestMessage.resetAccountId"></a>
...
Refer to the {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.19.1/docs/resources/cloudforce_one_request_message#import import section} in the documentation of this resource for the id to use
...
##### `AccountId`<sup>Optional</sup> <a name="AccountId" id="@cdktn/provider-cloudflare.cloudforceOneRequestMessage.CloudforceOneRequestMessageConfig.property.accountId"></a>

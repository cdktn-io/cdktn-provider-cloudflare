...
| <code><a href="#@cdktn/provider-cloudflare.loadBalancerPool.LoadBalancerPoolOrigins.property.disabledAt">disabledAt</a></code> | <code>string</code> | This field shows up only if the origin is disabled. |
...
##### `disabledAt`<sup>Optional</sup> <a name="disabledAt" id="@cdktn/provider-cloudflare.loadBalancerPool.LoadBalancerPoolOrigins.property.disabledAt"></a>
...
| <code><a href="#@cdktn/provider-cloudflare.loadBalancerPool.LoadBalancerPoolOriginsOutputReference.resetDisabledAt">resetDisabledAt</a></code> | *No description.* |
...
##### `resetDisabledAt` <a name="resetDisabledAt" id="@cdktn/provider-cloudflare.loadBalancerPool.LoadBalancerPoolOriginsOutputReference.resetDisabledAt"></a>

```typescript
public resetDisabledAt(): void
```
...
| <code><a href="#@cdktn/provider-cloudflare.loadBalancerPool.LoadBalancerPoolOriginsOutputReference.property.disabledAtInput">disabledAtInput</a></code> | <code>string</code> | *No description.* |
...
##### `disabledAtInput`<sup>Optional</sup> <a name="disabledAtInput" id="@cdktn/provider-cloudflare.loadBalancerPool.LoadBalancerPoolOriginsOutputReference.property.disabledAtInput"></a>

```typescript
public readonly disabledAtInput: string;
```

...
```go
import "github.com/cdktn-io/cdktn-provider-cloudflare-go/cloudflare/v15/datacloudflareworkerskvnamespace"
...
&datacloudflareworkerskvnamespace.DataCloudflareWorkersKvNamespaceConfig {
	...
	AccountId: *string,
	Filter: github.com/cdktn-io/cdktn-provider-cloudflare-go/cloudflare/v15.dataCloudflareWorkersKvNamespace.DataCloudflareWorkersKvNamespaceFilter,
	NamespaceId: *string,
}
```

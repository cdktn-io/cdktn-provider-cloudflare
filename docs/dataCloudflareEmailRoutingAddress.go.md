...
```go
import "github.com/cdktn-io/cdktn-provider-cloudflare-go/cloudflare/v15/datacloudflareemailroutingaddress"
...
&datacloudflareemailroutingaddress.DataCloudflareEmailRoutingAddressConfig {
	...
	Filter: github.com/cdktn-io/cdktn-provider-cloudflare-go/cloudflare/v15.dataCloudflareEmailRoutingAddress.DataCloudflareEmailRoutingAddressFilter,
}
```

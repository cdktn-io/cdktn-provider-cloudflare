...
| <code><a href="#@cdktn/provider-cloudflare.dataCloudflareAiGateways.DataCloudflareAiGatewaysResultOutputReference.property.logClassification">log_classification</a></code> | <code>cdktn.IResolvable</code> | *No description.* |
...
##### `log_classification`<sup>Required</sup> <a name="log_classification" id="@cdktn/provider-cloudflare.dataCloudflareAiGateways.DataCloudflareAiGatewaysResultOutputReference.property.logClassification"></a>

```python
log_classification: IResolvable
```

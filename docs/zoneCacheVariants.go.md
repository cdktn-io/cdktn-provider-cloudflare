...
```go
import "github.com/cdktn-io/cdktn-provider-cloudflare-go/cloudflare/v16/zonecachevariants"
...
&zonecachevariants.ZoneCacheVariantsConfig {
	...
	Value: github.com/cdktn-io/cdktn-provider-cloudflare-go/cloudflare/v16.zoneCacheVariants.ZoneCacheVariantsValue,
	ZoneId: *string,
}
```

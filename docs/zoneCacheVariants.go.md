...
```go
import "github.com/cdktn-io/cdktn-provider-cloudflare-go/cloudflare/v15/zonecachevariants"
...
&zonecachevariants.ZoneCacheVariantsConfig {
	...
	Value: github.com/cdktn-io/cdktn-provider-cloudflare-go/cloudflare/v15.zoneCacheVariants.ZoneCacheVariantsValue,
	ZoneId: *string,
}
```

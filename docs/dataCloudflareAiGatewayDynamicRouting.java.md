...
| <code><a href="#@cdktn/provider-cloudflare.dataCloudflareAiGatewayDynamicRouting.DataCloudflareAiGatewayDynamicRoutingVersionOutputReference.property.isValid">isValid</a></code> | <code>io.cdktn.cdktn.IResolvable</code> | *No description.* |

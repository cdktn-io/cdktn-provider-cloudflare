...
```go
import "github.com/cdktn-io/cdktn-provider-cloudflare-go/cloudflare/v16/clientcertificate"
...
| <code><a href="#@cdktn/provider-cloudflare.clientCertificate.ClientCertificateConfig.property.reactivate">Reactivate</a></code> | <code>interface{}</code> | Docs at Terraform Registry: {@link https://registry.terraform.io/providers/cloudflare/cloudflare/5.23.0/docs/resources/client_certificate#reactivate ClientCertificate#reactivate}. |

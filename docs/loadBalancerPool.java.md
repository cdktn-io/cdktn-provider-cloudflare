...
| <code><a href="#@cdktn/provider-cloudflare.loadBalancerPool.LoadBalancerPool.Initializer.parameter.healthSources">healthSources</a></code> | <code>java.util.List<java.lang.String></code> | A list of health sources, ordered from highest to lowest priority, used to evaluate individual origin health and overall pool health. |
...
##### `healthSources`<sup>Optional</sup> <a name="healthSources" id="@cdktn/provider-cloudflare.loadBalancerPool.LoadBalancerPool.Initializer.parameter.healthSources"></a>
...
| <code><a href="#@cdktn/provider-cloudflare.loadBalancerPool.LoadBalancerPool.property.healthSourcesInput">healthSourcesInput</a></code> | <code>java.util.List<java.lang.String></code> | *No description.* |
...
| <code><a href="#@cdktn/provider-cloudflare.loadBalancerPool.LoadBalancerPool.property.healthSources">healthSources</a></code> | <code>java.util.List<java.lang.String></code> | *No description.* |
...
| <code><a href="#@cdktn/provider-cloudflare.loadBalancerPool.LoadBalancerPoolConfig.property.healthSources">healthSources</a></code> | <code>java.util.List<java.lang.String></code> | A list of health sources, ordered from highest to lowest priority, used to evaluate individual origin health and overall pool health. |

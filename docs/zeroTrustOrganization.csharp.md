...
```csharp
private void ResetWarpAuthNonBrowser401()
```
...
```csharp
public bool|IResolvable WarpAuthNonBrowser401Input { get; }
```
...
```csharp
public bool|IResolvable WarpAuthNonBrowser401 { get; }
```
...
```csharp
public bool|IResolvable WarpAuthNonBrowser401 { get; set; }
```
